...
execute as @a[tag=p1] if predicate {condition:"minecraft:entity_properties",entity:"this",predicate:{effects:{"minecraft:fire_resistance":{amplifier:{min:20,max:20}}}}} if score slot2isatk booleans matches 1 run scoreboard players operation slot1Regen regen += docLeaderRegen abilityStats
execute as @a[tag=p1] if predicate {condition:"minecraft:entity_properties",entity:"this",predicate:{effects:{"minecraft:fire_resistance":{amplifier:{min:20,max:20}}}}} if score slot2isatk booleans matches 1 run scoreboard players operation slot2Regen regen += docLeaderRegen abilityStats
execute as @a[tag=p1] if predicate {condition:"minecraft:entity_properties",entity:"this",predicate:{effects:{"minecraft:fire_resistance":{amplifier:{min:20,max:20}}}}} if score slot2isatk booleans matches 1 run scoreboard players operation slot3Regen regen += docLeaderRegen abilityStats
execute as @a[tag=p1] if predicate {condition:"minecraft:entity_properties",entity:"this",predicate:{effects:{"minecraft:fire_resistance":{amplifier:{min:20,max:20}}}}} if score slot2isatk booleans matches 1 run scoreboard players operation slot4Regen regen += docLeaderRegen abilityStats
...
execute as @a[tag=p2] if predicate {condition:"minecraft:entity_properties",entity:"this",predicate:{effects:{"minecraft:fire_resistance":{amplifier:{min:20,max:20}}}}} if score slot6isatk booleans matches 1 run scoreboard players operation slot5Regen regen += docLeaderRegen abilityStats
execute as @a[tag=p2] if predicate {condition:"minecraft:entity_properties",entity:"this",predicate:{effects:{"minecraft:fire_resistance":{amplifier:{min:20,max:20}}}}} if score slot6isatk booleans matches 1 run scoreboard players operation slot6Regen regen += docLeaderRegen abilityStats
execute as @a[tag=p2] if predicate {condition:"minecraft:entity_properties",entity:"this",predicate:{effects:{"minecraft:fire_resistance":{amplifier:{min:20,max:20}}}}} if score slot6isatk booleans matches 1 run scoreboard players operation slot7Regen regen += docLeaderRegen abilityStats
execute as @a[tag=p2] if predicate {condition:"minecraft:entity_properties",entity:"this",predicate:{effects:{"minecraft:fire_resistance":{amplifier:{min:20,max:20}}}}} if score slot6isatk booleans matches 1 run scoreboard players operation slot8Regen regen += docLeaderRegen abilityStats
