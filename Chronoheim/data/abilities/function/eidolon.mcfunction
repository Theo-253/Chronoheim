...
execute as @a[tag=p1] if predicate {condition:"minecraft:entity_properties",entity:"this",predicate:{effects:{"minecraft:fire_resistance":{amplifier:{min:28,max:28}}}}} run tellraw @a[tag=game1] ["",{"selector":"@p[tag=p1]"}," used Bell Tolls!"]
...
execute as @a[tag=p1] if predicate {condition:"minecraft:entity_properties",entity:"this",predicate:{effects:{"minecraft:fire_resistance":{amplifier:{min:28,max:28}}}}} run execute if score slot1isatk booleans matches 1.. run execute at @n[name=slot1,type=armor_stand] run particle minecraft:raid_omen ~ ~1 ~ 0.3 0.3 0.3 2 100
execute as @a[tag=p1] if predicate {condition:"minecraft:entity_properties",entity:"this",predicate:{effects:{"minecraft:fire_resistance":{amplifier:{min:28,max:28}}}}} run execute if score slot2isatk booleans matches 1.. run execute at @n[name=slot2,type=armor_stand] run particle minecraft:raid_omen ~ ~1 ~ 0.3 0.3 0.3 2 100
execute as @a[tag=p1] if predicate {condition:"minecraft:entity_properties",entity:"this",predicate:{effects:{"minecraft:fire_resistance":{amplifier:{min:28,max:28}}}}} run execute if score slot3isatk booleans matches 1.. run execute at @n[name=slot3,type=armor_stand] run particle minecraft:raid_omen ~ ~1 ~ 0.3 0.3 0.3 2 100
...
execute as @a[tag=p2] if predicate {condition:"minecraft:entity_properties",entity:"this",predicate:{effects:{"minecraft:fire_resistance":{amplifier:{min:28,max:28}}}}} run execute if score slot5isatk booleans matches 1.. run execute at @n[name=slot5,type=armor_stand] run particle minecraft:raid_omen ~ ~1 ~ 0.3 0.3 0.3 2 100
execute as @a[tag=p2] if predicate {condition:"minecraft:entity_properties",entity:"this",predicate:{effects:{"minecraft:fire_resistance":{amplifier:{min:28,max:28}}}}} run execute if score slot6isatk booleans matches 1.. run execute at @n[name=slot6,type=armor_stand] run particle minecraft:raid_omen ~ ~1 ~ 0.3 0.3 0.3 2 100
execute as @a[tag=p2] if predicate {condition:"minecraft:entity_properties",entity:"this",predicate:{effects:{"minecraft:fire_resistance":{amplifier:{min:28,max:28}}}}} run execute if score slot7isatk booleans matches 1.. run execute at @n[name=slot7,type=armor_stand] run particle minecraft:raid_omen ~ ~1 ~ 0.3 0.3 0.3 2 100
