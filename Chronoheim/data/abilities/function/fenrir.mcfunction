...
execute if score curse slot5 matches 3 run scoreboard players set curse slot5 0
execute if score curse slot6 matches 3 run scoreboard players set curse slot6 0
execute if score curse slot6 matches 3 run scoreboard players set curse slot7 0
execute if score curse slot8 matches 3 run scoreboard players set curse slot8 0
