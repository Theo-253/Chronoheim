...
execute if score fenrirattack saves matches 2 if score curse slot1 matches 3 run function abilities:fenrirattackslot2
execute if score fenrirattack saves matches 2 if score curse slot2 matches 3 run function abilities:fenrirattackslot3
execute if score fenrirattack saves matches 2 if score curse slot3 matches 3 run function abilities:fenrirattackslot4