...
## P2
execute as @a[tag=p2] if predicate {condition:"minecraft:entity_properties",entity:"this",predicate:{effects:{"minecraft:fire_resistance":{amplifier:{min:6,max:6}}}}} if score slot5isatk booleans matches 1 run scoreboard players operation durationSlot1 wards = thornDuration abilityStats 
execute as @a[tag=p2] if predicate {condition:"minecraft:entity_properties",entity:"this",predicate:{effects:{"minecraft:fire_resistance":{amplifier:{min:6,max:6}}}}} if score slot6isatk booleans matches 1 run scoreboard players operation durationSlot2 wards = thornDuration abilityStats 
execute as @a[tag=p2] if predicate {condition:"minecraft:entity_properties",entity:"this",predicate:{effects:{"minecraft:fire_resistance":{amplifier:{min:6,max:6}}}}} if score slot7isatk booleans matches 1 run scoreboard players operation durationSlot3 wards = thornDuration abilityStats 
