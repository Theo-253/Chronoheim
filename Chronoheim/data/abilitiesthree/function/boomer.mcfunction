...
execute as @a[tag=p6] if predicate {condition:"minecraft:entity_properties",entity:"this",predicate:{effects:{"minecraft:fire_resistance":{amplifier:{min:25,max:25}}}}} run execute if score slot22isatk booleans matches 1.. run scoreboard players operation cooldown slot22 = boomerCD abilityStats
...
execute if score slot22isatk booleans matches 1.. at @e[name=slot22] run particle minecraft:flame ~ ~1 ~ 0.9 0.9 0.9 0.5 400
...
execute as @a[tag=p6] if predicate {condition:"minecraft:entity_properties",entity:"this",predicate:{effects:{"minecraft:fire_resistance":{amplifier:{min:25,max:25}}}}} run execute if score slot22isatk booleans matches 1.. run scoreboard players set slot22 hp 0
