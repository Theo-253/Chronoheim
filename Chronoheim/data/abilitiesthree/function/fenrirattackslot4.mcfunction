...
tellraw @a[tag=game3] ["",{"selector":"@p[tag=p6]"},"'s Fenrir attacked Slot 4"]
#slot 5
...
execute if score character# slot21 matches 41 run scoreboard players operation atk1 saves += marks slot20
execute if score character# slot21 matches 41 run scoreboard players operation atk1 saves /= atkmultiplier slot20
execute if score character# slot21 matches 41 run scoreboard players operation shield slot20 -= atk1 saves
#slot 6
...
execute if score character# slot22 matches 41 run scoreboard players operation atk1 saves += marks slot20
execute if score character# slot22 matches 41 if score character# slot22 matches 36 run execute unless score durationSlot21-4 fear matches 1.. unless score durationSlot22-4 fear matches 1.. unless score durationSlot23-4 fear matches 1.. unless score durationSlot24-4 fear matches 1.. run scoreboard players operation atk1 saves -= barleyLeader abilityStats
execute if score character# slot22 matches 41 run scoreboard players operation atk1 saves /= atkmultiplier slot20
execute if score character# slot22 matches 41 run scoreboard players operation shield slot20 -= atk1 saves
#slot 7
execute if score character# slot23 matches 41 run scoreboard players operation atk1 saves = atk slot23
execute if score character# slot23 matches 41 run scoreboard players operation atk1 saves += marks slot20
execute if score character# slot23 matches 41 run scoreboard players operation atk1 saves += slot23 atkmodifiers
execute if score character# slot23 matches 41 run scoreboard players operation atk1 saves /= atkmultiplier slot20
execute if score character# slot23 matches 41 run scoreboard players operation shield slot20 -= atk1 saves
#slot 8
execute if score character# slot24 matches 41 run scoreboard players operation atk1 saves = atk slot24
execute if score character# slot24 matches 41 run scoreboard players operation atk1 saves += marks slot20
execute if score character# slot24 matches 41 run scoreboard players operation atk1 saves += slot24 atkmodifiers
execute if score character# slot24 matches 41 run scoreboard players operation atk1 saves /= atkmultiplier slot20
execute if score character# slot24 matches 41 run scoreboard players operation shield slot20 -= atk1 saves
...
execute if score splash slot21 matches 1.. run execute if score character# slot21 matches 41 run scoreboard players operation splashdamage saves += marks slot19
execute if score splash slot21 matches 1.. run execute if score character# slot21 matches 41 run scoreboard players operation splashdamage saves /= atkmultiplier slot19
execute if score ward slot19 matches 0 run execute if score splash slot21 matches 1.. run execute if score character# slot21 matches 41 run scoreboard players operation shield slot19 -= splashdamage saves
...
execute if score splash slot22 matches 1.. run execute if score character# slot22 matches 41 run scoreboard players operation splashdamage saves += marks slot19
execute if score splash slot22 matches 1.. run execute if score character# slot22 matches 41 run scoreboard players operation splashdamage saves /= atkmultiplier slot19
execute if score ward slot19 matches 0 run execute if score splash slot22 matches 1.. run execute if score character# slot22 matches 41 run scoreboard players operation shield slot19 -= splashdamage saves
...
execute if score splash slot23 matches 1.. run execute if score character# slot23 matches 41 run scoreboard players operation splashdamage saves += marks slot19
execute if score splash slot23 matches 1.. run execute if score character# slot23 matches 41 run scoreboard players operation splashdamage saves /= atkmultiplier slot19
execute if score ward slot19 matches 0 run execute if score splash slot23 matches 1.. run execute if score character# slot23 matches 41 run scoreboard players operation shield slot19 -= splashdamage saves
...
execute if score splash slot24 matches 1.. run execute if score character# slot24 matches 41 run scoreboard players operation splashdamage saves += marks slot19
execute if score splash slot24 matches 1.. run execute if score character# slot24 matches 41 run scoreboard players operation splashdamage saves /= atkmultiplier slot19
execute if score ward slot19 matches 0 run execute if score splash slot24 matches 1.. run execute if score character# slot24 matches 41 run scoreboard players operation shield slot19 -= splashdamage saves
...
execute if score lifesteal slot21 matches 1.. run execute if score character# slot21 matches 41 run scoreboard players operation lifesteal saves += marks slot20
execute if score lifesteal slot21 matches 1.. run execute if score character# slot21 matches 41 run scoreboard players operation lifesteal saves /= atkmultiplier slot20
...
execute if score ward slot20 matches 0 if score slot21bleeding booleaneffects matches 0 run execute if score lifesteal slot21 matches 1.. run execute if score character# slot21 matches 41 run scoreboard players operation slot21 hp += lifesteal saves
execute if score ward slot20 matches 0 if score lifesteal slot21 matches 1.. if score character# slot21 matches 41 at @e[name=slot21,type=armor_stand] run particle minecraft:composter ~ ~1 ~ 0.9 0.9 0.9 0.5 50
#slot 6
...
execute if score lifesteal slot22 matches 1.. run execute if score character# slot22 matches 41 run scoreboard players operation lifesteal saves += marks slot20
execute if score lifesteal slot22 matches 1.. run execute if score character# slot22 matches 41 run scoreboard players operation lifesteal saves /= atkmultiplier slot20
...
execute if score ward slot20 matches 0 if score slot22bleeding booleaneffects matches 0 run execute if score lifesteal slot22 matches 1.. run execute if score character# slot22 matches 41 run scoreboard players operation slot22 hp += lifesteal saves
execute if score ward slot20 matches 0 if score lifesteal slot22 matches 1.. if score character# slot22 matches 41 at @e[name=slot22,type=armor_stand] run particle minecraft:composter ~ ~1 ~ 0.9 0.9 0.9 0.5 50
#slot 7
...
execute if score lifesteal slot23 matches 1.. run execute if score character# slot23 matches 41 run scoreboard players operation lifesteal saves += marks slot20
execute if score lifesteal slot23 matches 1.. run execute if score character# slot23 matches 41 run scoreboard players operation lifesteal saves /= atkmultiplier slot20
...
execute if score ward slot20 matches 0 if score slot23bleeding booleaneffects matches 0 run execute if score lifesteal slot23 matches 1.. run execute if score character# slot23 matches 41 run scoreboard players operation slot23 hp += lifesteal saves
execute if score ward slot20 matches 0 if score lifesteal slot23 matches 1.. if score character# slot23 matches 41 at @e[name=slot23,type=armor_stand] run particle minecraft:composter ~ ~1 ~ 0.9 0.9 0.9 0.5 50
#slot 8
...
execute if score lifesteal slot24 matches 1.. run execute if score character# slot24 matches 41 run scoreboard players operation lifesteal saves += marks slot20
execute if score lifesteal slot24 matches 1.. run execute if score character# slot24 matches 41 run scoreboard players operation lifesteal saves /= atkmultiplier slot20
...
execute if score ward slot20 matches 0 if score slot24bleeding booleaneffects matches 0 run execute if score lifesteal slot24 matches 1.. run execute if score character# slot24 matches 41 run scoreboard players operation slot24 hp += lifesteal saves
execute if score ward slot20 matches 0 if score lifesteal slot24 matches 1.. if score character# slot24 matches 41 at @e[name=slot24,type=armor_stand] run particle minecraft:composter ~ ~1 ~ 0.9 0.9 0.9 0.5 50

#Special Cases
execute if score ward slot20 matches ..0 run execute if score character# slot21 matches 41 if score character# slot21 matches 29 if score slot20 hp <= ripperHpBleed abilityStats run scoreboard players operation slot20bleeding booleaneffects = ripperBleed abilityStats
execute if score ward slot20 matches ..0 run execute if score character# slot22 matches 41 if score character# slot22 matches 29 if score slot20 hp <= ripperHpBleed abilityStats run scoreboard players operation slot20bleeding booleaneffects = ripperBleed abilityStats
execute if score ward slot20 matches ..0 run execute if score character# slot23 matches 41 if score character# slot23 matches 29 if score slot20 hp <= ripperHpBleed abilityStats run scoreboard players operation slot20bleeding booleaneffects = ripperBleed abilityStats
execute if score ward slot20 matches ..0 run execute if score character# slot21 matches 41 if score character# slot21 matches -8 run scoreboard players operation slot20Disease disease += zombieDisease abilityStats
execute if score ward slot20 matches ..0 run execute if score character# slot22 matches 41 if score character# slot22 matches -8 run scoreboard players operation slot20Disease disease += zombieDisease abilityStats
execute if score ward slot20 matches ..0 run execute if score character# slot23 matches 41 if score character# slot23 matches -8 run scoreboard players operation slot20Disease disease += zombieDisease abilityStats
execute if score ward slot20 matches ..0 run execute if score character# slot24 matches 41 if score character# slot24 matches -8 run scoreboard players operation slot20Disease disease += zombieDisease abilityStats
...
execute if score ward slot20 matches 1.. run function chthree:wardslot20
execute if score shield slot20 matches ..0 run scoreboard players set shield slot20 0
execute at @e[name=slot20,type=armor_stand] run particle minecraft:crit ~ ~1 ~ 0.9 0.9 0.9 0.5 100
...
execute if score lifesteal slot21 matches 1.. run execute if score splash slot21 matches 1.. run execute if score character# slot21 matches 41 run scoreboard players operation lifestealsplash saves += marks slot19
execute if score lifesteal slot21 matches 1.. run execute if score splash slot21 matches 1.. run execute if score character# slot21 matches 41 run scoreboard players operation lifestealsplash saves /= atkmultiplier slot19
...
execute if score lifesteal slot22 matches 1.. run execute if score splash slot22 matches 1.. run execute if score character# slot22 matches 41 run scoreboard players operation lifestealsplash saves += marks slot19
execute if score lifesteal slot22 matches 1.. run execute if score splash slot22 matches 1.. run execute if score character# slot22 matches 41 run scoreboard players operation lifestealsplash saves /= atkmultiplier slot19
...
execute if score lifesteal slot23 matches 1.. run execute if score splash slot23 matches 1.. run execute if score character# slot23 matches 41 run scoreboard players operation lifestealsplash saves += marks slot19
execute if score lifesteal slot23 matches 1.. run execute if score splash slot23 matches 1.. run execute if score character# slot23 matches 41 run scoreboard players operation lifestealsplash saves /= atkmultiplier slot19
...
execute if score lifesteal slot24 matches 1.. run execute if score splash slot24 matches 1.. run execute if score character# slot24 matches 41 run scoreboard players operation lifestealsplash saves += marks slot19
execute if score lifesteal slot24 matches 1.. run execute if score splash slot24 matches 1.. run execute if score character# slot24 matches 41 run scoreboard players operation lifestealsplash saves /= atkmultiplier slot19
