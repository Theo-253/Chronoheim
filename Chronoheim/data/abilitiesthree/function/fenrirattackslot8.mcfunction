...
tellraw @a[tag=game3] ["",{"selector":"@p[tag=p5]"},"'s Fenrir attacked Slot 8"]
#slot 5
...
execute if score character# slot17 matches 41 run scoreboard players operation atk1 saves += marks slot24
execute if score character# slot17 matches 41 run scoreboard players operation atk1 saves /= atkmultiplier slot24
execute if score character# slot17 matches 41 run scoreboard players operation shield slot24 -= atk1 saves
#slot 6
...
execute if score character# slot18 matches 41 run scoreboard players operation atk1 saves += marks slot24
execute if score character# slot18 matches 41 if score character# slot18 matches 36 run execute unless score durationSlot17-8 fear matches 1.. unless score durationSlot18-8 fear matches 1.. unless score durationSlot19-8 fear matches 1.. unless score durationSlot20-8 fear matches 1.. run scoreboard players operation atk1 saves -= barleyLeader abilityStats
execute if score character# slot18 matches 41 run scoreboard players operation atk1 saves /= atkmultiplier slot24
execute if score character# slot18 matches 41 run scoreboard players operation shield slot24 -= atk1 saves
#slot 7
execute if score character# slot19 matches 41 run scoreboard players operation atk1 saves = atk slot19
execute if score character# slot19 matches 41 run scoreboard players operation atk1 saves += marks slot24
execute if score character# slot19 matches 41 run scoreboard players operation atk1 saves += slot19 atkmodifiers
execute if score character# slot19 matches 41 run scoreboard players operation atk1 saves /= atkmultiplier slot24
execute if score character# slot19 matches 41 run scoreboard players operation shield slot24 -= atk1 saves
#slot 8
execute if score character# slot20 matches 41 run scoreboard players operation atk1 saves = atk slot20
execute if score character# slot20 matches 41 run scoreboard players operation atk1 saves += marks slot24
execute if score character# slot20 matches 41 run scoreboard players operation atk1 saves += slot20 atkmodifiers
execute if score character# slot20 matches 41 run scoreboard players operation atk1 saves /= atkmultiplier slot24
execute if score character# slot20 matches 41 run scoreboard players operation shield slot24 -= atk1 saves
...
execute if score lifesteal slot17 matches 1.. run execute if score character# slot17 matches 41 run scoreboard players operation lifesteal saves += marks slot24
execute if score lifesteal slot17 matches 1.. run execute if score character# slot17 matches 41 run scoreboard players operation lifesteal saves /= atkmultiplier slot24
...
execute if score ward slot24 matches 0 if score slot17bleeding booleaneffects matches 0 run execute if score lifesteal slot17 matches 1.. run execute if score character# slot17 matches 41 run scoreboard players operation slot17 hp += lifesteal saves
execute if score ward slot24 matches 0 if score lifesteal slot17 matches 1.. if score character# slot17 matches 41 at @e[name=slot17,type=armor_stand] run particle minecraft:composter ~ ~1 ~ 0.9 0.9 0.9 0.5 50
#slot 6
...
execute if score lifesteal slot18 matches 1.. run execute if score character# slot18 matches 41 run scoreboard players operation lifesteal saves += marks slot24
execute if score lifesteal slot18 matches 1.. run execute if score character# slot18 matches 41 run scoreboard players operation lifesteal saves /= atkmultiplier slot24
...
execute if score ward slot24 matches 0 if score slot18bleeding booleaneffects matches 0 run execute if score lifesteal slot18 matches 1.. run execute if score character# slot18 matches 41 run scoreboard players operation slot18 hp += lifesteal saves
execute if score ward slot24 matches 0 if score lifesteal slot18 matches 1.. if score character# slot18 matches 41 at @e[name=slot18,type=armor_stand] run particle minecraft:composter ~ ~1 ~ 0.9 0.9 0.9 0.5 50
#slot 7
...
execute if score lifesteal slot19 matches 1.. run execute if score character# slot19 matches 41 run scoreboard players operation lifesteal saves += marks slot24
execute if score lifesteal slot19 matches 1.. run execute if score character# slot19 matches 41 run scoreboard players operation lifesteal saves /= atkmultiplier slot24
...
execute if score ward slot24 matches 0 if score slot19bleeding booleaneffects matches 0 run execute if score lifesteal slot19 matches 1.. run execute if score character# slot19 matches 41 run scoreboard players operation slot19 hp += lifesteal saves
execute if score ward slot24 matches 0 if score lifesteal slot19 matches 1.. if score character# slot19 matches 41 at @e[name=slot19,type=armor_stand] run particle minecraft:composter ~ ~1 ~ 0.9 0.9 0.9 0.5 50
#slot 8
...
execute if score lifesteal slot20 matches 1.. run execute if score character# slot20 matches 41 run scoreboard players operation lifesteal saves += marks slot24
execute if score lifesteal slot20 matches 1.. run execute if score character# slot20 matches 41 run scoreboard players operation lifesteal saves /= atkmultiplier slot24
...
execute if score ward slot24 matches 0 if score slot20bleeding booleaneffects matches 0 run execute if score lifesteal slot20 matches 1.. run execute if score character# slot20 matches 41 run scoreboard players operation slot20 hp += lifesteal saves
execute if score ward slot24 matches 0 if score lifesteal slot20 matches 1.. if score character# slot20 matches 41 at @e[name=slot20,type=armor_stand] run particle minecraft:composter ~ ~1 ~ 0.9 0.9 0.9 0.5 50
...
#Special Cases
execute if score ward slot24 matches ..0 run execute if score character# slot17 matches 41 if score character# slot17 matches 29 if score slot24 hp <= ripperHpBleed abilityStats run scoreboard players operation slot24bleeding booleaneffects = ripperBleed abilityStats
execute if score ward slot24 matches ..0 run execute if score character# slot18 matches 41 if score character# slot18 matches 29 if score slot24 hp <= ripperHpBleed abilityStats run scoreboard players operation slot24bleeding booleaneffects = ripperBleed abilityStats
execute if score ward slot24 matches ..0 run execute if score character# slot19 matches 41 if score character# slot19 matches 29 if score slot24 hp <= ripperHpBleed abilityStats run scoreboard players operation slot24bleeding booleaneffects = ripperBleed abilityStats
execute if score ward slot24 matches ..0 run execute if score character# slot17 matches 41 if score character# slot17 matches -8 run scoreboard players operation slot24Disease disease += zombieDisease abilityStats
execute if score ward slot24 matches ..0 run execute if score character# slot18 matches 41 if score character# slot18 matches -8 run scoreboard players operation slot24Disease disease += zombieDisease abilityStats
execute if score ward slot24 matches ..0 run execute if score character# slot19 matches 41 if score character# slot19 matches -8 run scoreboard players operation slot24Disease disease += zombieDisease abilityStats
execute if score ward slot24 matches ..0 run execute if score character# slot20 matches 41 if score character# slot20 matches -8 run scoreboard players operation slot24Disease disease += zombieDisease abilityStats
