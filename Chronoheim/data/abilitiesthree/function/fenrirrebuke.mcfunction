...
execute unless score fenrircancel3 saves matches 2 if score fenrirattack3 saves matches 2 if score curse slot17 matches 3 run function abilitiesthree:fenrirattackslot1
execute unless score fenrircancel3 saves matches 2 if score fenrirattack3 saves matches 2 if score curse slot18 matches 3 run function abilitiesthree:fenrirattackslot2
execute unless score fenrircancel3 saves matches 2 if score fenrirattack3 saves matches 2 if score curse slot19 matches 3 run function abilitiesthree:fenrirattackslot3
execute unless score fenrircancel3 saves matches 2 if score fenrirattack3 saves matches 2 if score curse slot20 matches 3 run function abilitiesthree:fenrirattackslot4

execute unless score fenrircancel3 saves matches 1 if score fenrirattack3 saves matches 1 if score curse slot21 matches 3 run function abilitiesthree:fenrirattackslot5
execute unless score fenrircancel3 saves matches 1 if score fenrirattack3 saves matches 1 if score curse slot22 matches 3 run function abilitiesthree:fenrirattackslot6
execute unless score fenrircancel3 saves matches 1 if score fenrirattack3 saves matches 1 if score curse slot23 matches 3 run function abilitiesthree:fenrirattackslot7
execute unless score fenrircancel3 saves matches 1 if score fenrirattack3 saves matches 1 if score curse slot24 matches 3 run function abilitiesthree:fenrirattackslot8
