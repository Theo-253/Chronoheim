...
execute as @a[tag=p5] if predicate {condition:"minecraft:entity_properties",entity:"this",predicate:{effects:{"minecraft:fire_resistance":{amplifier:{min:22,max:22}}}}} run tellraw @a[tag=game3] ["",{"selector":"@p[tag=p5]"}," used Divine Retribution!"]
execute as @a[tag=p6] if predicate {condition:"minecraft:entity_properties",entity:"this",predicate:{effects:{"minecraft:fire_resistance":{amplifier:{min:22,max:22}}}}} run tellraw @a[tag=game3] ["",{"selector":"@p[tag=p6]"}," used Divine Retribution!"]
...
execute as @a[tag=p5] if predicate {condition:"minecraft:entity_properties",entity:"this",predicate:{effects:{"minecraft:fire_resistance":{amplifier:{min:22,max:22}}}}} run function ch:abilitygivetargetsp5
execute as @a[tag=p6] if predicate {condition:"minecraft:entity_properties",entity:"this",predicate:{effects:{"minecraft:fire_resistance":{amplifier:{min:22,max:22}}}}} run function ch:abilitygivetargetsp6