...
#Jones Ability
execute if score abilitynumber abilities matches 31 run execute if score ward slot1 matches 0 run scoreboard players set disarmedslot1 booleaneffects 2
