...
execute if score abilitynumber3 abilities matches 22 if score slot23isatk booleans matches 1 if score ward slot17 matches 0 run scoreboard players operation abilitydmg3 saves /= gabrielLeader abilityStats
execute if score abilitynumber3 abilities matches 22 if score slot23isatk booleans matches 1 if score ward slot17 matches 0 run scoreboard players operation slot23 hp += abilitydmg3 saves
