...
execute if score abilitynumber abilities matches 12 run execute if score character# slot6 matches 12 run scoreboard players operation cooldown slot1 = aceSetCooldownLeader abilityStats
...
execute if score abilitynumber abilities matches 41 if score ward slot1 matches ..0 unless score curse slot1 matches 5 unless score curse slot1 matches 3 run scoreboard players set curseDuration slot1 -1
...
execute if score abilitynumber abilities matches 42 run execute at @e[name=slot1,type=armor_stand] run particle minecraft:sonic_boom ~ ~2 ~ 0.03 0.03 0.03 0.01 100
