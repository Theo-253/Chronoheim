...
#Subject ability
execute if score abilitynumber abilities matches 4 run scoreboard players operation slot2Poison poison += subject abilityStats
execute if score abilitynumber abilities matches 4 if score slot6isatk booleans matches 1 run scoreboard players operation slot2Poison poison += subjectLeader abilityStats
...
execute if score abilitynumber abilities matches 3 run scoreboard players operation abilityDmg saves /= atkmultiplier slot2
execute if score abilitynumber abilities matches 3 run execute if score ward slot2 matches 0 run scoreboard players operation shield slot2 -= abilityDmg saves
execute if score abilitynumber abilities matches 3 run execute if score ward slot2 matches 0 if score slot6isatk booleans matches 1 if score durationSlot6-2 fear <= eidolonLeaderFearDuration abilityStats run scoreboard players operation durationSlot6-2 fear = eidolonLeaderFearDuration abilityStats
execute if score abilitynumber abilities matches 3 run execute if score ward slot2 matches 0 if score shield slot2 matches ..0 run scoreboard players operation slot2 hp += shield slot2
execute if score abilitynumber abilities matches 3 run execute if score ward slot2 matches 1.. run function ch:wardslot2
execute if score abilitynumber abilities matches 3 run execute at @e[name=slot2,type=armor_stand] run particle raid_omen ~ ~1 ~ 0.3 0.3 0.3 2 100
