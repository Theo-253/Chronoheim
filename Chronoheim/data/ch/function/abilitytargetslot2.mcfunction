...
execute if score abilitynumber abilities matches 12 run execute if score character# slot6 matches 12 run scoreboard players operation cooldown slot2 = aceSetCooldownLeader abilityStats
...
execute if score abilitynumber abilities matches 38 run scoreboard players operation speed slot2 += igorSpBuff abilityStats
...
execute if score abilitynumber abilities matches 41 if score ward slot2 matches ..0 unless score character# slot2 matches 41 unless score curse slot2 matches 5 run scoreboard players set curse slot2 3
...
execute if score abilitynumber abilities matches 43 run tellraw @a[tag=game1] ["",{"selector":"@p[tag=p2]"}," used Piercing Pestilence on Slot 2!"]
execute if score abilitynumber abilities matches 43 run execute if score ward slot2 matches 0 if score shield slot2 matches ..0 run scoreboard players operation slot2 hp += shield slot2
execute if score abilitynumber abilities matches -43 run execute if score ward slot2 matches 0 if score shield slot2 matches ..0 run scoreboard players operation slot2 hp += shield slot2
#Frank
...
#Anubis
execute if score abilitynumber abilities matches 42 if score ward slot2 matches 0 run scoreboard players operation abilityDmg saves = anubis abilityStats
execute if score abilitynumber abilities matches 42 if score ward slot2 matches 0 run scoreboard players operation abilityDmg saves *= anubisUnusedP2 saves
execute if score abilitynumber abilities matches 42 run execute at @e[name=slot2,type=armor_stand] run particle minecraft:sonic_boom ~ ~2 ~ 0.03 0.03 0.03 0.01 100
execute if score abilitynumber abilities matches 42 run tellraw @a[tag=game1] ["",{"selector":"@p[tag=p2]"}," used Wrath of the Desert on Slot 2!"]
...
execute if score abilitynumber abilities matches 42 run scoreboard players operation abilityDmg saves += marks slot2
execute if score abilitynumber abilities matches 42 run scoreboard players operation abilityDmg saves /= atkmultiplier slot2
execute if score abilitynumber abilities matches 42 run execute if score ward slot2 matches 0 run scoreboard players operation shield slot2 -= abilityDmg saves
execute if score abilitynumber abilities matches 42 run execute if score ward slot2 matches 0 if score shield slot2 matches ..0 run scoreboard players operation slot2 hp += shield slot2
