...
execute if score abilitynumber abilities matches 42 run execute at @e[name=slot2,type=armor_stand] run particle minecraft:sonic_boom ~ ~1.5 ~ 0.03 0.03 0.03 0.01 100
