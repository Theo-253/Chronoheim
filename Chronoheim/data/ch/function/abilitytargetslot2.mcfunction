...
#Garabaldi Ability
execute if score ability# abilities matches 24 if score slot2 hp matches 1.. if score slot2bleeding booleaneffects matches 0 run scoreboard players operation hp slot2 += garabaldiHeal abilityStats
execute if score ability# abilities matches 24 if score slot2 hp matches 1.. run scoreboard players set ward slot2 2
...
execute if score abilitynumber abilities matches 24 run scoreboard players operation abilityDmg saves += marks slot2
execute if score abilitynumber abilities matches 24 run scoreboard players operation abilityDmg saves /= atkmultiplier slot2
execute if score abilitynumber abilities matches 24 run execute if score ward slot2 matches 0 run scoreboard players operation shield slot2 -= abilityDmg saves
execute if score abilitynumber abilities matches 24 run execute if score ward slot2 matches 0 run scoreboard players operation slot2 stun = juniperStun abilityStats
execute if score abilitynumber abilities matches 24 run execute if score ward slot2 matches 0 if score shield slot2 matches ..0 run scoreboard players operation slot2 hp += shield slot2
execute if score abilitynumber abilities matches 24 run execute if score ward slot2 matches 1.. run function ch:wardslot2
...
execute if score character# slot2 matches 27 run function ch:cleanseslot2
...
execute if score abilitynumber abilities matches 7 run execute if score ward slot2 matches 0 if score kongDmgDebuffDuration abilityStats > debuffDurationslot2 speedDebuffs run scoreboard players operation debuffDurationslot2 atkmodifiers = kongDmgDebuffDuration abilityStats
execute if score abilitynumber abilities matches 7 run execute if score ward slot2 matches 0 run scoreboard players operation durationslot2 speedDebuffs += kongSpDebuffDuration abilityStats
execute if score abilitynumber abilities matches 7 run execute if score ward slot2 matches 0 run scoreboard players operation debuffDurationslot2 atkmodifiers += kongDmgDebuffDuration abilityStats
