...
#Subject ability
execute if score abilitynumber abilities matches 4 if score ward slot3 matches 0 if score durationSlot3 poison < subjectDuration abilityStats run scoreboard players operation durationSlot3 poison = subjectDuration abilityStats
execute if score abilitynumber abilities matches 4 if score ward slot3 matches 0 run scoreboard players operation slot3Poison poison += subject abilityStats
execute if score abilitynumber abilities matches 4 if score ward slot3 matches 0 if score slot6isatk booleans matches 1 run scoreboard players operation slot3Poison poison += subjectLeader abilityStats
execute if score abilitynumber abilities matches 4 at @e[name=slot3] run particle minecraft:trial_omen ~ ~1 ~ 0.9 0.9 0.9 0.1 50
execute if score abilitynumber abilities matches 4 run execute if score ward slot3 matches 1.. run function ch:wardslot3
execute if score abilitynumber abilities matches 4 run tellraw @a[tag=game1] ["",{"selector":"@p[tag=p2]"}," used Contagion on Slot 3!"]
...
#Robyn Ability
execute if score abilitynumber abilities matches 9 if score ward slot3 matches 0 if score durationSlot3 mark < robynDuration abilityStats run scoreboard players operation durationSlot3 mark = robynDuration abilityStats
...
execute if score abilitynumber abilities matches 22 at @e[name=slot3] run particle minecraft:flash{color:[1.000,1.000,1.000,1.00]} ~ ~1 ~ 0.9 0.9 0.9 0.5 100
...
execute if score abilitynumber abilities matches 32 if score ward slot3 matches 0 if score slot6isatk booleans matches 1 if score durationSlot3 mark < scytheDuration abilityStats run scoreboard players operation durationSlot3 mark = scytheDuration abilityStats
...
#Doc Basic Attack
#Doc Basic Attack
execute if score abilitynumber abilities matches -1 if score ward slot3 matches 0 run scoreboard players operation slot3Disease disease += doc heroattack
execute if score abilitynumber abilities matches -1 if score ward slot3 matches 0 if score slot6isatk booleans matches 1 run scoreboard players operation slot3Disease disease += docLeader heroattack
execute if score abilitynumber abilities matches -1 run execute if score ward slot3 matches 1.. run function ch:wardslot3
...
execute if score abilitynumber abilities matches 28 run scoreboard players operation abilityDmg saves += marks slot3
execute if score abilitynumber abilities matches 28 run scoreboard players operation abilityDmg saves /= atkmultiplier slot3
execute if score abilitynumber abilities matches 28 run execute if score ward slot3 matches 0 run scoreboard players operation shield slot3 -= abilityDmg saves
execute if score abilitynumber abilities matches 28 run execute if score ward slot3 matches 0 if score slot6isatk booleans matches 1 if score durationSlot6-3 fear <= eidolonLeaderFearDuration abilityStats run scoreboard players operation durationSlot6-3 fear = eidolonLeaderFearDuration abilityStats
execute if score abilitynumber abilities matches 28 run execute if score ward slot3 matches 0 if score shield slot3 matches ..0 run scoreboard players operation slot3 hp += shield slot3
execute if score abilitynumber abilities matches 28 run execute if score ward slot3 matches 1.. run function ch:wardslot3
execute if score abilitynumber abilities matches 28 run execute at @e[name=slot3,type=armor_stand] run particle raid_omen ~ ~1 ~ 0.3 0.3 0.3 2 100

#Barley
execute if score abilitynumber abilities matches -36 if score barleyPart1 abilities matches 5 if score ward slot3 matches ..0 run scoreboard players operation durationSlot5-3 fear = barleyDuration abilityStats 
execute if score abilitynumber abilities matches -36 if score barleyPart1 abilities matches 6 if score ward slot3 matches ..0 run scoreboard players operation durationSlot6-3 fear = barleyDuration abilityStats 
execute if score abilitynumber abilities matches -36 if score barleyPart1 abilities matches 7 if score ward slot3 matches ..0 run scoreboard players operation durationSlot7-3 fear = barleyDuration abilityStats 
execute if score abilitynumber abilities matches -36 if score barleyPart1 abilities matches 8 if score ward slot3 matches ..0 run scoreboard players operation durationSlot8-3 fear = barleyDuration abilityStats 
...
execute if score abilitynumber abilities matches -36 if score ward slot3 matches ..0 run scoreboard players operation attackDebuffSlot3 atkmodifiers += barley abilityStats
...
execute if score abilitynumber abilities matches 36 run scoreboard players set barleyPart1 abilities 3
...
execute if score abilitynumber abilities matches 38 if score slot2isatk booleans matches 1 run scoreboard players operation savehp3 saves = slot3 hp
...
execute if score abilitynumber abilities matches 40 if score ward slot3 matches ..0 unless score curse slot3 matches 5 unless score curse slot3 matches 2 run scoreboard players set curseDuration slot3 -1
...
execute if score abilitynumber abilities matches 40 if score ward slot3 matches ..0 run scoreboard players operation slot3Burn burn += zeeboBurn abilityStats
...
execute if score abilitynumber abilities matches 40 run tellraw @a[tag=game1] ["",{"selector":"@p[tag=p2]"}," used Last Laugh on Slot 3!"]
execute if score abilitynumber abilities matches 40 run execute at @e[type=armor_stand,name=slot3] run summon firework_rocket ~ ~2 ~ {LifeTime:1,FireworksItem:{id:"minecraft:firework_rocket",count:1,components:{"minecraft:fireworks":{explosions:[{shape:"burst",has_twinkle:true,has_trail:true,colors:[I;13894251,16746496,16770560],fade_colors:[I;10224278]}]}}}}
...
execute if score abilitynumber abilities matches 41 if score ward slot3 matches ..0 unless score curse slot3 matches 5 unless score curse slot3 matches 3 run scoreboard players set curseDuration slot3 -1
execute if score abilitynumber abilities matches 41 if score ward slot3 matches ..0 unless score character# slot3 matches 41 unless score curse slot3 matches 5 run scoreboard players set curse slot3 3
...
execute if score abilitynumber abilities matches 41 run tellraw @a[tag=game1] ["",{"selector":"@p[tag=p2]"}," used Mark of the Wolf on Slot 3!"]
execute if score abilitynumber abilities matches 41 run execute if score ward slot3 matches 0 if score shield slot3 matches ..0 run scoreboard players operation slot3 hp += shield slot3
...
execute if score abilitynumber abilities matches -43 run execute at @e[type=armor_stand,name=slot3] run particle minecraft:noxious_gas ~ ~1 ~ 0.7 0.7 0.7 0.05 200
execute if score abilitynumber abilities matches -43 if score ward slot3 matches 1.. run function ch:wardslot3
execute if score abilitynumber abilities matches -43 run tellraw @a[tag=game1] ["",{"selector":"@p[tag=p2]"}," used Piercing Pestilence on Slot 3!"]
execute if score abilitynumber abilities matches 43 run tellraw @a[tag=game1] ["",{"selector":"@p[tag=p2]"}," used Piercing Pestilence on Slot 3!"]
execute if score abilitynumber abilities matches 43 run execute if score ward slot3 matches 0 if score shield slot3 matches ..0 run scoreboard players operation slot3 hp += shield slot3
execute if score abilitynumber abilities matches -43 run execute if score ward slot3 matches 0 if score shield slot3 matches ..0 run scoreboard players operation slot3 hp += shield slot3
#Frank
...
execute if score abilitynumber abilities matches 34 run tellraw @a[tag=game1] ["",{"selector":"@p[tag=p1]"}," used IT'S ALIVE! to damage Slot 3!"]
...
execute if score abilitynumber abilities matches -34 run tellraw @a[tag=game1] ["",{"selector":"@p[tag=p2]"}," used IT'S ALIVE! to stun Slot 3!"]
...
execute if score abilitynumber abilities matches 35 run tellraw @a[tag=game1] ["",{"selector":"@p[tag=p2]"}," used Reanimation Beam to damage Slot 3!"]
...
execute if score abilitynumber abilities matches -35 if score character# slot2 matches 34 run function ch:cleanseslot3
...
#Anubis
execute if score abilitynumber abilities matches 42 if score ward slot3 matches 0 run scoreboard players operation abilityDmg saves = anubis abilityStats
execute if score abilitynumber abilities matches 42 if score ward slot3 matches 0 run scoreboard players operation abilityDmg saves *= anubisUnusedP2 saves
execute if score abilitynumber abilities matches 42 run execute at @e[name=slot3,type=armor_stand] run particle minecraft:sonic_boom ~ ~2 ~ 0.03 0.03 0.03 0.01 100
execute if score abilitynumber abilities matches 42 run tellraw @a[tag=game1] ["",{"selector":"@p[tag=p2]"}," used Wrath of the Desert on Slot 3!"]
...
execute if score abilitynumber abilities matches 42 run scoreboard players operation abilityDmg saves += marks slot3
execute if score abilitynumber abilities matches 42 run scoreboard players operation abilityDmg saves /= atkmultiplier slot3
execute if score abilitynumber abilities matches 42 run execute if score ward slot3 matches 0 run scoreboard players operation shield slot3 -= abilityDmg saves
execute if score abilitynumber abilities matches 42 run execute if score ward slot3 matches 0 if score shield slot3 matches ..0 run scoreboard players operation slot3 hp += shield slot3
