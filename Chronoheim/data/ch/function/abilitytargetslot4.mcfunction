...
#Subject ability
execute if score abilitynumber abilities matches 4 if score ward slot4 matches 0 if score durationSlot4 poison < subjectDuration abilityStats run scoreboard players operation durationSlot4 poison = subjectDuration abilityStats
execute if score abilitynumber abilities matches 4 if score ward slot4 matches 0 run scoreboard players operation slot4Poison poison += subject abilityStats
execute if score abilitynumber abilities matches 4 if score ward slot4 matches 0 if score slot6isatk booleans matches 1 run scoreboard players operation slot4Poison poison += subjectLeader abilityStats
execute if score abilitynumber abilities matches 4 at @e[name=slot4] run particle minecraft:trial_omen ~ ~1 ~ 0.9 0.9 0.9 0.1 50
execute if score abilitynumber abilities matches 4 run execute if score ward slot4 matches 1.. run function ch:wardslot4
execute if score abilitynumber abilities matches 4 run tellraw @a[tag=game1] ["",{"selector":"@p[tag=p2]"}," used Contagion on Slot 4!"]
...
#Robyn Ability
execute if score abilitynumber abilities matches 9 if score ward slot4 matches 0 if score durationSlot4 mark < robynDuration abilityStats run scoreboard players operation durationSlot4 mark = robynDuration abilityStats
...
execute if score abilitynumber abilities matches 5 if score slot2isatk booleans matches 1 run scoreboard players operation shield slot4 += roboLeader abilityStats
...
execute if score abilitynumber abilities matches 8 if score slot2isatk booleans matches 1 if score slot4bleeding booleaneffects matches 0 run scoreboard players operation slot4 hp += kirinLeader abilityStats
...
execute if score abilitynumber abilities matches 12 run execute if score character# slot6 matches 12 run scoreboard players operation cooldown slot4 = aceSetCooldownLeader abilityStats
...
execute if score abilitynumber abilities matches 22 at @e[name=slot4] run particle minecraft:flash{color:[1.000,1.000,1.000,1.00]} ~ ~1 ~ 0.9 0.9 0.9 0.5 100
...
execute if score abilitynumber abilities matches 32 if score ward slot4 matches 0 if score slot6isatk booleans matches 1 if score durationSlot4 mark < scytheDuration abilityStats run scoreboard players operation durationSlot4 mark = scytheDuration abilityStats
...
#Doc Basic Attack
execute if score abilitynumber abilities matches -1 if score ward slot4 matches 0 run scoreboard players operation slot4Disease disease += doc heroattack
execute if score abilitynumber abilities matches -1 if score ward slot4 matches 0 if score slot6isatk booleans matches 1 run scoreboard players operation slot4Disease disease += docLeader heroattack
execute if score abilitynumber abilities matches -1 run execute if score ward slot4 matches 1.. run function ch:wardslot4
...
execute if score abilitynumber abilities matches 31 run scoreboard players operation abilityDmg saves += marks slot4
execute if score abilitynumber abilities matches 31 run scoreboard players operation abilityDmg saves /= atkmultiplier slot4
execute if score abilitynumber abilities matches 31 run execute if score ward slot4 matches 0 run scoreboard players operation shield slot4 -= abilityDmg saves
execute if score abilitynumber abilities matches 31 run execute if score ward slot4 matches 0 if score shield slot4 matches ..0 run scoreboard players operation slot4 hp += shield slot4
...
execute if score abilitynumber abilities matches 28 run scoreboard players operation abilityDmg saves += marks slot4
execute if score abilitynumber abilities matches 28 run scoreboard players operation abilityDmg saves /= atkmultiplier slot4
execute if score abilitynumber abilities matches 28 run execute if score ward slot4 matches 0 run scoreboard players operation shield slot4 -= abilityDmg saves
execute if score abilitynumber abilities matches 28 run execute if score ward slot4 matches 0 if score slot6isatk booleans matches 1 if score durationSlot6-4 fear <= eidolonLeaderFearDuration abilityStats run scoreboard players operation durationSlot6-4 fear = eidolonLeaderFearDuration abilityStats
execute if score abilitynumber abilities matches 28 run execute if score ward slot4 matches 0 if score shield slot4 matches ..0 run scoreboard players operation slot4 hp += shield slot4
execute if score abilitynumber abilities matches 28 run execute if score ward slot4 matches 1.. run function ch:wardslot4
execute if score abilitynumber abilities matches 28 run execute at @e[name=slot4,type=armor_stand] run particle raid_omen ~ ~1 ~ 0.3 0.3 0.3 2 100

#Barley
execute if score abilitynumber abilities matches -36 if score barleyPart1 abilities matches 5 if score ward slot4 matches ..0 run scoreboard players operation durationSlot5-4 fear = barleyDuration abilityStats 
execute if score abilitynumber abilities matches -36 if score barleyPart1 abilities matches 6 if score ward slot4 matches ..0 run scoreboard players operation durationSlot6-4 fear = barleyDuration abilityStats 
execute if score abilitynumber abilities matches -36 if score barleyPart1 abilities matches 7 if score ward slot4 matches ..0 run scoreboard players operation durationSlot7-4 fear = barleyDuration abilityStats 
execute if score abilitynumber abilities matches -36 if score barleyPart1 abilities matches 8 if score ward slot4 matches ..0 run scoreboard players operation durationSlot8-4 fear = barleyDuration abilityStats 
...
execute if score abilitynumber abilities matches -36 if score ward slot4 matches ..0 run scoreboard players operation attackDebuffSlot4 atkmodifiers += barley abilityStats
...
#Igor
execute if score abilitynumber abilities matches 38 if score cooldown slot4 matches 1.. run scoreboard players operation cooldown slot4 -= igor abilityStats
...
execute if score abilitynumber abilities matches 38 run scoreboard players operation speed slot4 += igorSpBuff abilityStats
...
execute if score abilitynumber abilities matches 38 run tellraw @a[tag=game1] ["",{"selector":"@p[tag=p1]"}," used Black Lagoon Brew on Slot 4!"]
...
execute if score abilitynumber abilities matches 38 if score slot2isatk booleans matches 1 run scoreboard players operation savehp4 saves = slot4 hp
...
execute if score abilitynumber abilities matches 40 if score ward slot4 matches ..0 unless score curse slot4 matches 5 unless score curse slot4 matches 2 run scoreboard players set curseDuration slot4 -1
...
execute if score abilitynumber abilities matches 40 if score ward slot4 matches ..0 run scoreboard players operation slot4Burn burn += zeeboBurn abilityStats
...
execute if score abilitynumber abilities matches 40 run tellraw @a[tag=game1] ["",{"selector":"@p[tag=p2]"}," used Last Laugh on Slot 4!"]
execute if score abilitynumber abilities matches 40 run execute at @e[type=armor_stand,name=slot4] run summon firework_rocket ~ ~2 ~ {LifeTime:1,FireworksItem:{id:"minecraft:firework_rocket",count:1,components:{"minecraft:fireworks":{explosions:[{shape:"burst",has_twinkle:true,has_trail:true,colors:[I;13894251,16746496,16770560],fade_colors:[I;10224278]}]}}}}
...
execute if score abilitynumber abilities matches 41 run tellraw @a[tag=game1] ["",{"selector":"@p[tag=p2]"}," used Mark of the Wolf on Slot 4!"]
execute if score abilitynumber abilities matches 41 run execute if score ward slot4 matches 0 if score shield slot4 matches ..0 run scoreboard players operation slot4 hp += shield slot4
...
execute if score abilitynumber abilities matches -43 run execute at @e[type=armor_stand,name=slot4] run particle minecraft:noxious_gas ~ ~1 ~ 0.7 0.7 0.7 0.05 200
execute if score abilitynumber abilities matches -43 if score ward slot4 matches 1.. run function ch:wardslot4
execute if score abilitynumber abilities matches -43 run tellraw @a[tag=game1] ["",{"selector":"@p[tag=p2]"}," used Piercing Pestilence on Slot 4!"]
execute if score abilitynumber abilities matches 43 run tellraw @a[tag=game1] ["",{"selector":"@p[tag=p2]"}," used Piercing Pestilence on Slot 4!"]
execute if score abilitynumber abilities matches 43 run execute if score ward slot4 matches 0 if score shield slot4 matches ..0 run scoreboard players operation slot4 hp += shield slot4
execute if score abilitynumber abilities matches -43 run execute if score ward slot4 matches 0 if score shield slot4 matches ..0 run scoreboard players operation slot4 hp += shield slot4
#Frank
...
execute if score abilitynumber abilities matches -34 run tellraw @a[tag=game1] ["",{"selector":"@p[tag=p2]"}," used IT'S ALIVE! to stun Slot 4!"]
...
execute if score abilitynumber abilities matches -35 if score character# slot2 matches 34 run function ch:cleanseslot4
...
execute if score abilitynumber abilities matches -35 run tellraw @a[tag=game1] ["",{"selector":"@p[tag=p1]"}," used Reanimation Beam to heal Slot 4!"]

#Boogaloo
execute if score abilitynumber abilities matches 37 unless score curse slot4 matches 5 run scoreboard players set curseDuration slot4 0
execute if score abilitynumber abilities matches 37 if score curseStacks slot4 matches 1.. unless score curse slot4 matches 5 run scoreboard players set curseStacks slot4 -1
...
execute if score abilitynumber abilities matches 42 run execute at @e[name=slot4,type=armor_stand] run particle minecraft:sonic_boom ~ ~2 ~ 0.03 0.03 0.03 0.01 100
