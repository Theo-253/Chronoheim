...
#Subject ability
execute if score abilitynumber abilities matches 4 if score ward slot5 matches 0 if score durationSlot5 poison < subjectDuration abilityStats run scoreboard players operation durationSlot5 poison = subjectDuration abilityStats
execute if score abilitynumber abilities matches 4 if score ward slot5 matches 0 run scoreboard players operation slot5Poison poison += subject abilityStats
execute if score abilitynumber abilities matches 4 if score ward slot5 matches 0 if score slot2isatk booleans matches 1 run scoreboard players operation slot5Poison poison += subjectLeader abilityStats
...
execute if score abilitynumber abilities matches 24 run execute at @n[type=armor_stand,name=slot5] run particle minecraft:composter ~ ~1 ~ 0.9 0.9 0.9 0.5 100
...
execute if score abilitynumber abilities matches 27 run execute at @e[name=slot5,type=armor_stand] run particle firefly ~ ~1 ~ 0.3 0.3 0.3 1 100
...
execute if score abilitynumber abilities matches -2 run execute at @n[type=armor_stand,name=slot5] run particle minecraft:composter ~ ~1 ~ 0.9 0.9 0.9 0.5 100
execute if score abilitynumber abilities matches -2 run execute if score slot5bleeding booleaneffects matches 0 if score slot6isatk booleans matches 1 run scoreboard players operation slot5 hp += juniperLeader heroattack
...
execute if score abilitynumber abilities matches 7 run execute at @n[type=armor_stand,name=slot5] run particle minecraft:explosion_emitter ~ ~1 ~
execute if score abilitynumber abilities matches 9 run execute at @n[type=armor_stand,name=slot5] run particle minecraft:angry_villager ~ ~1 ~ 0.9 0.9 0.9 1 50
...
#Robyn Ability
execute if score abilitynumber abilities matches 9 if score ward slot5 matches 0 if score durationSlot5 mark < robynDuration abilityStats run scoreboard players operation durationSlot5 mark = robynDuration abilityStats
...
execute if score abilitynumber abilities matches 5 if score slot6isatk booleans matches 1 run scoreboard players operation shield slot5 += roboLeader abilityStats
execute if score abilitynumber abilities matches 5 run execute at @n[name=slot5,type=armor_stand] run particle minecraft:wax_off ~ ~1 ~ 0.6 0.6 0.6 0.0001 400
...
execute if score abilitynumber abilities matches 8 if score slot6isatk booleans matches 1 if score slot5bleeding booleaneffects matches 0 run scoreboard players operation slot5 hp += kirinLeader abilityStats
...
execute if score abilitynumber abilities matches 12 run execute if score character# slot2 matches 12 run scoreboard players operation cooldown slot5 = aceSetCooldownLeader abilityStats
...
execute if score abilitynumber abilities matches 22 at @e[name=slot5] run particle minecraft:flash{color:[1.000,1.000,1.000,1.00]} ~ ~1 ~ 0.9 0.9 0.9 0.5 100
...
#Scythe
execute if score abilitynumber abilities matches 32 if score ward slot5 matches 0 run scoreboard players operation slot5 hp /= scytheDivide abilityStats
execute if score abilitynumber abilities matches 32 if score ward slot5 matches 0 run scoreboard players operation slot5 hp *= scytheMult abilityStats
execute if score abilitynumber abilities matches 32 if score ward slot5 matches 0 if score slot2isatk booleans matches 1 if score durationSlot5 mark < scytheDuration abilityStats run scoreboard players operation durationSlot5 mark = scytheDuration abilityStats
execute if score abilitynumber abilities matches 32 if score ward slot5 matches 0 if score slot2isatk booleans matches 1 run scoreboard players operation marks slot5 += scytheLeader abilityStats
execute if score abilitynumber abilities matches 32 if score ward slot5 matches 1.. run function ch:wardslot5
execute if score abilitynumber abilities matches 32 at @e[name=slot5] run particle minecraft:sculk_soul ~ ~1 ~ 0.9 0.9 0.9 0.1 100
...
execute if score abilitynumber abilities matches -4 run execute if score ward slot5 matches 1.. run function ch:wardslot5
execute if score abilitynumber abilities matches -4 run execute at @e[name=slot5,type=armor_stand] run particle minecraft:crit ~ ~1 ~ 0.9 0.9 0.9 0.5 100
...
execute if score abilitynumber abilities matches 31 run scoreboard players operation abilityDmg saves += marks slot5
execute if score abilitynumber abilities matches 31 run scoreboard players operation abilityDmg saves /= atkmultiplier slot5
execute if score abilitynumber abilities matches 31 run execute if score ward slot5 matches 0 run scoreboard players operation shield slot5 -= abilityDmg saves
execute if score abilitynumber abilities matches 31 run execute if score ward slot5 matches 0 if score shield slot5 matches ..0 run scoreboard players operation slot5 hp += shield slot5
execute if score abilitynumber abilities matches 31 run execute if score ward slot5 matches 0 run scoreboard players operation disarmedslot5 booleaneffects = jones abilityStats
execute if score abilitynumber abilities matches 31 run execute if score ward slot5 matches 1 run function ch:wardslot5
execute if score abilitynumber abilities matches 31 run tellraw @a[tag=game1] ["",{"selector":"@p[tag=p1]"}," used Lasso on Slot 5!"]
execute if score abilitynumber abilities matches 31 at @e[name=slot5] run particle minecraft:crit ~ ~1 ~ 0.9 0.9 0.9 0.1 100


#Sherman Basic
execute if score abilitynumber abilities matches -5 run execute unless score slot5bleeding booleaneffects matches 1.. run scoreboard players operation slot5 hp += sherman heroattack
execute if score abilitynumber abilities matches -5 run tellraw @a[tag=game1] ["",{"selector":"@p[tag=p2]"}," healed Slot 5!"]
execute if score abilitynumber abilities matches -5 run execute at @n[type=armor_stand,name=slot5] run particle minecraft:composter ~ ~1 ~ 0.9 0.9 0.9 0.5 80


#Sherman Ability
execute if score abilitynumber abilities matches 33 run execute if score ward slot5 matches 0 if score debuffDurationSlot5 atkmodifiers < shermanDuration abilityStats run scoreboard players operation debuffDurationSlot5 atkmodifiers = shermanDuration abilityStats
execute if score abilitynumber abilities matches 33 run execute if score ward slot5 matches 0 run scoreboard players operation attackDebuffSlot5 atkmodifiers += shermanDebuff abilityStats
...
execute if score abilitynumber abilities matches 33 at @e[name=slot5] run particle minecraft:pale_oak_leaves ~ ~1 ~ 0.9 0.9 0.9 0.1 100
execute if score abilitynumber abilities matches 33 at @e[name=slot5] run particle minecraft:explosion ~ ~1 ~ 0.9 0.9 0.9 0.1 10
...
execute if score abilitynumber abilities matches 33 run tellraw @a[tag=game1] ["",{"selector":"@p[tag=p1]"}," used Grasping Roots on Slot 5!"]
execute if score abilitynumber abilities matches 33 run scoreboard players operation abilityDmg saves = sherman abilityStats
execute if score abilitynumber abilities matches 33 if score slot1isatk booleans matches 1 run scoreboard players operation abilityDmg saves += slot1 atkmodifiers
execute if score abilitynumber abilities matches 33 if score slot2isatk booleans matches 1 run scoreboard players operation abilityDmg saves += slot2 atkmodifiers
execute if score abilitynumber abilities matches 33 if score slot3isatk booleans matches 1 run scoreboard players operation abilityDmg saves += slot3 atkmodifiers
...
execute if score abilitynumber abilities matches 28 run scoreboard players operation abilityDmg saves += marks slot5
execute if score abilitynumber abilities matches 28 run scoreboard players operation abilityDmg saves /= atkmultiplier slot5
execute if score abilitynumber abilities matches 28 run execute if score ward slot5 matches 0 run scoreboard players operation shield slot5 -= abilityDmg saves
execute if score abilitynumber abilities matches 28 run execute if score ward slot5 matches 0 if score slot2isatk booleans matches 1 if score durationSlot2-5 fear <= eidolonLeaderFearDuration abilityStats run scoreboard players operation durationSlot2-5 fear = eidolonLeaderFearDuration abilityStats
execute if score abilitynumber abilities matches 28 run execute if score ward slot5 matches 0 if score shield slot5 matches ..0 run scoreboard players operation slot5 hp += shield slot5
execute if score abilitynumber abilities matches 28 run execute if score ward slot5 matches 1.. run function ch:wardslot5
execute if score abilitynumber abilities matches 28 run execute at @e[name=slot5,type=armor_stand] run particle raid_omen ~ ~1 ~ 0.3 0.3 0.3 2 100

#Barley
execute if score abilitynumber abilities matches -36 if score barleyPart1 abilities matches 1 if score ward slot5 matches ..0 run scoreboard players operation durationSlot1-5 fear = barleyDuration abilityStats 
execute if score abilitynumber abilities matches -36 if score barleyPart1 abilities matches 2 if score ward slot5 matches ..0 run scoreboard players operation durationSlot2-5 fear = barleyDuration abilityStats 
execute if score abilitynumber abilities matches -36 if score barleyPart1 abilities matches 3 if score ward slot5 matches ..0 run scoreboard players operation durationSlot3-5 fear = barleyDuration abilityStats 
execute if score abilitynumber abilities matches -36 if score barleyPart1 abilities matches 4 if score ward slot5 matches ..0 run scoreboard players operation durationSlot4-5 fear = barleyDuration abilityStats 
execute if score abilitynumber abilities matches -36 if score ward slot5 matches ..0 if score debuffDurationSlot5 atkmodifiers < barleyDuration abilityStats run scoreboard players operation debuffDurationSlot5 atkmodifiers = barleyDuration abilityStats
execute if score abilitynumber abilities matches -36 if score ward slot5 matches ..0 run scoreboard players operation attackDebuffSlot5 atkmodifiers += barley abilityStats
execute if score abilitynumber abilities matches -36 if score ward slot5 matches 1.. run function ch:wardslot5
execute if score abilitynumber abilities matches -36 run execute at @n[type=armor_stand,name=slot5] run particle trial_omen ~ ~1 ~ 0.9 0.9 0.9 0.1 400
execute if score abilitynumber abilities matches -36 run tellraw @a[tag=game1] ["",{"selector":"@p[tag=p1]"}," used Spookcrow to fear Slot 5!"]

execute if score abilitynumber abilities matches 36 run scoreboard players set barleyPart1 abilities 5
execute if score abilitynumber abilities matches 36 if score buffDurationSlot5 atkmodifiers < barleyDuration abilityStats run scoreboard players operation buffDurationSlot5 atkmodifiers = barleyDuration abilityStats
execute if score abilitynumber abilities matches 36 run scoreboard players operation attackBuffSlot5 atkmodifiers += barley abilityStats
execute if score abilitynumber abilities matches 36 run function ch:abilitygivetargetsp2
execute if score abilitynumber abilities matches 36 run execute at @n[type=armor_stand,name=slot5] run particle raid_omen ~ ~1 ~ 0.9 0.9 0.9 0.1 400
execute if score abilitynumber abilities matches 36 run tellraw @a[tag=game1] ["",{"selector":"@p[tag=p2]"}," used Spookcrow to make Slot 5 scary!"]

#Igor
execute if score abilitynumber abilities matches 38 if score cooldown slot5 matches 1.. run scoreboard players operation cooldown slot5 -= igor abilityStats
execute if score abilitynumber abilities matches 38 run execute at @e[type=armor_stand,name=slot5] run particle witch ~ ~1 ~ 0.5 0.8 0.5 0.1 100
execute if score abilitynumber abilities matches 38 run execute if score durationSlot5 speedBuffs < igorDuration abilityStats run scoreboard players operation durationSlot5 speedBuffs = igorDuration abilityStats
execute if score abilitynumber abilities matches 38 run scoreboard players operation speed slot5 += igorSpBuff abilityStats
...
execute if score abilitynumber abilities matches 40 run execute at @e[type=armor_stand,name=slot5] run summon firework_rocket ~ ~2 ~ {LifeTime:1,FireworksItem:{id:"minecraft:firework_rocket",count:1,components:{"minecraft:fireworks":{explosions:[{shape:"burst",has_twinkle:true,has_trail:true,colors:[I;13894251,16746496,16770560],fade_colors:[I;10224278]}]}}}}
execute if score abilitynumber abilities matches 40 if score ward slot5 matches 1.. run function ch:wardslot5
...
execute if score abilitynumber abilities matches 41 if score ward slot5 matches ..0 unless score character# slot5 matches 41 unless score curse slot5 matches 5 run scoreboard players set curse slot5 3
...
execute if score abilitynumber abilities matches 41 run scoreboard players operation abilityDmg saves += marks slot5
execute if score abilitynumber abilities matches 41 run scoreboard players operation abilityDmg saves /= atkmultiplier slot5
...
execute if score abilitynumber abilities matches 43 run scoreboard players operation abilityDmg saves += marks slot5
execute if score abilitynumber abilities matches 43 run scoreboard players operation abilityDmg saves /= atkmultiplier slot5
execute if score abilitynumber abilities matches 43 run execute if score ward slot5 matches ..0 run scoreboard players operation shield slot5 -= abilityDmg saves
execute if score abilitynumber abilities matches 43 run execute if score ward slot5 matches ..0 run scoreboard players operation slot5Disease disease += grendelDisease abilityStats
execute if score abilitynumber abilities matches 43 run execute at @e[type=armor_stand,name=slot5] run particle minecraft:noxious_gas ~ ~1 ~ 0.7 0.7 0.7 0.05 200
execute if score abilitynumber abilities matches 43 if score ward slot5 matches 1.. run function ch:wardslot5
...
execute if score abilitynumber abilities matches -43 run execute at @e[type=armor_stand,name=slot5] run particle minecraft:noxious_gas ~ ~1 ~ 0.7 0.7 0.7 0.05 200
execute if score abilitynumber abilities matches -43 if score ward slot5 matches 1.. run function ch:wardslot5
execute if score abilitynumber abilities matches -43 run tellraw @a[tag=game1] ["",{"selector":"@p[tag=p1]"}," used Piercing Pestilence on Slot 5!"]
execute if score abilitynumber abilities matches 43 run tellraw @a[tag=game1] ["",{"selector":"@p[tag=p1]"}," used Piercing Pestilence on Slot 5!"]
execute if score abilitynumber abilities matches 43 run execute if score ward slot5 matches 0 if score shield slot5 matches ..0 run scoreboard players operation slot5 hp += shield slot5
execute if score abilitynumber abilities matches -43 run execute if score ward slot5 matches 0 if score shield slot5 matches ..0 run scoreboard players operation slot5 hp += shield slot5
#Frank
execute if score abilitynumber abilities matches 34 run scoreboard players operation abilityDmg saves = frank abilityStats
execute if score abilitynumber abilities matches 34 run scoreboard players operation shield slot5 -= abilityDmg saves
execute if score abilitynumber abilities matches 34 run scoreboard players operation slot5 hp += shield slot5
execute if score abilitynumber abilities matches 34 run execute at @e[name=slot5,type=armor_stand] run particle minecraft:angry_villager ~ ~1 ~ 0.9 0.9 0.9 0.5 15
execute if score abilitynumber abilities matches 34 run tellraw @a[tag=game1] ["",{"selector":"@p[tag=p2]"}," used IT'S ALIVE! to damage Slot 5!"]
execute if score abilitynumber abilities matches 34 run function ch:abilitygivetargetsp2

execute if score abilitynumber abilities matches -34 run execute if score ward slot5 matches 0 run scoreboard players operation slot5 stun = frankDuration abilityStats
execute if score abilitynumber abilities matches -34 run execute if score ward slot5 matches 1.. run function ch:wardslot5
execute if score abilitynumber abilities matches -34 run execute at @e[name=slot5,type=armor_stand] run particle minecraft:flash{color:[1.000,1.000,1.000,1.00]} ~ ~1 ~ 0.9 0.9 0.9 0.5 100
execute if score abilitynumber abilities matches -34 run tellraw @a[tag=game1] ["",{"selector":"@p[tag=p1]"}," used IT'S ALIVE! to stun Slot 5!"]
...
execute if score abilitynumber abilities matches 35 run scoreboard players operation abilityDmg saves += marks slot5
execute if score abilitynumber abilities matches 35 run scoreboard players operation abilityDmg saves /= atkmultiplier slot5
execute if score abilitynumber abilities matches 35 run execute if score ward slot5 matches 0 run scoreboard players operation shield slot5 -= abilityDmg saves
execute if score abilitynumber abilities matches 35 run execute if score ward slot5 matches 0 if score shield slot5 matches ..0 run scoreboard players operation slot5 hp += shield slot5
...
execute if score abilitynumber abilities matches -35 if score character# slot6 matches 35 run function ch:cleanseslot5
execute if score abilitynumber abilities matches -35 if score character# slot6 matches 34 run function ch:cleanseslot5
...
#Boogaloo
execute if score abilitynumber abilities matches 37 unless score curse slot5 matches 5 run scoreboard players set curseDuration slot5 -1
...
execute if score abilitynumber abilities matches 42 run scoreboard players operation abilityDmg saves += marks slot5
execute if score abilitynumber abilities matches 42 run scoreboard players operation abilityDmg saves /= atkmultiplier slot5
execute if score abilitynumber abilities matches 42 run execute if score ward slot5 matches 0 run scoreboard players operation shield slot5 -= abilityDmg saves
execute if score abilitynumber abilities matches 42 run execute if score ward slot5 matches 0 if score shield slot5 matches ..0 run scoreboard players operation slot5 hp += shield slot5
