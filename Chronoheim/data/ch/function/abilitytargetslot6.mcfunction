...
#Barley
execute if score abilitynumber abilities matches -36 if score barleyPart1 abilities matches 5 if score ward slot6 matches ..0 run scoreboard players operation durationSlot1-1 fear = barleyDuration abilityStats 
execute if score abilitynumber abilities matches -36 if score barleyPart1 abilities matches 6 if score ward slot6 matches ..0 run scoreboard players operation durationSlot2-1 fear = barleyDuration abilityStats 
execute if score abilitynumber abilities matches -36 if score barleyPart1 abilities matches 7 if score ward slot6 matches ..0 run scoreboard players operation durationSlot3-1 fear = barleyDuration abilityStats 
execute if score abilitynumber abilities matches -36 if score barleyPart1 abilities matches 8 if score ward slot6 matches ..0 run scoreboard players operation durationSlot4-1 fear = barleyDuration abilityStats 
...
execute if score sabilitynumber abilities matches -36 run tellraw @a[tag=game1] ["",{"selector":"@p[tag=p2]"}," used Spookcrow to fear Slot 6!"]
...
execute if score abilitynumber abilities matches 36 run tellraw @a[tag=game1] ["",{"selector":"@p[tag=p1]"}," used Spookcrow to make Slot 6 scary!"]
...
execute if score abilitynumber abilities matches 40 if score ward slot6 matches ..0 unless score curse slot6 matches 5 unless score curse slot6 matches 2 run scoreboard players set curseDuration slot6 0
...
execute if score abilitynumber abilities matches 41 if score ward slot6 matches ..0 unless score curse slot6 matches 5 unless score curse slot6 matches 3 run scoreboard players set curseDuration slot6 0
