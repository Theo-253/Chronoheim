...
execute if score abilitynumber abilities matches 42 if score ward slot6 matches 0 run scoreboard players operation abilityDmg saves *= anubisUnusedP2 saves
execute if score abilitynumber abilities matches 42 run execute at @e[name=slot6,type=armor_stand] run particle minecraft:sonic_boom ~ ~1.5 ~ 0.03 0.03 0.03 0.01 100
