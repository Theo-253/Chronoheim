...
#Dolly
execute if score abilitynumber abilities matches 42 if score ward slot6 matches 0 unless score curse slot6 matches 5 run scoreboard players operation curseDuration slot6 = dollyDuration abilityStats
execute if score abilitynumber abilities matches 42 if score ward slot6 matches 0 unless score curse slot6 matches 5 if score curseStacks slot6 matches 1.. run scoreboard players set curseStacks slot6 0
execute if score abilitynumber abilities matches 42 if score ward slot6 matches 0 unless score curse slot6 matches 5 run scoreboard players set curse slot6 4
execute if score abilitynumber abilities matches 42 if score ward slot6 matches 0 run scoreboard players operation dollydump saves = slot6 hp
execute if score abilitynumber abilities matches 42 if score ward slot6 matches 0 run scoreboard players operation dollydump saves += shield slot6
execute if score abilitynumber abilities matches 42 if score ward slot6 matches 0 run scoreboard players operation slot6Dolly saves = dollydump saves
execute if score abilitynumber abilities matches 42 if score ward slot6 matches 1.. run function ch:wardslot6
execute if score abilitynumber abilities matches 42 run execute at @e[name=slot6,type=armor_stand] run particle effect{color:[0.725,0.180,1.000]} ~ ~1 ~ 0.9 0.9 0.9 0.05 100
execute if score abilitynumber abilities matches 42 run tellraw @a[tag=game1] ["",{"selector":"@p[tag=p1]"}," used Life Link on Slot 6!"]
