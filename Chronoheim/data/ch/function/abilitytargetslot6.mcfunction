...
#Dolly
execute if score abilitynumber abilities matches 42 if score ward slot6 matches 0 unless score curse slot6 matches 5 run scoreboard players set curseDuration slot6 3
