...
clear @p[tag=game1]
#Arthur Ability
execute if score abilitynumber abilities matches 2 run function ch:cleanseslot6
...
#Subject ability
execute if score abilitynumber abilities matches 4 if score ward slot6 matches 0 if score durationSlot6 poison < subjectDuration abilityStats run scoreboard players operation durationSlot6 poison = subjectDuration abilityStats
execute if score abilitynumber abilities matches 4 if score ward slot6 matches 0 run scoreboard players operation slot6Poison poison += subject abilityStats
execute if score abilitynumber abilities matches 4 if score ward slot6 matches 0 if score slot2isatk booleans matches 1 run scoreboard players operation slot6Poison poison += subjectLeader abilityStats
execute if score abilitynumber abilities matches 4 at @e[name=slot6] run particle minecraft:trial_omen ~ ~1 ~ 0.9 0.9 0.9 0.1 50
execute if score abilitynumber abilities matches 4 run execute if score ward slot6 matches 1.. run function ch:wardslot6
execute if score abilitynumber abilities matches 4 run tellraw @a[tag=game1] ["",{"selector":"@p[tag=p1]"}," used Contagion on Slot 6!"]
...
execute if score abilitynumber abilities matches 24 run execute at @n[type=armor_stand,name=slot6] run particle minecraft:composter ~ ~1 ~ 0.9 0.9 0.9 0.5 100
...
execute if score abilitynumber abilities matches 27 run execute at @e[name=slot6,type=armor_stand] run particle firefly ~ ~1 ~ 0.3 0.3 0.3 1 100

execute if score abilitynumber abilities matches -2 if score abilitynumber abilities matches 27 run tellraw @a[tag=game1] ["",{"selector":"@p[tag=p1]"}," used Pixie Dust on Slot 6!"]
...
execute if score abilitynumber abilities matches -2 run execute at @n[type=armor_stand,name=slot6] run particle minecraft:composter ~ ~1 ~ 0.9 0.9 0.9 0.5 100
execute if score abilitynumber abilities matches -2 run execute if score slot6bleeding booleaneffects matches 0 if score slot6isatk booleans matches 1 run scoreboard players operation slot6 hp += juniperLeader heroattack
...
execute if score abilitynumber abilities matches 7 run execute at @n[type=armor_stand,name=slot6] run particle minecraft:explosion_emitter ~ ~1 ~
execute if score abilitynumber abilities matches 9 run execute at @n[type=armor_stand,name=slot6] run particle minecraft:angry_villager ~ ~1 ~ 0.9 0.9 0.9 1 50
...
#Robyn Ability
execute if score abilitynumber abilities matches 9 if score ward slot6 matches 0 if score durationSlot6 mark < robynDuration abilityStats run scoreboard players operation durationSlot6 mark = robynDuration abilityStats
...
execute if score abilitynumber abilities matches 5 run execute at @n[name=slot6,type=armor_stand] run particle minecraft:wax_off ~ ~1 ~ 0.6 0.6 0.6 0.0001 400
...
execute if score abilitynumber abilities matches 12 run execute if score character# slot2 matches 12 run scoreboard players operation cooldown slot6 = aceSetCooldownLeader abilityStats
...
execute if score abilitynumber abilities matches 22 at @e[name=slot6] run particle minecraft:flash{color:[1.000,1.000,1.000,1.00]} ~ ~1 ~ 0.9 0.9 0.9 0.5 100
...
execute if score abilitynumber abilities matches 23 if score ward slot6 matches 0 at @e[name=slot6] run execute at @e[distance=..4,type=!player] run tp @n[type=!minecraft:player,distance=..4] ~ ~-20 ~
execute if score abilitynumber abilities matches 23 run execute if score ward slot6 matches 1.. run function ch:wardslot6
...
#Scythe
execute if score abilitynumber abilities matches 32 if score ward slot6 matches 0 run scoreboard players operation slot6 hp /= scytheDivide abilityStats
execute if score abilitynumber abilities matches 32 if score ward slot6 matches 0 run scoreboard players operation slot6 hp *= scytheMult abilityStats
execute if score abilitynumber abilities matches 32 if score ward slot6 matches 0 if score slot2isatk booleans matches 1 if score durationSlot6 mark < scytheDuration abilityStats run scoreboard players operation durationSlot6 mark = scytheDuration abilityStats
execute if score abilitynumber abilities matches 32 if score ward slot6 matches 0 if score slot2isatk booleans matches 1 run scoreboard players operation marks slot6 += scytheLeader abilityStats
execute if score abilitynumber abilities matches 32 if score ward slot6 matches 1.. run function ch:wardslot6
execute if score abilitynumber abilities matches 32 at @e[name=slot6] run particle minecraft:sculk_soul ~ ~1 ~ 0.9 0.9 0.9 0.1 100
execute if score abilitynumber abilities matches 32 run tellraw @a[tag=game1] ["",{"selector":"@p[tag=p1]"}," used Cull the Weak on Slot 6!"]

#Doc Basic Attack
execute if score abilitynumber abilities matches -1 if score ward slot6 matches 0 run scoreboard players operation slot6Disease disease += doc heroattack
execute if score abilitynumber abilities matches -1 if score ward slot6 matches 0 if score slot2isatk booleans matches 1 run scoreboard players operation slot6Disease disease += docLeader heroattack
execute if score abilitynumber abilities matches -1 run execute if score ward slot6 matches 1.. run function ch:wardslot6
...
execute if score abilitynumber abilities matches 31 run scoreboard players operation abilityDmg saves += marks slot6
execute if score abilitynumber abilities matches 31 run scoreboard players operation abilityDmg saves /= atkmultiplier slot6
execute if score abilitynumber abilities matches 31 run execute if score ward slot6 matches 0 run scoreboard players operation shield slot6 -= abilityDmg saves
execute if score abilitynumber abilities matches 31 run execute if score ward slot6 matches 0 if score shield slot6 matches ..0 run scoreboard players operation slot6 hp += shield slot6
execute if score abilitynumber abilities matches 31 run execute if score ward slot6 matches 0 run scoreboard players operation disarmedslot6 booleaneffects = jones abilityStats
execute if score abilitynumber abilities matches 31 run execute if score ward slot6 matches 1 run function ch:wardslot6
execute if score abilitynumber abilities matches 31 run tellraw @a[tag=game1] ["",{"selector":"@p[tag=p1]"}," used Lasso on Slot 6!"]
execute if score abilitynumber abilities matches 31 at @e[name=slot6] run particle minecraft:crit ~ ~1 ~ 0.9 0.9 0.9 0.1 100


#Sherman Basic
execute if score abilitynumber abilities matches -5 run execute unless score slot6bleeding booleaneffects matches 1.. run scoreboard players operation slot6 hp += sherman heroattack
execute if score abilitynumber abilities matches -5 run tellraw @a[tag=game1] ["",{"selector":"@p[tag=p2]"}," healed Slot 6!"]
execute if score abilitynumber abilities matches -5 run execute at @n[type=armor_stand,name=slot6] run particle minecraft:composter ~ ~1 ~ 0.9 0.9 0.9 0.5 80


#Sherman Ability
execute if score abilitynumber abilities matches 33 run execute if score ward slot6 matches 0 if score debuffDurationSlot6 atkmodifiers < shermanDuration abilityStats run scoreboard players operation debuffDurationSlot6 atkmodifiers = shermanDuration abilityStats
execute if score abilitynumber abilities matches 33 run execute if score ward slot6 matches 0 run scoreboard players operation attackDebuffSlot6 atkmodifiers += shermanDebuff abilityStats
...
execute if score abilitynumber abilities matches 33 at @e[name=slot6] run particle minecraft:pale_oak_leaves ~ ~1 ~ 0.9 0.9 0.9 0.1 100
execute if score abilitynumber abilities matches 33 at @e[name=slot6] run particle minecraft:explosion ~ ~1 ~ 0.9 0.9 0.9 0.1 10
execute if score abilitynumber abilities matches 33 at @e[name=slot5] run particle minecraft:pale_oak_leaves ~ ~1 ~ 0.9 0.9 0.9 0.1 50
execute if score abilitynumber abilities matches 33 at @e[name=slot7] run particle minecraft:pale_oak_leaves ~ ~1 ~ 0.9 0.9 0.9 0.1 50
execute if score abilitynumber abilities matches 33 run tellraw @a[tag=game1] ["",{"selector":"@p[tag=p1]"}," used Grasping Roots on Slot 6!"]
execute if score abilitynumber abilities matches 33 run scoreboard players operation abilityDmg saves = sherman abilityStats
execute if score abilitynumber abilities matches 33 if score slot1isatk booleans matches 1 run scoreboard players operation abilityDmg saves += slot1 atkmodifiers
execute if score abilitynumber abilities matches 33 if score slot2isatk booleans matches 1 run scoreboard players operation abilityDmg saves += slot2 atkmodifiers
execute if score abilitynumber abilities matches 33 if score slot3isatk booleans matches 1 run scoreboard players operation abilityDmg saves += slot3 atkmodifiers
...
execute if score abilitynumber abilities matches 33 run scoreboard players operation abilityDmg saves += marks slot5
execute if score abilitynumber abilities matches 33 run scoreboard players operation abilityDmg saves /= atkmultiplier slot5
execute if score abilitynumber abilities matches 33 run execute if score ward slot5 matches 0 run scoreboard players operation shield slot5 -= abilityDmg saves
execute if score abilitynumber abilities matches 33 run execute if score ward slot5 matches 0 if score shield slot5 matches ..0 run scoreboard players operation slot5 hp += shield slot5
execute if score abilitynumber abilities matches 33 run execute if score ward slot5 matches 1.. run function ch:wardslot5
execute if score abilitynumber abilities matches 33 run scoreboard players operation abilityDmg saves = sherman abilityStats
execute if score abilitynumber abilities matches 33 if score slot1isatk booleans matches 1 run scoreboard players operation abilityDmg saves += slot1 atkmodifiers
execute if score abilitynumber abilities matches 33 if score slot2isatk booleans matches 1 run scoreboard players operation abilityDmg saves += slot2 atkmodifiers
execute if score abilitynumber abilities matches 33 if score slot3isatk booleans matches 1 run scoreboard players operation abilityDmg saves += slot3 atkmodifiers
...
execute if score abilitynumber abilities matches 28 run scoreboard players operation abilityDmg saves += marks slot6
execute if score abilitynumber abilities matches 28 run scoreboard players operation abilityDmg saves /= atkmultiplier slot6
execute if score abilitynumber abilities matches 28 run execute if score ward slot6 matches 0 run scoreboard players operation shield slot6 -= abilityDmg saves
execute if score abilitynumber abilities matches 28 run execute if score ward slot6 matches 0 if score slot2isatk booleans matches 1 if score durationSlot2-6 fear <= eidolonLeaderFearDuration abilityStats run scoreboard players operation durationSlot2-6 fear = eidolonLeaderFearDuration abilityStats
execute if score abilitynumber abilities matches 28 run execute if score ward slot6 matches 0 if score shield slot6 matches ..0 run scoreboard players operation slot6 hp += shield slot6
execute if score abilitynumber abilities matches 28 run execute if score ward slot6 matches 1.. run function ch:wardslot6
execute if score abilitynumber abilities matches 28 run execute at @e[name=slot6,type=armor_stand] run particle raid_omen ~ ~1 ~ 0.3 0.3 0.3 2 100

#Barley
execute if score abilitynumber abilities matches -36 if score barleyPart1 abilities matches 1 if score ward slot6 matches ..0 run scoreboard players operation durationSlot1-6 fear = barleyDuration abilityStats 
execute if score abilitynumber abilities matches -36 if score barleyPart1 abilities matches 2 if score ward slot6 matches ..0 run scoreboard players operation durationSlot2-6 fear = barleyDuration abilityStats 
...
execute if score abilitynumber abilities matches 36 run execute at @n[type=armor_stand,name=slot6] run particle raid_omen ~ ~1 ~ 0.9 0.9 0.9 0.1 400
execute if score abilitynumber abilities matches 36 run tellraw @a[tag=game1] ["",{"selector":"@p[tag=p2]"}," used Spookcrow to make Slot 6 scary!"]

#Igor
execute if score abilitynumber abilities matches 38 if score cooldown slot6 matches 1.. run scoreboard players operation cooldown slot6 -= igor abilityStats
execute if score abilitynumber abilities matches 38 run execute at @e[type=armor_stand,name=slot6] run particle witch ~ ~1 ~ 0.5 0.8 0.5 0.1 100
execute if score abilitynumber abilities matches 38 run execute if score durationSlot6 speedBuffs < igorDuration abilityStats run scoreboard players operation durationSlot6 speedBuffs = igorDuration abilityStats
execute if score abilitynumber abilities matches 38 run scoreboard players operation speed slot6 += igorSpBuff abilityStats
execute if score abilitynumber abilities matches 38 run scoreboard players operation speedBuffSlot6 speedBuffs += igorSpBuff abilityStats
execute if score abilitynumber abilities matches 38 run tellraw @a[tag=game1] ["",{"selector":"@p[tag=p2]"}," used Black Lagoon Brew on Slot 6!"]
execute if score abilitynumber abilities matches 38 if score slot6isatk booleans matches 1 run execute if score invincibleSlot6 booleaneffects < igorDuration abilityStats run scoreboard players operation invincibleSlot6 booleaneffects = igorDuration abilityStats
execute if score abilitynumber abilities matches 38 if score slot6isatk booleans matches 1 run scoreboard players operation savehp6 saves = slot6 hp

#Zeebo
execute if score abilitynumber abilities matches 40 if score ward slot6 matches ..0 unless score curse slot6 matches 5 unless score curse slot6 matches 2 run scoreboard players set curseStacks slot6 0
execute if score abilitynumber abilities matches 40 if score ward slot6 matches ..0 unless score curse slot6 matches 5 unless score curse slot6 matches 2 run scoreboard players set curseDuration slot6 -1
execute if score abilitynumber abilities matches 40 if score ward slot6 matches ..0 unless score curse slot6 matches 5 run scoreboard players set curse slot6 2
execute if score abilitynumber abilities matches 40 if score ward slot6 matches ..0 unless score curse slot6 matches 5 if score curse slot6 matches 2 run scoreboard players add curseStacks slot6 1
execute if score abilitynumber abilities matches 40 if score ward slot6 matches ..0 run execute if score durationSlot6 burn < zeeboDuration abilityStats run scoreboard players operation durationSlot6 burn = zeeboDuration abilityStats
execute if score abilitynumber abilities matches 40 if score ward slot6 matches ..0 run scoreboard players operation slot6Burn burn += zeeboBurn abilityStats
execute if score abilitynumber abilities matches 40 run execute at @e[type=armor_stand,name=slot6] run summon firework_rocket ~ ~2 ~ {LifeTime:1,FireworksItem:{id:"minecraft:firework_rocket",count:1,components:{"minecraft:fireworks":{explosions:[{shape:"burst",has_twinkle:true,has_trail:true,colors:[I;13894251,16746496,16770560],fade_colors:[I;10224278]}]}}}}
execute if score abilitynumber abilities matches 40 run tellraw @a[tag=game1] ["",{"selector":"@p[tag=p1]"}," used Last Laugh on Slot 6!"]
execute if score abilitynumber abilities matches 40 run execute at @e[type=armor_stand,name=slot6] run summon firework_rocket ~ ~2 ~ {LifeTime:1,FireworksItem:{id:"minecraft:firework_rocket",count:1,components:{"minecraft:fireworks":{explosions:[{shape:"burst",has_twinkle:true,has_trail:true,colors:[I;13894251,16746496,16770560],fade_colors:[I;10224278]}]}}}}
execute if score abilitynumber abilities matches 40 if score ward slot6 matches 1.. run function ch:wardslot6

#Fenrir
execute if score abilitynumber abilities matches 41 if score ward slot6 matches ..0 unless score curse slot6 matches 5 unless score curse slot6 matches 3 run scoreboard players set curseStacks slot6 0
execute if score abilitynumber abilities matches 41 if score ward slot6 matches ..0 unless score curse slot6 matches 5 unless score curse slot6 matches 3 run scoreboard players set curseDuration slot6 -1
execute if score abilitynumber abilities matches 41 if score ward slot6 matches ..0 unless score character# slot6 matches 41 unless score curse slot6 matches 5 run scoreboard players set curse slot6 3
...
execute if score abilitynumber abilities matches 41 run scoreboard players operation abilityDmg saves += marks slot6
execute if score abilitynumber abilities matches 41 run scoreboard players operation abilityDmg saves /= atkmultiplier slot6
execute if score abilitynumber abilities matches 41 run execute if score ward slot6 matches ..0 run scoreboard players operation shield slot6 -= abilityDmg saves
execute if score abilitynumber abilities matches 41 run execute at @n[type=armor_stand,name=slot6] run particle enchanted_hit ~ ~1 ~ 0.9 0.9 0.9 0.1 400
execute if score abilitynumber abilities matches 41 run tellraw @a[tag=game1] ["",{"selector":"@p[tag=p1]"}," used Mark of the Wolf on Slot 6!"]
execute if score abilitynumber abilities matches 41 run execute if score ward slot6 matches 0 if score shield slot6 matches ..0 run scoreboard players operation slot6 hp += shield slot6
execute if score abilitynumber abilities matches 41 if score ward slot6 matches 1.. run function ch:wardslot6
...
execute if score abilitynumber abilities matches 43 run scoreboard players operation abilityDmg saves += marks slot6
execute if score abilitynumber abilities matches 43 run scoreboard players operation abilityDmg saves /= atkmultiplier slot6
execute if score abilitynumber abilities matches 43 run execute if score ward slot6 matches ..0 run scoreboard players operation shield slot6 -= abilityDmg saves
execute if score abilitynumber abilities matches 43 run execute if score ward slot6 matches ..0 run scoreboard players operation slot6Disease disease += grendelDisease abilityStats
execute if score abilitynumber abilities matches 43 run execute at @e[type=armor_stand,name=slot6] run particle minecraft:noxious_gas ~ ~1 ~ 0.7 0.7 0.7 0.05 200
execute if score abilitynumber abilities matches 43 if score ward slot6 matches 1.. run function ch:wardslot6
...
execute if score abilitynumber abilities matches -43 run execute at @e[type=armor_stand,name=slot6] run particle minecraft:noxious_gas ~ ~1 ~ 0.7 0.7 0.7 0.05 200
execute if score abilitynumber abilities matches -43 if score ward slot6 matches 1.. run function ch:wardslot6
execute if score abilitynumber abilities matches -43 run tellraw @a[tag=game1] ["",{"selector":"@p[tag=p1]"}," used Piercing Pestilence on Slot 6!"]
execute if score abilitynumber abilities matches 43 run tellraw @a[tag=game1] ["",{"selector":"@p[tag=p1]"}," used Piercing Pestilence on Slot 6!"]
execute if score abilitynumber abilities matches 43 run execute if score ward slot6 matches 0 if score shield slot6 matches ..0 run scoreboard players operation slot6 hp += shield slot6
execute if score abilitynumber abilities matches -43 run execute if score ward slot6 matches 0 if score shield slot6 matches ..0 run scoreboard players operation slot6 hp += shield slot6
#Frank
execute if score abilitynumber abilities matches 34 run scoreboard players operation abilityDmg saves = frank abilityStats
execute if score abilitynumber abilities matches 34 run scoreboard players operation shield slot6 -= abilityDmg saves
execute if score abilitynumber abilities matches 34 run scoreboard players operation slot6 hp += shield slot6
execute if score abilitynumber abilities matches 34 run execute at @e[name=slot6,type=armor_stand] run particle minecraft:angry_villager ~ ~1 ~ 0.9 0.9 0.9 0.5 15
execute if score abilitynumber abilities matches 34 run tellraw @a[tag=game1] ["",{"selector":"@p[tag=p2]"}," used IT'S ALIVE! to damage Slot 6!"]
execute if score abilitynumber abilities matches 34 run function ch:abilitygivetargetsp2

execute if score abilitynumber abilities matches -34 run execute if score ward slot6 matches 0 run scoreboard players operation slot6 stun = frankDuration abilityStats
execute if score abilitynumber abilities matches -34 run execute if score ward slot6 matches 1.. run function ch:wardslot6
execute if score abilitynumber abilities matches -34 run execute at @e[name=slot6,type=armor_stand] run particle minecraft:flash{color:[1.000,1.000,1.000,1.00]} ~ ~1 ~ 0.9 0.9 0.9 0.5 100
execute if score abilitynumber abilities matches -34 run tellraw @a[tag=game1] ["",{"selector":"@p[tag=p1]"}," used IT'S ALIVE! to stun Slot 6!"]

#Stein
execute if score abilitynumber abilities matches 35 run scoreboard players operation abilityDmg saves = stein abilityStats
execute if score abilitynumber abilities matches 35 if score slot1isatk booleans matches 1 run scoreboard players operation abilityDmg saves += slot1 atkmodifiers
execute if score abilitynumber abilities matches 35 if score slot2isatk booleans matches 1 run scoreboard players operation abilityDmg saves += slot2 atkmodifiers
execute if score abilitynumber abilities matches 35 if score slot3isatk booleans matches 1 run scoreboard players operation abilityDmg saves += slot3 atkmodifiers
execute if score abilitynumber abilities matches 35 run scoreboard players operation abilityDmg saves += marks slot6
execute if score abilitynumber abilities matches 35 run scoreboard players operation abilityDmg saves /= atkmultiplier slot6
execute if score abilitynumber abilities matches 35 run execute if score ward slot6 matches 0 run scoreboard players operation shield slot6 -= abilityDmg saves
execute if score abilitynumber abilities matches 35 run execute if score ward slot6 matches 0 if score shield slot6 matches ..0 run scoreboard players operation slot6 hp += shield slot6
execute if score abilitynumber abilities matches 35 run execute if score ward slot6 matches 1.. run function ch:wardslot6
execute if score abilitynumber abilities matches 35 run execute at @e[name=slot6,type=armor_stand] run particle raid_omen ~ ~1 ~ 0.9 0.9 0.9 2 100
execute if score abilitynumber abilities matches 35 run tellraw @a[tag=game1] ["",{"selector":"@p[tag=p1]"}," used Reanimation Beam to damage Slot 6!"]
execute if score abilitynumber abilities matches 35 run function ch:abilitygivetargetsp2reverse

execute if score abilitynumber abilities matches -35 if score slot6bleeding booleaneffects matches 0 run scoreboard players operation slot6 hp += abilityDmg saves
execute if score abilitynumber abilities matches -35 if score character# slot6 matches 35 run function ch:cleanseslot6
execute if score abilitynumber abilities matches -35 if score character# slot6 matches 34 run function ch:cleanseslot6
execute if score abilitynumber abilities matches -35 run execute at @e[name=slot6,type=armor_stand] run particle trial_omen ~ ~1 ~ 0.9 0.9 0.9 2 100
execute if score abilitynumber abilities matches -35 run tellraw @a[tag=game1] ["",{"selector":"@p[tag=p2]"}," used Reanimation Beam to heal Slot 6!"]

#Boogaloo
execute if score abilitynumber abilities matches 37 unless score curse slot6 matches 5 run scoreboard players set curseDuration slot6 -1
execute if score abilitynumber abilities matches 37 if score curseStacks slot6 matches 1.. unless score curse slot6 matches 5 run scoreboard players set curseStacks slot6 0
execute if score abilitynumber abilities matches 37 unless score curse slot6 matches 5 run scoreboard players set curse slot6 1
execute if score abilitynumber abilities matches 37 run execute at @e[name=slot6,type=armor_stand] run particle minecraft:sculk_soul ~ ~1 ~ 0.9 0.9 0.9 0.15 30
execute if score abilitynumber abilities matches 37 run tellraw @a[tag=game1] ["",{"selector":"@p[tag=p1]"}," used Devour Soul on Slot 6!"]

#Anubis
execute if score abilitynumber abilities matches 42 if score ward slot6 matches 0 run scoreboard players operation abilityDmg saves = anubis abilityStats
execute if score abilitynumber abilities matches 42 if score ward slot6 matches 0 run scoreboard players operation abilityDmg saves *= anubisUnusedP1 saves
execute if score abilitynumber abilities matches 42 run execute at @e[name=slot6,type=armor_stand] run particle minecraft:sonic_boom ~ ~2 ~ 0.03 0.03 0.03 0.01 100
execute if score abilitynumber abilities matches 42 run tellraw @a[tag=game1] ["",{"selector":"@p[tag=p2]"}," used Wrath of the Desert on Slot 6!"]
...
execute if score abilitynumber abilities matches 42 if score slot3isatk booleans matches 1 run scoreboard players operation abilityDmg saves += slot3 atkmodifiers
execute if score abilitynumber abilities matches 42 run scoreboard players operation abilityDmg saves += marks slot6
execute if score abilitynumber abilities matches 42 run scoreboard players operation abilityDmg saves /= atkmultiplier slot6
execute if score abilitynumber abilities matches 42 run execute if score ward slot6 matches 0 run scoreboard players operation shield slot6 -= abilityDmg saves
execute if score abilitynumber abilities matches 42 run execute if score ward slot6 matches 0 if score shield slot6 matches ..0 run scoreboard players operation slot6 hp += shield slot6
execute if score abilitynumber abilities matches 42 if score ward slot6 matches 1.. run function ch:wardslot6
