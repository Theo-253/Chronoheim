...
execute if score abilitynumber abilities matches 41 if score ward slot6 matches ..0 unless score curse slot6 matches 5 run scoreboard players set curse slot6 3
