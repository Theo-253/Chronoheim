...
execute if score abilitynumber abilities matches 12 run execute if score character# slot2 matches 12 run scoreboard players operation cooldown slot7 = aceSetCooldownLeader abilityStats
...
execute if score abilitynumber abilities matches -36 if score ward slot7 matches ..0 run scoreboard players operation attackDebuffSlot7 atkmodifiers += barley abilityStats
...
#Igor
execute if score abilitynumber abilities matches 38 if score cooldown slot7 matches 1.. run scoreboard players operation cooldown slot7 -= igor abilityStats
...
execute if score abilitynumber abilities matches 38 run scoreboard players operation speed slot7 += igorSpBuff abilityStats
...
execute if score abilitynumber abilities matches 40 if score ward slot7 matches ..0 run scoreboard players operation slot7Burn burn += zeeboBurn abilityStats
...
execute if score abilitynumber abilities matches 41 if score ward slot7 matches ..0 unless score character# slot7 matches 41 unless score curse slot7 matches 5 run scoreboard players set curse slot7 3
...
execute if score abilitynumber abilities matches 41 run execute if score ward slot7 matches 0 if score shield slot7 matches ..0 run scoreboard players operation slot7 hp += shield slot7
...
execute if score abilitynumber abilities matches 43 run tellraw @a[tag=game1] ["",{"selector":"@p[tag=p1]"}," used Piercing Pestilence on Slot 7!"]
execute if score abilitynumber abilities matches 43 run execute if score ward slot7 matches 0 if score shield slot7 matches ..0 run scoreboard players operation slot7 hp += shield slot7
execute if score abilitynumber abilities matches -43 run execute if score ward slot7 matches 0 if score shield slot7 matches ..0 run scoreboard players operation slot7 hp += shield slot7
#Frank
...
#Anubis
execute if score abilitynumber abilities matches 42 if score ward slot7 matches 0 run scoreboard players operation abilityDmg saves = anubis abilityStats
execute if score abilitynumber abilities matches 42 if score ward slot7 matches 0 run scoreboard players operation abilityDmg saves *= anubisUnusedP1 saves
execute if score abilitynumber abilities matches 42 run execute at @e[name=slot7,type=armor_stand] run particle minecraft:sonic_boom ~ ~2 ~ 0.03 0.03 0.03 0.01 100
execute if score abilitynumber abilities matches 42 run tellraw @a[tag=game1] ["",{"selector":"@p[tag=p2]"}," used Wrath of the Desert on Slot 7!"]
...
execute if score abilitynumber abilities matches 42 run scoreboard players operation abilityDmg saves += marks slot7
execute if score abilitynumber abilities matches 42 run scoreboard players operation abilityDmg saves /= atkmultiplier slot7
execute if score abilitynumber abilities matches 42 run execute if score ward slot7 matches 0 run scoreboard players operation shield slot7 -= abilityDmg saves
execute if score abilitynumber abilities matches 42 run execute if score ward slot7 matches 0 if score shield slot7 matches ..0 run scoreboard players operation slot7 hp += shield slot7
