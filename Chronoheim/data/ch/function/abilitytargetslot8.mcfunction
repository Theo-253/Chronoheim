...
#Dolly
execute if score abilitynumber abilities matches 42 if score ward slot8 matches 0 unless score curse slot8 matches 5 run scoreboard players set curseDuration slot8 3
