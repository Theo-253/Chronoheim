...
#Boogaloo
execute if score abilitynumber abilities matches 37 if score curseDuration slot8 matches 1.. unless score curse slot8 matches 5 run scoreboard players set curseDuration slot8 0
