...
execute if score abilitynumber abilities matches 41 if score ward slot8 matches ..0 unless score curse slot8 matches 5 run scoreboard players set curse slot8 3
