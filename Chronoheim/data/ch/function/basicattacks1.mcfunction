...
execute if score ward slot1 matches 0 if score lifesteal slot5 matches 1.. at @e[name=slot5,type=armor_stand] run particle minecraft:composter ~ ~1 ~ 0.9 0.9 0.9 0.5 50
...
execute if score ward slot1 matches 0 if score lifesteal slot6 matches 1.. at @e[name=slot6,type=armor_stand] run particle minecraft:composter ~ ~1 ~ 0.9 0.9 0.9 0.5 50
#slot 7
...
execute if score ward slot1 matches 0 if score lifesteal slot7 matches 1.. at @e[name=slot7,type=armor_stand] run particle minecraft:composter ~ ~1 ~ 0.9 0.9 0.9 0.5 50
#slot 8
...
execute if score ward slot1 matches 0 if score lifesteal slot8 matches 1.. at @e[name=slot8,type=armor_stand] run particle minecraft:composter ~ ~1 ~ 0.9 0.9 0.9 0.5 50
