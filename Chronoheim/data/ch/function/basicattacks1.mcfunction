...
tellraw @a[tag=game1] ["",{"selector":"@p[tag=p2]"}," attacked Slot 1"]
clear @a[tag=p2]
#slot 5
...
execute if score slot6isatk booleans matches 1 if score character# slot6 matches 36 if score durationSlot5-1 fear matches 1.. run scoreboard players operation atk1 saves += barleyLeader abilityStats
execute if score slot6isatk booleans matches 1 if score character# slot6 matches 36 if score durationSlot6-1 fear matches 1.. run scoreboard players operation atk1 saves += barleyLeader abilityStats
execute if score slot6isatk booleans matches 1 if score character# slot6 matches 36 if score durationSlot7-1 fear matches 1.. run scoreboard players operation atk1 saves += barleyLeader abilityStats
execute if score slot6isatk booleans matches 1 if score character# slot6 matches 36 if score durationSlot8-1 fear matches 1.. run scoreboard players operation atk1 saves += barleyLeader abilityStats
...
execute if score ward slot1 matches 0 if score slot5bleeding booleaneffects matches 0 run execute if score lifesteal slot5 matches 1.. run execute if score slot5isatk booleans matches 1 run scoreboard players operation slot5 hp += lifesteal saves
execute if score ward slot1 matches 0 if score lifesteal slot5 matches 1.. if score slot5isatk booleans matches 1 at @e[name=slot5,type=armor_stand] run particle minecraft:composter ~ ~1 ~ 0.9 0.9 0.9 0.5 50
...
execute if score ward slot1 matches 0 if score slot6bleeding booleaneffects matches 0 run execute if score lifesteal slot6 matches 1.. run execute if score slot6isatk booleans matches 1 run scoreboard players operation slot6 hp += lifesteal saves
execute if score ward slot1 matches 0 if score lifesteal slot6 matches 1.. if score slot6isatk booleans matches 1 at @e[name=slot6,type=armor_stand] run particle minecraft:composter ~ ~1 ~ 0.9 0.9 0.9 0.5 50
#slot 7
...
execute if score ward slot1 matches 0 if score slot7bleeding booleaneffects matches 0 run execute if score lifesteal slot7 matches 1.. run execute if score slot7isatk booleans matches 1 run scoreboard players operation slot7 hp += lifesteal saves
execute if score ward slot1 matches 0 if score lifesteal slot7 matches 1.. if score slot7isatk booleans matches 1 at @e[name=slot7,type=armor_stand] run particle minecraft:composter ~ ~1 ~ 0.9 0.9 0.9 0.5 50
#slot 8
...
execute if score ward slot1 matches 0 if score slot8bleeding booleaneffects matches 0 run execute if score lifesteal slot8 matches 1.. run execute if score slot8isatk booleans matches 1 run scoreboard players operation slot8 hp += lifesteal saves
execute if score ward slot1 matches 0 if score lifesteal slot8 matches 1.. if score slot8isatk booleans matches 1 at @e[name=slot8,type=armor_stand] run particle minecraft:composter ~ ~1 ~ 0.9 0.9 0.9 0.5 50
...
#Special Cases
execute if score ward slot1 matches ..0 run execute if score slot5isatk booleans matches 1 if score character# slot5 matches 29 if score slot1 hp <= ripperHpBleed abilityStats run scoreboard players operation slot1bleeding booleaneffects = ripperBleed abilityStats
execute if score ward slot1 matches ..0 run execute if score slot6isatk booleans matches 1 if score character# slot6 matches 29 if score slot1 hp <= ripperHpBleed abilityStats run scoreboard players operation slot1bleeding booleaneffects = ripperBleed abilityStats
execute if score ward slot1 matches ..0 run execute if score slot7isatk booleans matches 1 if score character# slot7 matches 29 if score slot1 hp <= ripperHpBleed abilityStats run scoreboard players operation slot1bleeding booleaneffects = ripperBleed abilityStats
execute if score ward slot1 matches ..0 run execute if score slot5isatk booleans matches 1 if score character# slot5 matches -8 run scoreboard players operation slot1Disease disease = zombieDisease abilityStats
execute if score ward slot1 matches ..0 run execute if score slot6isatk booleans matches 1 if score character# slot6 matches -8 run scoreboard players operation slot1Disease disease = zombieDisease abilityStats
execute if score ward slot1 matches ..0 run execute if score slot7isatk booleans matches 1 if score character# slot7 matches -8 run scoreboard players operation slot1Disease disease = zombieDisease abilityStats
execute if score ward slot1 matches ..0 run execute if score slot8isatk booleans matches 1 if score character# slot8 matches -8 run scoreboard players operation slot1Disease disease = zombieDisease abilityStats
