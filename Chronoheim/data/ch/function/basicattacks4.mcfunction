...
#Special Cases
execute if score slot5isatk booleans matches 1 if score character# slot5 matches 29 run scoreboard players operation slot4bleeding booleaneffects = ripperBleed abilityStats
execute if score slot6isatk booleans matches 1 if score character# slot6 matches 29 run scoreboard players operation slot4bleeding booleaneffects = ripperBleed abilityStats
execute if score slot7isatk booleans matches 1 if score character# slot7 matches 29 run scoreboard players operation slot4bleeding booleaneffects = ripperBleed abilityStats
