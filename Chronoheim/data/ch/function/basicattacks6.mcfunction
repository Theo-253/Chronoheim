...
execute if score slot2isatk booleans matches 1 if score character# slot2 matches 36 if score durationSlot1-6 fear matches 1.. run scoreboard players operation atk1 saves += barleyLeader abilityStats
execute if score slot2isatk booleans matches 1 if score character# slot2 matches 36 if score durationSlot2-6 fear matches 1.. run scoreboard players operation atk1 saves += barleyLeader abilityStats
execute if score slot2isatk booleans matches 1 if score character# slot2 matches 36 if score durationSlot3-6 fear matches 1.. run scoreboard players operation atk1 saves += barleyLeader abilityStats
execute if score slot2isatk booleans matches 1 if score character# slot2 matches 36 if score durationSlot4-6 fear matches 1.. run scoreboard players operation atk1 saves += barleyLeader abilityStats
