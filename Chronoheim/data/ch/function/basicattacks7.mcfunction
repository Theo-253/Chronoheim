...
execute if score slot1isatk booleans matches 1 run scoreboard players operation atk saves += marks slot7
...
execute if score slot2isatk booleans matches 1 run scoreboard players operation atk saves += marks slot7
...
execute if score slot3isatk booleans matches 1 run scoreboard players operation atk saves += marks slot7
...
execute if score slot4isatk booleans matches 1 run scoreboard players operation atk saves += marks slot7
