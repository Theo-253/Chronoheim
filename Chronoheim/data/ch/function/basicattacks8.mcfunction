...
tellraw @a[tag=game1] ["",{"selector":"@p[tag=p1]"}," attacked Slot 8"]
clear @a[tag=p1]
#slot 5
...
execute if score slot1isatk booleans matches 1 run scoreboard players operation atk1 saves += marks slot8
execute if score slot1isatk booleans matches 1 run scoreboard players operation atk1 saves /= atkmultiplier slot8
execute if score slot1isatk booleans matches 1 run scoreboard players operation shield slot8 -= atk1 saves
#slot 6
...
execute if score slot3isatk booleans matches 1 run scoreboard players operation atk1 saves += marks slot8
execute if score slot3isatk booleans matches 1 run scoreboard players operation atk1 saves += slot3 atkmodifiers
execute if score slot3isatk booleans matches 1 run scoreboard players operation atk1 saves /= atkmultiplier slot8
execute if score slot3isatk booleans matches 1 run scoreboard players operation shield slot8 -= atk1 saves
#slot 8
execute if score slot4isatk booleans matches 1 run scoreboard players operation atk1 saves = atk slot4
execute if score slot4isatk booleans matches 1 run scoreboard players operation atk1 saves += marks slot8
execute if score slot4isatk booleans matches 1 run scoreboard players operation atk1 saves += slot4 atkmodifiers
execute if score slot4isatk booleans matches 1 run scoreboard players operation atk1 saves /= atkmultiplier slot8
execute if score slot4isatk booleans matches 1 run scoreboard players operation shield slot8 -= atk1 saves
...
execute if score lifesteal slot1 matches 1.. run execute if score slot1isatk booleans matches 1 run scoreboard players operation lifesteal saves += marks slot8
execute if score lifesteal slot1 matches 1.. run execute if score slot1isatk booleans matches 1 run scoreboard players operation lifesteal saves /= atkmultiplier slot8
...
execute if score ward slot8 matches 0 if score slot1bleeding booleaneffects matches 0 run execute if score lifesteal slot1 matches 1.. run execute if score slot1isatk booleans matches 1 run scoreboard players operation slot1 hp += lifesteal saves
execute if score ward slot8 matches 0 if score lifesteal slot1 matches 1.. if score slot1isatk booleans matches 1 at @e[name=slot1,type=armor_stand] run particle minecraft:composter ~ ~1 ~ 0.9 0.9 0.9 0.5 50
#slot 6
...
execute if score lifesteal slot2 matches 1.. run execute if score slot2isatk booleans matches 1 run scoreboard players operation lifesteal saves += marks slot8
execute if score lifesteal slot2 matches 1.. run execute if score slot2isatk booleans matches 1 run scoreboard players operation lifesteal saves /= atkmultiplier slot8
...
execute if score ward slot8 matches 0 if score slot2bleeding booleaneffects matches 0 run execute if score lifesteal slot2 matches 1.. run execute if score slot2isatk booleans matches 1 run scoreboard players operation slot2 hp += lifesteal saves
execute if score ward slot8 matches 0 if score lifesteal slot2 matches 1.. if score slot2isatk booleans matches 1 at @e[name=slot2,type=armor_stand] run particle minecraft:composter ~ ~1 ~ 0.9 0.9 0.9 0.5 50
#slot 7
...
execute if score lifesteal slot3 matches 1.. run execute if score slot3isatk booleans matches 1 run scoreboard players operation lifesteal saves += marks slot8
execute if score lifesteal slot3 matches 1.. run execute if score slot3isatk booleans matches 1 run scoreboard players operation lifesteal saves /= atkmultiplier slot8
...
execute if score ward slot8 matches 0 if score slot3bleeding booleaneffects matches 0 run execute if score lifesteal slot3 matches 1.. run execute if score slot3isatk booleans matches 1 run scoreboard players operation slot3 hp += lifesteal saves
execute if score ward slot8 matches 0 if score lifesteal slot3 matches 1.. if score slot3isatk booleans matches 1 at @e[name=slot3,type=armor_stand] run particle minecraft:composter ~ ~1 ~ 0.9 0.9 0.9 0.5 50
#slot 8
...
execute if score lifesteal slot4 matches 1.. run execute if score slot4isatk booleans matches 1 run scoreboard players operation lifesteal saves += marks slot8
execute if score lifesteal slot4 matches 1.. run execute if score slot4isatk booleans matches 1 run scoreboard players operation lifesteal saves /= atkmultiplier slot8
...
execute if score ward slot8 matches 0 if score slot4bleeding booleaneffects matches 0 run execute if score lifesteal slot4 matches 1.. run execute if score slot4isatk booleans matches 1 run scoreboard players operation slot4 hp += lifesteal saves
execute if score ward slot8 matches 0 if score lifesteal slot4 matches 1.. if score slot4isatk booleans matches 1 at @e[name=slot4,type=armor_stand] run particle minecraft:composter ~ ~1 ~ 0.9 0.9 0.9 0.5 50
...
#Special Cases
execute if score ward slot8 matches ..0 run execute if score slot1isatk booleans matches 1 if score character# slot1 matches 29 if score slot8 hp <= ripperHpBleed abilityStats run scoreboard players operation slot8bleeding booleaneffects = ripperBleed abilityStats
execute if score ward slot8 matches ..0 run execute if score slot2isatk booleans matches 1 if score character# slot2 matches 29 if score slot8 hp <= ripperHpBleed abilityStats run scoreboard players operation slot8bleeding booleaneffects = ripperBleed abilityStats
execute if score ward slot8 matches ..0 run execute if score slot3isatk booleans matches 1 if score character# slot3 matches 29 if score slot8 hp <= ripperHpBleed abilityStats run scoreboard players operation slot8bleeding booleaneffects = ripperBleed abilityStats
execute if score ward slot8 matches ..0 run execute if score slot1isatk booleans matches 1 if score character# slot1 matches -8 run scoreboard players operation slot8Disease disease = zombieDisease abilityStats
execute if score ward slot8 matches ..0 run execute if score slot2isatk booleans matches 1 if score character# slot2 matches -8 run scoreboard players operation slot8Disease disease = zombieDisease abilityStats
execute if score ward slot8 matches ..0 run execute if score slot3isatk booleans matches 1 if score character# slot3 matches -8 run scoreboard players operation slot8Disease disease = zombieDisease abilityStats
execute if score ward slot8 matches ..0 run execute if score slot4isatk booleans matches 1 if score character# slot4 matches -8 run scoreboard players operation slot8Disease disease = zombieDisease abilityStats
