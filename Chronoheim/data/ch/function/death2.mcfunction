...
execute if score game1Ongoing ongoinggames matches 1 run execute if score character# slot2 matches 1.. run execute if score slot2 hp matches ..0 run execute unless score speed slot2 matches -10000..-9000 run execute if score character# slot1 matches 28 run scoreboard players set cooldown slot1 0
execute if score game1Ongoing ongoinggames matches 1 run execute if score character# slot2 matches 1.. run execute if score slot2 hp matches ..0 run execute unless score speed slot2 matches -10000..-9000 run execute if score character# slot2 matches 28 run scoreboard players set cooldown slot2 0
execute if score game1Ongoing ongoinggames matches 1 run execute if score character# slot2 matches 1.. run execute if score slot2 hp matches ..0 run execute unless score speed slot2 matches -10000..-9000 run execute if score character# slot3 matches 28 run scoreboard players set cooldown slot3 0
execute if score game1Ongoing ongoinggames matches 1 run execute if score character# slot2 matches 1.. run execute if score slot2 hp matches ..0 run execute unless score speed slot2 matches -10000..-9000 run execute if score character# slot5 matches 28 run scoreboard players set cooldown slot5 0
execute if score game1Ongoing ongoinggames matches 1 run execute if score character# slot2 matches 1.. run execute if score slot2 hp matches ..0 run execute unless score speed slot2 matches -10000..-9000 run execute if score character# slot6 matches 28 run scoreboard players set cooldown slot6 0
execute if score game1Ongoing ongoinggames matches 1 run execute if score character# slot2 matches 1.. run execute if score slot2 hp matches ..0 run execute unless score speed slot2 matches -10000..-9000 run execute if score character# slot7 matches 28 run scoreboard players set cooldown slot7 0
