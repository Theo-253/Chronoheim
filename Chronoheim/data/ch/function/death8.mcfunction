...
execute if score curse slot8 matches 6 run execute if score slot1 hp matches 1.. if score slot2 hp matches 1.. if score slot3 hp matches 1.. if score slot4 hp matches ..0 run scoreboard players set character# slot4 -7
execute if score curse slot8 matches 6 run execute if score slot1 hp matches 1.. if score slot2 hp matches 1.. if score slot3 hp matches 1.. if score slot4 hp matches ..0 run scoreboard players operation maxspeed slot4 = bat herospeed
execute if score curse slot8 matches 6 run execute if score slot1 hp matches 1.. if score slot2 hp matches 1.. if score slot3 hp matches 1.. if score slot4 hp matches ..0 run scoreboard players operation speed slot4 = bat herospeed
...
execute if score curse slot8 matches 6 run execute if score slot1 hp matches 1.. if score slot2 hp matches 1.. if score slot3 hp matches 1.. if score slot4 hp matches ..0 run function ch:cleanseslot4
execute if score curse slot8 matches 6 run execute if score slot1 hp matches 1.. if score slot2 hp matches 1.. if score slot3 hp matches 1.. if score slot4 hp matches ..0 run scoreboard players operation maxhp slot4 = curseofbatsHPScale spellStats
execute if score curse slot8 matches 6 run execute if score slot1 hp matches 1.. if score slot2 hp matches 1.. if score slot3 hp matches 1.. if score slot4 hp matches ..0 run scoreboard players operation maxhp slot4 *= curseStacks slot8
execute if score curse slot8 matches 6 run execute if score slot1 hp matches 1.. if score slot2 hp matches 1.. if score slot3 hp matches 1.. if score slot4 hp matches ..0 run scoreboard players operation maxhp slot4 -= curseofbatsHPScale spellStats
execute if score curse slot8 matches 6 run execute if score slot1 hp matches 1.. if score slot2 hp matches 1.. if score slot3 hp matches 1.. if score slot4 hp matches ..0 run scoreboard players operation maxhp slot4 += bat herohealth
execute if score curse slot8 matches 6 run execute if score slot1 hp matches 1.. if score slot2 hp matches 1.. if score slot3 hp matches 1.. if score slot4 hp matches ..0 run scoreboard players operation slot4 hp = maxhp slot4
execute if score curse slot8 matches 6 run execute if score slot1 hp matches 1.. if score slot2 hp matches 1.. if score slot3 hp matches ..0 run scoreboard players set character# slot3 -7
execute if score curse slot8 matches 6 run execute if score slot1 hp matches 1.. if score slot2 hp matches 1.. if score slot3 hp matches ..0 run scoreboard players operation maxspeed slot3 = bat herospeed
execute if score curse slot8 matches 6 run execute if score slot1 hp matches 1.. if score slot2 hp matches 1.. if score slot3 hp matches ..0 run scoreboard players operation speed slot3 = bat herospeed
...
execute if score curse slot8 matches 6 run execute if score slot1 hp matches 1.. if score slot2 hp matches 1.. if score slot3 hp matches ..0 run function ch:cleanseslot3
execute if score curse slot8 matches 6 run execute if score slot1 hp matches 1.. if score slot2 hp matches 1.. if score slot3 hp matches ..0 run scoreboard players operation maxhp slot3 = curseofbatsHPScale spellStats
execute if score curse slot8 matches 6 run execute if score slot1 hp matches 1.. if score slot2 hp matches 1.. if score slot3 hp matches ..0 run scoreboard players operation maxhp slot3 *= curseStacks slot8
execute if score curse slot8 matches 6 run execute if score slot1 hp matches 1.. if score slot2 hp matches 1.. if score slot3 hp matches ..0 run scoreboard players operation maxhp slot3 -= curseofbatsHPScale spellStats
execute if score curse slot8 matches 6 run execute if score slot1 hp matches 1.. if score slot2 hp matches 1.. if score slot3 hp matches ..0 run scoreboard players operation maxhp slot3 += bat herohealth
execute if score curse slot8 matches 6 run execute if score slot1 hp matches 1.. if score slot2 hp matches 1.. if score slot3 hp matches ..0 run scoreboard players operation slot3 hp = maxhp slot3
execute if score curse slot8 matches 6 run execute if score slot1 hp matches 1.. if score slot2 hp matches ..0 run scoreboard players set character# slot2 -7
execute if score curse slot8 matches 6 run execute if score slot1 hp matches 1.. if score slot2 hp matches ..0 run scoreboard players operation maxspeed slot2 = bat herospeed
execute if score curse slot8 matches 6 run execute if score slot1 hp matches 1.. if score slot2 hp matches ..0 run scoreboard players operation speed slot2 = bat herospeed
...
execute if score curse slot8 matches 6 run execute if score slot1 hp matches 1.. if score slot2 hp matches ..0 run function ch:cleanseslot2
execute if score curse slot8 matches 6 run execute if score slot1 hp matches 1.. if score slot2 hp matches ..0 run scoreboard players operation maxhp slot2 = curseofbatsHPScale spellStats
execute if score curse slot8 matches 6 run execute if score slot1 hp matches 1.. if score slot2 hp matches ..0 run scoreboard players operation maxhp slot2 *= curseStacks slot8
execute if score curse slot8 matches 6 run execute if score slot1 hp matches 1.. if score slot2 hp matches ..0 run scoreboard players operation maxhp slot2 -= curseofbatsHPScale spellStats
execute if score curse slot8 matches 6 run execute if score slot1 hp matches 1.. if score slot2 hp matches ..0 run scoreboard players operation maxhp slot2 += bat herohealth
execute if score curse slot8 matches 6 run execute if score slot1 hp matches 1.. if score slot2 hp matches ..0 run scoreboard players operation slot2 hp = maxhp slot2
execute if score curse slot8 matches 6 run execute if score slot1 hp matches ..0 run scoreboard players set character# slot1 -7
execute if score curse slot8 matches 6 run execute if score slot1 hp matches ..0 run scoreboard players operation maxspeed slot1 = bat herospeed
execute if score curse slot8 matches 6 run execute if score slot1 hp matches ..0 run scoreboard players operation speed slot1 = bat herospeed
...
execute if score curse slot8 matches 6 run execute if score slot1 hp matches ..0 run function ch:cleanseslot1
execute if score curse slot8 matches 6 run execute if score slot1 hp matches ..0 run scoreboard players operation maxhp slot1 = curseofbatsHPScale spellStats
execute if score curse slot8 matches 6 run execute if score slot1 hp matches ..0 run scoreboard players operation maxhp slot1 *= curseStacks slot8
execute if score curse slot8 matches 6 run execute if score slot1 hp matches ..0 run scoreboard players operation maxhp slot1 -= curseofbatsHPScale spellStats
execute if score curse slot8 matches 6 run execute if score slot1 hp matches ..0 run scoreboard players operation maxhp slot1 += bat herohealth
execute if score curse slot8 matches 6 run execute if score slot1 hp matches ..0 run scoreboard players operation slot1 hp = maxhp slot1
