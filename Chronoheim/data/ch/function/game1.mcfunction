...
execute if score character# slot1 matches 41 if score fenrirhpsave saves > maxhp slot1 run scoreboard players operation fenrirhpsave saves = maxhp slot1
execute if score character# slot2 matches 41 if score fenrirhpsave saves > maxhp slot2 run scoreboard players operation fenrirhpsave saves = maxhp slot2
execute if score character# slot3 matches 41 if score fenrirhpsave saves > maxhp slot3 run scoreboard players operation fenrirhpsave saves = maxhp slot3
execute if score character# slot5 matches 41 if score fenrirhpsave2 saves > maxhp slot5 run scoreboard players operation fenrirhpsave2 saves = maxhp slot5
execute if score character# slot6 matches 41 if score fenrirhpsave2 saves > maxhp slot6 run scoreboard players operation fenrirhpsave2 saves = maxhp slot6
execute if score character# slot7 matches 41 if score fenrirhpsave2 saves > maxhp slot7 run scoreboard players operation fenrirhpsave2 saves = maxhp slot7
