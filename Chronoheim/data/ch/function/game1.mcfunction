...
execute if score alivep2 deaths matches 0 if score testing Combat_Rating matches 0 run scoreboard players add @p[tag=p1] Gold 15
execute if score alivep2 deaths matches 0 if score testing Combat_Rating matches 0 run scoreboard players remove @p[tag=p2] Combat_Rating 5
