...
execute if score ward slot1 matches 1.. run execute as @p[tag=p2] if predicate {condition:"minecraft:entity_properties",entity:"this",predicate:{effects:{"minecraft:conduit_power":{amplifier:{min:1,max:1}}}}} run function ch:wardslot1
...
execute if score ward slot2 matches 1.. run execute as @p[tag=p2] if predicate {condition:"minecraft:entity_properties",entity:"this",predicate:{effects:{"minecraft:conduit_power":{amplifier:{min:2,max:2}}}}} run function ch:wardslot2
...
#Speed Reset
execute if score attackIsOngoingGame1 booleans matches 0 run execute if score speed slot6 matches ..-10000 run execute if score speed slot5 matches ..-10000 run execute if score speed slot4 matches ..-10000 run execute if score speed slot3 matches ..-10000 run execute if score speed slot2 matches ..-10000 run execute if score speed slot1 matches ..-10000 run execute unless score character# slot1 matches 0 run scoreboard players set attackIsOngoingGame1 booleans 1
execute if score attackIsOngoingGame1 booleans matches 0 run execute if score speed slot6 matches ..-10000 run execute if score speed slot5 matches ..-10000 run execute if score speed slot4 matches ..-10000 run execute if score speed slot3 matches ..-10000 run execute if score speed slot2 matches ..-10000 run execute if score speed slot1 matches ..-10000 run execute unless score character# slot1 matches 0 run function ch:turnresetgame1
...
execute if score game1Ongoing ongoinggames matches 1 run execute if score slot4 hp matches ..0 run execute unless score speed slot4 matches -1000000..-900000 run function ch:death4
