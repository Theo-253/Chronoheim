...
execute if score slot1 hp matches ..0 if score slot2 hp matches ..0 if score slot3 hp matches ..0 if score slot4 hp matches ..0 if score testing Combat_Rating matches 0 run scoreboard players add @p[tag=p2] Combat_Rating 5
execute if score slot1 hp matches ..0 if score slot2 hp matches ..0 if score slot3 hp matches ..0 if score slot4 hp matches ..0 if score testing Combat_Rating matches 0 run scoreboard players add @p[tag=p2] Gold 15
execute if score slot1 hp matches ..0 if score slot2 hp matches ..0 if score slot3 hp matches ..0 if score slot4 hp matches ..0 if score testing Combat_Rating matches 0 run scoreboard players add @p[tag=p1] Gold 5
...
execute if score slot5 hp matches ..0 if score slot6 hp matches ..0 if score slot6 hp matches ..0 if score slot8 hp matches ..0 if score testing Combat_Rating matches 0 run scoreboard players add @p[tag=p1] Combat_Rating 5
execute if score slot5 hp matches ..0 if score slot6 hp matches ..0 if score slot6 hp matches ..0 if score slot8 hp matches ..0 if score testing Combat_Rating matches 0 run scoreboard players add @p[tag=p2] Gold 5
execute if score slot5 hp matches ..0 if score slot6 hp matches ..0 if score slot6 hp matches ..0 if score slot8 hp matches ..0 if score testing Combat_Rating matches 0 run scoreboard players add @p[tag=p1] Gold 15
