execute if score game3Ongoing ongoinggames matches 1 run function ch:game3
function ch:effectclear
execute if score game3Ongoing ongoinggames matches 0 if score game3start ongoinggames matches 1 run function ch:draftgame3
execute if score game3start ongoinggames matches 1 if score game3Ongoing ongoinggames matches 0 run execute if score character# slot23 matches 1.. run execute if score character# slot19 matches 1.. run function ch:spellpickp5
execute if score game3start ongoinggames matches 1 if score game3Ongoing ongoinggames matches 0 run execute if score character# slot23 matches 1.. run execute if score character# slot19 matches 1.. run function ch:spellpickp6
