...
execute as @a[tag=p1] run execute as @a[tag=p2] if score game1start ongoinggames matches 0 run say Magic Missile! Magic Missile! I Smite thee with Magic Missile!
