...
execute as @p[tag=p1] if predicate {condition:"minecraft:entity_properties",entity:"this",predicate:{effects:{"minecraft:water_breathing":{amplifier:{min:0,max:0}}}}} if score anubisSpCheckedP1 booleans matches 0 run scoreboard players operation anubisUnusedP1 saves = Spell_Points_P1 Spell_Points
execute as @p[tag=p2] if predicate {condition:"minecraft:entity_properties",entity:"this",predicate:{effects:{"minecraft:water_breathing":{amplifier:{min:0,max:0}}}}} if score anubisSpCheckedP2 booleans matches 0 run scoreboard players operation anubisUnusedP2 saves = Spell_Points_P2 Spell_Points
execute as @p[tag=p1] if predicate {condition:"minecraft:entity_properties",entity:"this",predicate:{effects:{"minecraft:water_breathing":{amplifier:{min:0,max:0}}}}} run scoreboard players set anubisSpCheckedP1 booleans 1
execute as @p[tag=p2] if predicate {condition:"minecraft:entity_properties",entity:"this",predicate:{effects:{"minecraft:water_breathing":{amplifier:{min:0,max:0}}}}} run scoreboard players set anubisSpCheckedP2 booleans 1
