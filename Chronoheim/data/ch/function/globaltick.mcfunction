...
execute if score game1Ongoing ongoinggames matches 0 if score game1start ongoinggames matches 1 if score character# slot3 matches 1.. if score character# slot7 matches 1.. if score Spell_Points_P1 Spell_Points matches -1 if score Spell_Points_P2 Spell_Points matches -1 run function ch:spellpickgame1
