...
execute if score Spell_Points_P1 Spell_Points >= frostBoltSp spellStats run execute if items entity @p[tag=p1,tag=frostboltO] container.* breeze_rod[minecraft:custom_name={"text":"Frostbolt","bold":true,"color":"dark_green","italic":false}] run tellraw @a[tag=p1] ["",{"selector":"@p[tag=p1]"}," picked Frost Bolt."]
...
execute if score Spell_Points_P1 Spell_Points >= shockOrbSp spellStats run execute if items entity @p[tag=p1,tag=shockorbO] container.* heart_of_the_sea[minecraft:custom_name={"text":"Ball Lightning","bold":true,"color":"dark_green","italic":false}] run tellraw @a[tag=p1] ["",{"selector":"@p[tag=p1]"}," picked Shock Orb."]
...
execute if score Spell_Points_P1 Spell_Points >= miracleSp spellStats run execute if items entity @p[tag=p1,tag=protectorsruneO] container.* chiseled_tuff[minecraft:custom_name={"text":"Protector's Rune","bold":true,"color":"blue","italic":false}] run tellraw @a[tag=p1] ["",{"selector":"@p[tag=p1]"}," picked Miracle."]
execute if score Spell_Points_P1 Spell_Points < miracleSp spellStats run execute if items entity @p[tag=p1,tag=protectorsruneO] container.* chiseled_tuff[minecraft:custom_name={"text":"Protector's Rune","bold":true,"color":"blue","italic":false}] run tellraw @a[tag=p1] ["",{"selector":"@p[tag=p1]"}," You dont have enough spell points to equip this spell."]
execute if score Spell_Points_P1 Spell_Points < miracleSp spellStats run execute if items entity @p[tag=p1,tag=protectorsruneO] container.* chiseled_tuff[minecraft:custom_name={"text":"Protector's Rune","bold":true,"color":"blue","italic":false}] run clear @a[tag=p1]
execute if score Spell_Points_P1 Spell_Points >= miracleSp spellStats run execute if items entity @p[tag=p1,tag=protectorsruneO] container.* chiseled_tuff[minecraft:custom_name={"text":"Protector's Rune","bold":true,"color":"blue","italic":false}] run scoreboard players operation Spell_Points_P1 Spell_Points -= miracleSp spellStats
execute if score Spell_Points_P1 Spell_Points >= miracleSp spellStats run execute if items entity @p[tag=p1,tag=protectorsruneO] container.* chiseled_tuff[minecraft:custom_name={"text":"Protector's Rune","bold":true,"color":"blue","italic":false}] run effect clear @a[tag=p1] water_breathing
