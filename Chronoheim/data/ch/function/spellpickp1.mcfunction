#Spell Point Giver
execute if score character# slot7 matches 1.. run execute if score character# slot3 matches 1.. if score Spell_Points_P1 Spell_Points matches ..-1 run give @p[tag=p1] barrier[minecraft:custom_name="Skip Spell Picking",food={can_always_eat:1b,nutrition:1,saturation:1},consumable={consume_seconds:0.1,animation:none,sound:"block.amethyst_block.break",has_consume_particles:0b,on_consume_effects:[{type:apply_effects,effects:[{id:water_breathing,duration:1,amplifier:0,show_particles:0b}]}]}]
execute if score character# slot8 matches 1.. run execute if score character# slot3 matches 1.. if score Spell_Points_P2 Spell_Points matches ..-1 run give @p[tag=p2] barrier[minecraft:custom_name="Skip Spell Picking",food={can_always_eat:1b,nutrition:1,saturation:1},consumable={consume_seconds:0.1,animation:none,sound:"block.amethyst_block.break",has_consume_particles:0b,on_consume_effects:[{type:apply_effects,effects:[{id:water_breathing,duration:1,amplifier:0,show_particles:0b}]}]}]
