...
execute if score spellnumber spells matches 13 run execute if score durationSlot1 shield < embiggenDuration spellStats run scoreboard players operation durationSlot1 shield = dragonforgeDuration spellStats 
...
execute if score spellnumber abilities matches 6 run scoreboard players operation spellDmg saves = frostbolt spellStats
execute if score spellnumber abilities matches 6 run scoreboard players operation spellDmg saves += spellbuffsp2 spells
execute if score spellnumber abilities matches 6 run scoreboard players operation spellDmg saves += marks slot1
execute if score spellnumber abilities matches 6 run scoreboard players operation spellDmg saves /= atkmultiplier slot1
execute if score spellnumber abilities matches 6 run execute if score ward slot1 matches 0 run scoreboard players operation shield slot1 -= spellDmg saves
execute if score spellnumber abilities matches 6 run execute if score ward slot1 matches 0 if score frostboltSpDebuffDuration spellStats > durationslot1 speedDebuffs run scoreboard players operation durationSlot1 speedDebuffs = frostboltSpDebuffDuration spellStats
execute if score spellnumber abilities matches 6 run execute if score ward slot1 matches 0 if score frostboltDmgDebuffDuration spellStats > debuffDurationSlot1 speedDebuffs run scoreboard players operation debuffDurationSlot1 atkmodifiers = frostboltDmgDebuffDuration spellStats
execute if score spellnumber abilities matches 6 run execute if score ward slot1 matches 0 run scoreboard players operation durationSlot1 speedDebuffs += frostboltSpDebuffDuration spellStats
execute if score spellnumber abilities matches 6 run execute if score ward slot1 matches 0 run scoreboard players operation debuffDurationSlot1 atkmodifiers += frostboltDmgDebuffDuration spellStats
execute if score spellnumber abilities matches 6 run execute if score ward slot1 matches 0 run scoreboard players operation speed slot1 -= frostboltSpDebuff spellStats
execute if score spellnumber abilities matches 6 run execute if score ward slot1 matches 0 if score shield slot1 matches ..0 run scoreboard players operation slot1 hp += shield slot1
execute if score spellnumber abilities matches 6 run execute if score ward slot1 matches 1.. run function ch:wardslot1
...
execute if score spellnumber abilities matches 3 run scoreboard players operation spellHeal saves = heal spellstats
execute if score spellnumber abilities matches 3 run scoreboard players operation spellHeal saves += spellbuffsp1 spells
execute if score spellnumber abilities matches 3 run scoreboard players operation slot1 hp += spellHeal saves
execute if score spellnumber abilities matches 3 run function ch:cleanseslot1
