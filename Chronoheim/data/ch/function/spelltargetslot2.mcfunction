...
execute if score spellnumber spells matches 3 run scoreboard players operation slot2 hp += spellHeal saves
execute if score spellnumber spells matches 3 run function ch:cleanseslot2
...
execute if score spellnumber spells matches 23 run execute if score ward slot2 matches 0 run scoreboard players operation slot2Poison atkmodifiers += witchesBrew spellStats
execute if score spellnumber spells matches 23 run execute if score ward slot2 matches 0 run scoreboard players operation slot2Burn atkmodifiers += witchesBrewBurn spellStats
...
execute if score spellnumber spells matches -1 if score shadowsPart1 spells matches 5 if score ward slot2 matches 0 run scoreboard players set durationSlot5-1 fear 1
execute if score spellnumber spells matches -1 if score shadowsPart1 spells matches 6 if score ward slot2 matches 0 run scoreboard players set durationSlot6-1 fear 1
execute if score spellnumber spells matches -1 if score shadowsPart1 spells matches 7 if score ward slot2 matches 0 run scoreboard players set durationSlot7-1 fear 1
execute if score spellnumber spells matches -1 if score shadowsPart1 spells matches 8 if score ward slot2 matches 0 run scoreboard players set durationSlot8-1 fear 1
...
execute if score spellnumber spells matches 3 run execute if score ward slot2 matches 0 run scoreboard players operation slot2burn burn += fireballBurn spellStats
