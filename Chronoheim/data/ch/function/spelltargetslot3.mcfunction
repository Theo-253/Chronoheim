...
execute if score spellnumber spells matches 13 run scoreboard players operation maxhp slot3 += embiggen spellStats
execute if score spellnumber spells matches 13 run scoreboard players operation slot3 hp += embiggen spellStats
...
#Evil Eye
execute if score spellnumber spells matches 15 if score ward slot3 matches 0 run execute if score durationSlot3 mark < evilEyeDuration spellStats run scoreboard players operation durationSlot3 mark = evilEyeDuration spellStats
...
execute if score spellnumber spells matches 2 unless score slot3bleeding booleaneffects matches 1.. run scoreboard players operation slot3 hp += spellHeal saves
...
#Miracle
execute if score spellnumber spells matches 17 run function ch:cleanseslot3
execute if score spellnumber spells matches 17 run scoreboard players set attackIsOngoingGame1 booleans 0
execute if score spellnumber spells matches 17 run tellraw @a[tag=game1] ["",{"selector":"@p[tag=p1]"}," used Miracle on Slot 3!"]
...
execute if score spellnumber spells matches 4 at @e[name=slot3] run particle minecraft:enchanted_hit ~ ~1 ~ 0.9 0.9 0.9 0.5 300
execute if score spellnumber spells matches 4 at @e[name=slot2] run particle minecraft:enchanted_hit ~ ~1 ~ 0.9 0.9 0.9 0.5 150
execute if score spellnumber spells matches 4 at @e[name=slot4] run particle minecraft:enchanted_hit ~ ~1 ~ 0.9 0.9 0.9 0.5 150
...
execute if score spellnumber spells matches 4 run tellraw @a[tag=game1] ["",{"selector":"@p[tag=p2]"}," used Magic Missile on Slot 3!"]
...
execute if score spellnumber spells matches 9 run execute at @n[type=armor_stand,name=slot3] run particle flash{color:[1.000,1.000,1.000,1.00]} ~ ~1 ~ 0.9 0.9 0.9 0.1 10
...
execute if score spellnumber spells matches 31 run scoreboard players operation spellDmg saves += marks slot3
execute if score spellnumber spells matches 31 run scoreboard players operation spellDmg saves /= atkmultiplier slot3
execute if score spellnumber spells matches 31 run execute if score ward slot3 matches 0 run scoreboard players operation shield slot3 -= spellDmg saves
execute if score spellnumber spells matches 31 run execute if score ward slot3 matches 0 if score shield slot3 matches ..0 run scoreboard players operation slot3 hp += shield slot3
execute if score spellnumber spells matches 31 run execute if score ward slot3 matches 1.. run function ch:wardslot3
execute if score spellnumber spells matches 31 run function ch:spellgivetargetsp1reverse
execute if score spellnumber spells matches 31 run execute at @n[type=armor_stand,name=slot3] run particle dust{color:[0.639,0.008,0.008],scale:1} ~ ~1 ~ 0.9 0.9 0.9 0.1 400
execute if score spellnumber spells matches 31 run tellraw @a[tag=game1] ["",{"selector":"@p[tag=p2]"}," used Life Leech on Slot 3!"]
...
execute if score spellnumber spells matches 32 run scoreboard players operation spellDmg saves += marks slot3
execute if score spellnumber spells matches 32 run scoreboard players operation spellDmg saves /= atkmultiplier slot3
execute if score spellnumber spells matches 32 run execute if score ward slot3 matches 0 if score character# slot3 matches ..-1 run scoreboard players operation shield slot3 -= spellDmg saves
execute if score spellnumber spells matches 32 run execute if score ward slot3 matches 0 if score character# slot3 matches ..-1 if score shield slot3 matches ..0 run scoreboard players operation slot3 hp += shield slot3
execute if score spellnumber spells matches 32 run execute if score ward slot3 matches 1.. if score character# slot3 matches ..-1 run function ch:wardslot3
execute if score spellnumber spells matches 32 run execute at @n[type=armor_stand,name=slot3] run particle block{block_state:"minecraft:dripstone_block"} ~ ~ ~ 0.9 2 0.9 1 250 normal
execute if score spellnumber spells matches 32 run tellraw @a[tag=game1] ["",{"selector":"@p[tag=p2]"}," used Decimate on Slot 3!"]
...
execute if score spellnumber spells matches 43 run scoreboard players operation savehp3 saves = slot3 hp
...
#Will O' Wisp
execute if score spellnumber spells matches 38 run execute if score ward slot3 matches 0 if score durationSlot3 burn < willowispDuration spellStats run scoreboard players operation durationSlot3 burn = willowispDuration spellStats
...
execute if score spellnumber spells matches 42 if score ward slot3 matches ..0 unless score curse slot3 matches 5 unless score curse slot3 matches 6 run scoreboard players set curseDuration slot3 -1
