...
execute if score spellnumber spells matches 3 run scoreboard players operation slot3 hp += spellHeal saves
execute if score spellnumber spells matches 3 run function ch:cleanseslot3
...
#Ball Lightning
execute if score spellnumber spells matches 8 if score ward slot3 matches 0 run scoreboard players operation slot3 stun += shockOrb spellStats
execute if score spellnumber spells matches 8 if score ward slot3 matches 1.. run function ch:wardslot3
...
execute if score spellnumber spells matches 3 run scoreboard players operation spellDmg saves += slot3 marks
execute if score spellnumber spells matches 3 run scoreboard players operation spellDmg saves /= atkmultiplier slot3
execute if score spellnumber spells matches 3 run execute if score ward slot3 matches 0 run scoreboard players operation shield slot3 -= spellDmg saves
execute if score spellnumber spells matches 3 run execute if score ward slot3 matches 0 run scoreboard players operation slot3 hp -= shield slot3
execute if score spellnumber spells matches 3 run execute if score ward slot3 matches 0 if score durationSlot3 burn < fireballDuration spellStats run scoreboard players operation durationSlot3 burn = fireballDuration spelltats
execute if score spellnumber spells matches 3 run execute if score ward slot3 matches 0 run scoreboard players operation slot3burn burn += fireballBurn spellStats
execute if score spellnumber spells matches 3 run execute if score ward slot3 matches 1.. run function ch:wardslot3
...
execute if score spellnumber spells matches 7 run execute if score ward slot4 matches 1.. run function ch:wardslot3
...
execute if score spellnumber spells matches 10 run scoreboard players operation spellDmg saves += slot3 marks
...
execute if score spellnumber spells matches 10 run execute if score ward slot3 matches 0 run scoreboard players operation slot3 hp -= shield slot3
