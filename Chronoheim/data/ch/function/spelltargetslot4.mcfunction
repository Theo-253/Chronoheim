...
execute if score spellnumber spells matches 13 run scoreboard players operation maxhp slot4 += embiggen spellStats
execute if score spellnumber spells matches 13 run scoreboard players operation slot4 hp += embiggen spellStats
...
#Evil Eye
execute if score spellnumber spells matches 15 if score ward slot4 matches 0 run execute if score durationSlot4 mark < evilEyeDuration spellStats run scoreboard players operation durationSlot4 mark = evilEyeDuration spellStats
...
#Miracle
execute if score spellnumber spells matches 17 run function ch:cleanseslot4
...
execute if score spellnumber spells matches 9 run execute at @n[type=armor_stand,name=slot4] run particle flash{color:[1.000,1.000,1.000,1.00]} ~ ~1 ~ 0.9 0.9 0.9 0.1 10
...
execute if score spellnumber spells matches -2 if score slot4bleeding booleaneffects matches 0 run scoreboard players operation slot4 hp += spellbuffsp1 spells
execute if score spellnumber spells matches -2 run scoreboard players set attackIsOngoingGame1 booleans 0
...
execute if score spellnumber spells matches 43 run scoreboard players operation savehp4 saves = slot4 hp
...
#Will O' Wisp
execute if score spellnumber spells matches 38 run execute if score ward slot4 matches 0 if score durationSlot4 burn < willowispDuration spellStats run scoreboard players operation durationSlot4 burn = willowispDuration spellStats
...
execute if score spellnumber spells matches 42 if score ward slot4 matches ..0 unless score curse slot4 matches 5 unless score curse slot4 matches 6 run scoreboard players set curseDuration slot4 -1
