...
execute if score spellnumber spells matches 3 run scoreboard players operation slot4 hp += spellHeal saves
execute if score spellnumber spells matches 3 run function ch:cleanseslot4
...
#Ball Lightning
execute if score spellnumber spells matches 8 if score ward slot4 matches 0 run scoreboard players operation slot4 stun += shockOrb spellStats
execute if score spellnumber spells matches 8 if score ward slot4 matches 1.. run function ch:wardslot4
...
execute if score spellnumber spells matches 23 run execute if score ward slot4 matches 0 run scoreboard players operation slot4Poison atkmodifiers += witchesBrew spellStats
execute if score spellnumber spells matches 23 run execute if score ward slot4 matches 0 run scoreboard players operation slot4Burn atkmodifiers += witchesBrewBurn spellStats
...
execute if score spellnumber spells matches 3 run scoreboard players operation spellDmg saves += slot4 marks
...
execute if score spellnumber spells matches 3 run execute if score ward slot4 matches 0 if score durationSlot4 burn < fireballDuration spellStats run scoreboard players operation durationSlot4 burn = fireballDuration spelltats
...
execute if score spellnumber spells matches 10 run scoreboard players operation spellDmg saves += slot4 marks
...
#fountain of youth
execute if score spellnumber spells matches 25 run execute if score diarmedslot4 booleaneffects < fountainOfYouthDuration spellStats run scoreboard players operation diarmedslot4 booleaneffects = fountainOfYouthDuration spellStats
