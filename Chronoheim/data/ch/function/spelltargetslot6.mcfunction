...
execute if score spellnumber spells matches 3 run scoreboard players operation spellDmg saves += slot6 marks
...
execute if score spellnumber spells matches 3 run execute if score ward slot6 matches 0 if score durationSlot6 burn < fireballDuration spellStats run scoreboard players operation durationSlot6 burn = fireballDuration spelltats
...
execute if score spellnumber spells matches 10 run scoreboard players operation spellDmg saves += slot6 marks
