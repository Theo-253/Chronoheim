...
execute if score spellnumber spells matches 13 run scoreboard players operation maxhp slot7 += embiggen spellStats
execute if score spellnumber spells matches 13 run scoreboard players operation slot7 hp += embiggen spellStats
...
#Evil Eye
execute if score spellnumber spells matches 15 if score ward slot7 matches 0 run execute if score durationSlot7 mark < evilEyeDuration spellStats run scoreboard players operation durationSlot7 mark = evilEyeDuration spellStats
...
execute if score spellnumber spells matches 2 unless score slot7bleeding booleaneffects matches 1.. run scoreboard players operation slot7 hp += spellHeal saves
...
#Miracle
execute if score spellnumber spells matches 17 run function ch:cleanseslot7
execute if score spellnumber spells matches 17 run function ch:spellphasep1
execute if score spellnumber spells matches 17 run tellraw @a[tag=game1] ["",{"selector":"@p[tag=p2]"}," used Miracle on Slot 7!"]
...
execute if score spellnumber spells matches 4 at @e[name=slot7] run particle minecraft:enchanted_hit ~ ~1 ~ 0.9 0.9 0.9 0.5 300
execute if score spellnumber spells matches 4 at @e[name=slot6] run particle minecraft:enchanted_hit ~ ~1 ~ 0.9 0.9 0.9 0.5 150
execute if score spellnumber spells matches 4 at @e[name=slot8] run particle minecraft:enchanted_hit ~ ~1 ~ 0.9 0.9 0.9 0.5 150
...
execute if score spellnumber spells matches 4 run scoreboard players set spellbuffsp1 spells 0
execute if score spellnumber spells matches 4 run scoreboard players set attackIsOngoingGame1 booleans 0
execute if score spellnumber spells matches 4 run tellraw @a[tag=game1] ["",{"selector":"@p[tag=p1]"}," used Magic Missile on Slot 7!"]
...
execute if score spellnumber spells matches -2 if score slot7bleeding booleaneffects matches 0 run scoreboard players operation slot7 hp += lifeLeechHeal spellStats
execute if score spellnumber spells matches -2 if score slot7bleeding booleaneffects matches 0 run scoreboard players operation slot7 hp += spellbuffsp2 spells
execute if score spellnumber spells matches -2 run function ch:spellphasep1
execute if score spellnumber spells matches -2 run execute at @n[type=armor_stand,name=slot7] run particle dust{color:[0.639,0.008,0.008],scale:1} ~ ~1 ~ 0.9 0.9 0.9 0.1 400
execute if score spellnumber spells matches -2 run tellraw @a[tag=game1] ["",{"selector":"@p[tag=p2]"}," used Life Leech to heal Slot 7!"]
execute if score spellnumber spells matches -2 run scoreboard players set spellbuffsp2 spells 0
...
execute if score spellnumber spells matches 31 run scoreboard players operation spellDmg saves += marks slot7
execute if score spellnumber spells matches 31 run scoreboard players operation spellDmg saves /= atkmultiplier slot7
execute if score spellnumber spells matches 31 run execute if score ward slot7 matches 0 run scoreboard players operation shield slot7 -= spellDmg saves
execute if score spellnumber spells matches 31 run execute if score ward slot7 matches 0 if score shield slot7 matches ..0 run scoreboard players operation slot7 hp += shield slot7
execute if score spellnumber spells matches 31 run execute if score ward slot7 matches 1.. run function ch:wardslot7
execute if score spellnumber spells matches 31 run function ch:spellgivetargetsp2reverse
execute if score spellnumber spells matches 31 run execute at @n[type=armor_stand,name=slot7] run particle dust{color:[0.639,0.008,0.008],scale:1} ~ ~1 ~ 0.9 0.9 0.9 0.1 400
execute if score spellnumber spells matches 31 run tellraw @a[tag=game1] ["",{"selector":"@p[tag=p1]"}," used Life Leech on Slot 7!"]
...
execute if score spellnumber spells matches 32 run scoreboard players operation spellDmg saves += marks slot7
execute if score spellnumber spells matches 32 run scoreboard players operation spellDmg saves /= atkmultiplier slot7
execute if score spellnumber spells matches 32 run execute if score ward slot7 matches 0 if score character# slot7 matches ..-1 run scoreboard players operation shield slot7 -= spellDmg saves
execute if score spellnumber spells matches 32 run execute if score ward slot7 matches 0 if score character# slot7 matches ..-1 if score shield slot7 matches ..0 run scoreboard players operation slot7 hp += shield slot7
execute if score spellnumber spells matches 32 run execute if score ward slot7 matches 1.. if score character# slot7 matches ..-1 run function ch:wardslot7
execute if score spellnumber spells matches 32 run execute at @n[type=armor_stand,name=slot7] run particle block{block_state:"minecraft:dripstone_block"} ~ ~ ~ 0.9 2 0.9 1 250 normal
execute if score spellnumber spells matches 32 run tellraw @a[tag=game1] ["",{"selector":"@p[tag=p1]"}," used Decimate on Slot 7!"]
...
execute if score spellnumber spells matches -3 if score slot7bleeding booleaneffects matches 0 run scoreboard players operation slot7 hp += cannibalize spellStats
execute if score spellnumber spells matches -3 if score slot7bleeding booleaneffects matches 0 run scoreboard players operation slot7 hp += spellbuffsp1 spells
execute if score spellnumber spells matches -3 run function ch:spellphasep1
execute if score spellnumber spells matches -3 run execute at @n[type=armor_stand,name=slot7] run particle dust{color:[0.639,0.008,0.008],scale:1} ~ ~1 ~ 0.9 0.9 0.9 0.1 400
execute if score spellnumber spells matches -3 run tellraw @a[tag=game1] ["",{"selector":"@p[tag=p2]"}," used Cannibalize to heal Slot 7!"]
execute if score spellnumber spells matches -3 run scoreboard players set spellbuffsp1 spells 0

#cannibalize
execute if score spellnumber spells matches 34 run scoreboard players operation slot7 hp -= cannibalize spellStats
execute if score spellnumber spells matches 34 run scoreboard players operation slot7bleeding booleaneffects += cannibalizeDuration spellStats
execute if score spellnumber spells matches 34 run function ch:spellgivetargetsp1reverse
execute if score spellnumber spells matches 34 run execute at @n[type=armor_stand,name=slot7] run particle dust{color:[0.639,0.008,0.008],scale:1} ~ ~1 ~ 0.9 0.9 0.9 0.1 400
execute if score spellnumber spells matches 34 run tellraw @a[tag=game1] ["",{"selector":"@p[tag=p2]"}," used Cannibalize on Slot 7!"]
execute if score spellnumber spells matches 34 run scoreboard players set spellnumber spells -3

#Dark Ritual
execute if score spellnumber spells matches 40 run execute if score buffDurationSlot7 atkmodifiers < darkpowerDuration spellStats run scoreboard players operation buffDurationSlot7 atkmodifiers = darkpowerDuration spellStats
execute if score spellnumber spells matches 40 run scoreboard players operation attackBuffSlot7 atkmodifiers += darkpower spellStats
execute if score spellnumber spells matches 40 run scoreboard players operation attackBuffSlot7 atkmodifiers += darkritual player2spells
execute if score spellnumber spells matches 40 at @e[name=slot7] run particle minecraft:trial_omen ~ ~1 ~ 0.9 0.9 0.9 0.5 40
execute if score spellnumber spells matches 40 run function ch:spellphasep1
execute if score spellnumber spells matches 40 run tellraw @a[tag=game1] ["",{"selector":"@p[tag=p2]"}," used Dark Ritual on Slot 7!"]

#Monkey's Paw
execute if score spellnumber spells matches 43 run scoreboard players operation invincibleSlot7 booleaneffects = monkeyspaw spellStats
execute if score spellnumber spells matches 43 run scoreboard players operation savehp7 saves = slot7 hp
execute if score spellnumber spells matches 43 run scoreboard players set curse slot7 5
execute if score spellnumber spells matches 43 run scoreboard players set curseStacks slot7 0
execute if score spellnumber spells matches 43 run scoreboard players operation curseDuration slot7 = monkeyspaw spellStats
execute if score spellnumber spells matches 43 at @e[name=slot7] run particle minecraft:raid_omen ~ ~1 ~ 0.9 0.9 0.9 0.00000001 200
...
execute if score spellnumber spells matches 43 run tellraw @a[tag=game1] ["",{"selector":"@p[tag=p2]"}," used Monkey's Paw on Slot 7!"]

#Slimed!
execute if score spellnumber spells matches 35 if score ward slot7 matches 0 run scoreboard players operation disarmedslot7 booleaneffects += slimed spellStats
execute if score spellnumber spells matches 35 if score ward slot7 matches 1.. run function ch:wardslot7
execute if score spellnumber spells matches 35 run scoreboard players set attackIsOngoingGame1 booleans 0
execute if score spellnumber spells matches 35 run execute at @n[type=armor_stand,name=slot7] run particle minecraft:item_slime ~ ~1 ~ 0.7 0.7 0.7 0.3 150
execute if score spellnumber spells matches 35 run tellraw @a[tag=game1] ["",{"selector":"@p[tag=p2]"}," used Slimed! on Slot 7!"]

#Vampire Mark
execute if score spellnumber spells matches 36 run scoreboard players operation lifesteal slot7 = vampiremark spellStats
execute if score spellnumber spells matches 36 run execute at @n[type=armor_stand,name=slot7] run particle minecraft:crimson_spore ~ ~1 ~ 0.6 0.4 0.6 0 200
execute if score spellnumber spells matches 36 run tellraw @a[tag=game1] ["",{"selector":"@p[tag=p2]"}," used Vampire Mark on Slot 7!"]
...
execute if score spellnumber spells matches 37 run scoreboard players operation spellDmg saves += marks slot7
execute if score spellnumber spells matches 37 run scoreboard players operation spellDmg saves /= atkmultiplier slot7
execute if score spellnumber spells matches 37 run execute if score ward slot7 matches 0 run scoreboard players operation shield slot7 -= spellDmg saves
execute if score spellnumber spells matches 37 run execute if score ward slot7 matches 0 if score shield slot7 matches ..0 run scoreboard players operation slot7 hp += shield slot7
execute if score spellnumber spells matches 37 at @e[name=slot7] run particle minecraft:damage_indicator ~ ~1 ~ 0.6 0.6 0.6 0 100
execute if score spellnumber spells matches 37 run execute if score ward slot7 matches 1.. run function ch:wardslot7
...
execute if score spellnumber spells matches 37 run tellraw @a[tag=game1] ["",{"selector":"@p[tag=p1]"}," used Butchering on Slot 7!"]

#Will O' Wisp
execute if score spellnumber spells matches 38 run execute if score ward slot7 matches 0 if score durationSlot7 burn < willowispDuration spellStats run scoreboard players operation durationSlot7 burn = willowispDuration spellStats
execute if score spellnumber spells matches 38 run execute if score ward slot7 matches 0 run scoreboard players operation slot7Burn burn += willowisp spellStats
execute if score spellnumber spells matches 38 run scoreboard players operation spellDmg saves = slot7Burn burn
execute if score spellnumber spells matches 38 run scoreboard players operation spellDmg saves += spellbuffsp1 spells
execute if score spellnumber spells matches 38 run scoreboard players operation spellDmg saves += marks slot7
execute if score spellnumber spells matches 38 run scoreboard players operation spellDmg saves /= atkmultiplier slot7
execute if score spellnumber spells matches 38 run execute if score ward slot7 matches 0 run scoreboard players operation shield slot7 -= spellDmg saves
execute if score spellnumber spells matches 38 run execute if score ward slot7 matches 0 if score shield slot7 matches ..0 run scoreboard players operation slot7 hp += shield slot7
execute if score spellnumber spells matches 38 at @e[name=slot7] run particle minecraft:glow ~ ~1 ~ 0.7 0.7 0.7 0.1 100
execute if score spellnumber spells matches 38 at @e[name=slot7] run particle minecraft:soul_fire_flame ~ ~1 ~ 0.6 0.6 0.6 0.1 100
execute if score spellnumber spells matches 38 run execute if score ward slot7 matches 1.. run function ch:wardslot7
...
execute if score spellnumber spells matches 38 run tellraw @a[tag=game1] ["",{"selector":"@p[tag=p1]"}," used Will O' Wisp on Slot 7!"]

#Curse of Bats
execute if score spellnumber spells matches 42 if score ward slot7 matches ..0 unless score curse slot7 matches 5 unless score curse slot7 matches 6 run scoreboard players set curseStacks slot7 0
execute if score spellnumber spells matches 42 if score ward slot7 matches ..0 unless score curse slot7 matches 5 unless score curse slot7 matches 6 run scoreboard players set curseDuration slot7 -1
execute if score spellnumber spells matches 42 if score ward slot7 matches ..0 unless score curse slot7 matches 5 run scoreboard players set curse slot7 6
execute if score spellnumber spells matches 42 if score ward slot7 matches ..0 unless score curse slot7 matches 5 if score curse slot7 matches 6 run scoreboard players add curseStacks slot7 1
execute if score spellnumber spells matches 42 run execute at @n[name=slot7] run particle shriek{delay:0} ~ ~1 ~ 0.3 0.5 0.3 0.1 200 normal
execute if score spellnumber spells matches 42 run tellraw @a[tag=game1] ["",{"selector":"@p[tag=p1]"}," used Curse of Bats on Slot 7!"]
execute if score spellnumber spells matches 42 if score ward slot7 matches 1.. run function ch:wardslot7
