...
#Ball Lightning
execute if score spellnumber spells matches 8 if score ward slot8 matches 0 run scoreboard players operation slot8 stun += shockOrb spellStats
execute if score spellnumber spells matches 8 if score ward slot8 matches 1.. run function ch:wardslot8
...
execute if score spellnumber spells matches -1 if score shadowsPart1 spells matches 1 if score ward slot8 matches 0 run scoreboard players set durationSlot1-5 fear 1
execute if score spellnumber spells matches -1 if score shadowsPart1 spells matches 2 if score ward slot8 matches 0 run scoreboard players set durationSlot2-5 fear 1
execute if score spellnumber spells matches -1 if score shadowsPart1 spells matches 3 if score ward slot8 matches 0 run scoreboard players set durationSlot3-5 fear 1
execute if score spellnumber spells matches -1 if score shadowsPart1 spells matches 4 if score ward slot8 matches 0 run scoreboard players set durationSlot4-5 fear 1
...
execute if score spellnumber spells matches 3 run scoreboard players operation spellDmg saves += slot8 marks
...
execute if score spellnumber spells matches 3 run execute if score ward slot8 matches 0 if score durationSlot8 burn < fireballDuration spellStats run scoreboard players operation durationSlot8 burn = fireballDuration spelltats
...
execute if score spellnumber spells matches 10 run scoreboard players operation spellDmg saves += slot8 marks
