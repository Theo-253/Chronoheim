...
execute if score abilitynumber3 abilities matches -2 if score character# slot18 matches 27 run function chthree:cleanseslot17
...
execute if score abilitynumber3 abilities matches 23 if score ward slot19 matches 1.. if score slot23isatk booleans matches 1 run function chthree:wardslot19
