...
#Robyn Ability
execute if score abilitynumber3 abilities matches 9 if score ward slot17 matches 0 if score durationSlot17 mark < robynDuration abilityStats run scoreboard players operation durationSlot17 mark = robynDuration abilityStats
...
execute if score abilitynumber3 abilities matches 22 at @e[name=slot17] run particle minecraft:flash{color:[1.000,1.000,1.000,1.00]} ~ ~1 ~ 0.9 0.9 0.9 0.5 100
...
#Scythe
execute if score abilitynumber3 abilities matches 32 if score ward slot17 matches 0 run scoreboard players operation slot17 hp /= scytheDivide abilityStats
execute if score abilitynumber3 abilities matches 32 if score ward slot17 matches 0 run scoreboard players operation slot17 hp *= scytheMult abilityStats
execute if score abilitynumber3 abilities matches 32 if score ward slot17 matches 0 if score slot22isatk booleans matches 1 run scoreboard players operation marks slot17 += scytheLeader abilityStats
execute if score abilitynumber3 abilities matches 32 if score ward slot17 matches 0 if score slot22isatk booleans matches 1 if score durationSlot17 mark < scytheDuration abilityStats run scoreboard players operation durationSlot17 mark = scytheDuration abilityStats
execute if score abilitynumber3 abilities matches 32 if score ward slot17 matches 1.. run function chthree:wardslot17
execute if score abilitynumber3 abilities matches 32 at @e[name=slot17] run particle minecraft:sculk_soul ~ ~1 ~ 0.9 0.9 0.9 0.1 100
execute if score abilitynumber3 abilities matches 32 run tellraw @a[tag=game3] ["",{"selector":"@p[tag=p6]"}," used Cull the Weak on Slot 1!"]

#Doc Basic Attack
execute if score abilitynumber3 abilities matches -1 if score ward slot17 matches 0 run scoreboard players operation slot17Disease disease += doc heroattack
execute if score abilitynumber3 abilities matches -1 if score ward slot17 matches 0 if score slot22isatk booleans matches 1 run scoreboard players operation slot17Disease disease += docLeader heroattack
execute if score abilitynumber3 abilities matches -1 run execute if score ward slot17 matches 1.. run function chthree:wardslot17
...
#Subject ability
execute if score abilitynumber3 abilities matches 4 if score ward slot17 matches 0 if score durationSlot17 poison < subjectDuration abilityStats run scoreboard players operation durationSlot17 poison = subjectDuration abilityStats
execute if score abilitynumber3 abilities matches 4 if score ward slot17 matches 0 run scoreboard players operation slot17Poison poison += subject abilityStats
execute if score abilitynumber3 abilities matches 4 if score ward slot17 matches 0 if score slot22isatk booleans matches 1 run scoreboard players operation slot17Poison poison += subjectLeader abilityStats
execute if score abilitynumber3 abilities matches 4 at @e[name=slot17] run particle minecraft:trial_omen ~ ~1 ~ 0.9 0.9 0.9 0.1 50
...
execute if score abilitynumber3 abilities matches 4 run tellraw @a[tag=game3] ["",{"selector":"@p[tag=p6]"}," used Contagion on Slot 1!"]
...
execute if score abilitynumber3 abilities matches 31 run scoreboard players operation abilityDmg3 saves += marks slot17
execute if score abilitynumber3 abilities matches 31 run scoreboard players operation abilityDmg3 saves /= atkmultiplier slot17
execute if score abilitynumber3 abilities matches 31 run execute if score ward slot17 matches 0 run scoreboard players operation shield slot17 -= abilityDmg3 saves
execute if score abilitynumber3 abilities matches 31 run execute if score ward slot17 matches 0 if score shield slot17 matches ..0 run scoreboard players operation slot17 hp += shield slot17
execute if score abilitynumber3 abilities matches 31 run execute if score ward slot17 matches 0 run scoreboard players operation disarmedslot17 booleaneffects = jones abilityStats
execute if score abilitynumber3 abilities matches 31 run execute if score ward slot17 matches 1 run function chthree:wardslot17
execute if score abilitynumber3 abilities matches 31 run tellraw @a[tag=game3] ["",{"selector":"@p[tag=p6]"}," used Lasso on Slot 1!"]
execute if score abilitynumber3 abilities matches 31 at @e[name=slot17] run particle minecraft:crit ~ ~1 ~ 0.9 0.9 0.9 0.1 100

#Sherman Basic
execute if score abilitynumber3 abilities matches -5 run execute unless score slot17bleeding booleaneffects matches 1.. run scoreboard players operation slot17 hp += sherman heroattack
execute if score abilitynumber3 abilities matches -5 run tellraw @a[tag=game3] ["",{"selector":"@p[tag=p5]"}," healed Slot 1!"]
execute if score abilitynumber3 abilities matches -5 run execute at @n[type=armor_stand,name=slot17] run particle minecraft:composter ~ ~1 ~ 0.9 0.9 0.9 0.5 80

#Sherman Ability
execute if score abilitynumber3 abilities matches 33 run execute if score ward slot17 matches 0 if score debuffDurationSlot17 atkmodifiers < shermanDuration abilityStats run scoreboard players operation debuffDurationSlot17 atkmodifiers = shermanDuration abilityStats
execute if score abilitynumber3 abilities matches 33 run execute if score ward slot17 matches 0 run scoreboard players operation attackDebuffSlot17 atkmodifiers += shermanDebuff abilityStats
...
execute if score abilitynumber3 abilities matches 33 if score slot13isatk booleans matches 1 run scoreboard players operation abilityDmg saves += slot13 atkmodifiers
execute if score abilitynumber3 abilities matches 33 if score slot14isatk booleans matches 1 run scoreboard players operation abilityDmg saves += slot14 atkmodifiers
execute if score abilitynumber3 abilities matches 33 if score slot15isatk booleans matches 1 run scoreboard players operation abilityDmg saves += slot15 atkmodifiers
...
execute if score abilitynumber3 abilities matches 33 at @e[name=slot17] run particle minecraft:pale_oak_leaves ~ ~1 ~ 0.9 0.9 0.9 0.1 100
execute if score abilitynumber3 abilities matches 33 at @e[name=slot17] run particle minecraft:explosion ~ ~1 ~ 0.9 0.9 0.9 0.1 10
...
execute if score abilitynumber3 abilities matches 33 run tellraw @a[tag=game3] ["",{"selector":"@p[tag=p6]"}," used Grasping Roots on Slot 1!"]
execute if score abilitynumber3 abilities matches 33 run scoreboard players operation abilityDmg saves = sherman abilityStats
execute if score abilitynumber3 abilities matches 33 if score slot13isatk booleans matches 1 run scoreboard players operation abilityDmg saves += slot13 atkmodifiers
execute if score abilitynumber3 abilities matches 33 if score slot14isatk booleans matches 1 run scoreboard players operation abilityDmg saves += slot14 atkmodifiers
execute if score abilitynumber3 abilities matches 33 if score slot15isatk booleans matches 1 run scoreboard players operation abilityDmg saves += slot15 atkmodifiers
...
execute if score abilitynumber3 abilities matches 28 run scoreboard players operation abilityDmg3 saves += marks slot17
execute if score abilitynumber3 abilities matches 28 run scoreboard players operation abilityDmg3 saves /= atkmultiplier slot17
execute if score abilitynumber3 abilities matches 28 run execute if score ward slot17 matches 0 run scoreboard players operation shield slot17 -= abilityDmg3 saves
execute if score abilitynumber3 abilities matches 28 run execute if score ward slot17 matches 0 if score slot22isatk booleans matches 1 if score durationSlot22-17 fear <= eidolonLeaderFearDuration abilityStats run scoreboard players operation durationSlot22-17 fear = eidolonLeaderFearDuration abilityStats
execute if score abilitynumber3 abilities matches 28 run execute if score ward slot17 matches 0 if score shield slot17 matches ..0 run scoreboard players operation slot17 hp += shield slot17
execute if score abilitynumber3 abilities matches 28 run execute if score ward slot17 matches 1.. run function chthree:wardslot17
execute if score abilitynumber3 abilities matches 28 run execute at @e[name=slot17,type=armor_stand] run particle raid_omen ~ ~1 ~ 0.3 0.3 0.3 2 100

#Barley
execute if score abilitynumber3 abilities matches -36 if score barleyPart1 abilities matches 5 if score ward slot17 matches ..0 run scoreboard players operation durationSlot21-17 fear = barleyDuration abilityStats 
execute if score abilitynumber3 abilities matches -36 if score barleyPart1 abilities matches 6 if score ward slot17 matches ..0 run scoreboard players operation durationSlot22-17 fear = barleyDuration abilityStats 
execute if score abilitynumber3 abilities matches -36 if score barleyPart1 abilities matches 7 if score ward slot17 matches ..0 run scoreboard players operation durationSlot23-17 fear = barleyDuration abilityStats 
execute if score abilitynumber3 abilities matches -36 if score barleyPart1 abilities matches 8 if score ward slot17 matches ..0 run scoreboard players operation durationSlot24-17 fear = barleyDuration abilityStats 
execute if score abilitynumber3 abilities matches -36 if score ward slot17 matches ..0 if score debuffDurationSlot17 atkmodifiers < barleyDuration abilityStats run scoreboard players operation debuffDurationSlot17 atkmodifiers = barleyDuration abilityStats
execute if score abilitynumber3 abilities matches -36 if score ward slot17 matches ..0 run scoreboard players operation attackDebuffSlot17 atkmodifiers += barley abilityStats
execute if score abilitynumber3 abilities matches -36 if score ward slot17 matches 1.. run function chthree:wardslot17
execute if score abilitynumber3 abilities matches -36 run execute at @n[type=armor_stand,name=slot17] run particle trial_omen ~ ~1 ~ 0.9 0.9 0.9 0.1 400
execute if score abilitynumber3 abilities matches -36 run tellraw @a[tag=game3] ["",{"selector":"@p[tag=p6]"}," used Spookcrow to fear Slot 17!"]

execute if score abilitynumber3 abilities matches 36 run scoreboard players set barleyPart1 abilities 1
execute if score abilitynumber3 abilities matches 36 if score buffDurationSlot17 atkmodifiers < barleyDuration abilityStats run scoreboard players operation buffDurationSlot17 atkmodifiers = barleyDuration abilityStats
execute if score abilitynumber3 abilities matches 36 run scoreboard players operation attackBuffSlot17 atkmodifiers += barley abilityStats
execute if score abilitynumber3 abilities matches 36 run function chthree:abilitygivetargetsp5
execute if score abilitynumber3 abilities matches 36 run execute at @n[type=armor_stand,name=slot17] run particle raid_omen ~ ~1 ~ 0.9 0.9 0.9 0.1 400
execute if score abilitynumber3 abilities matches 36 run tellraw @a[tag=game3] ["",{"selector":"@p[tag=p5]"}," used Spookcrow to make Slot 17 scary!"]

#Igor
execute if score abilitynumber3 abilities matches 38 if score cooldown slot17 matches 1.. run scoreboard players operation cooldown slot17 -= igor abilityStats
execute if score abilitynumber3 abilities matches 38 run execute at @e[type=armor_stand,name=slot17] run particle witch ~ ~1 ~ 0.5 0.8 0.5 0.1 100
execute if score abilitynumber3 abilities matches 38 run execute if score durationSlot17 speedBuffs < igorDuration abilityStats run scoreboard players operation durationSlot17 speedBuffs = igorDuration abilityStats
execute if score abilitynumber3 abilities matches 38 run scoreboard players operation speed slot17 += igorSpBuff abilityStats
execute if score abilitynumber3 abilities matches 38 run scoreboard players operation speedBuffSlot17 speedBuffs += igorSpBuff abilityStats
execute if score abilitynumber3 abilities matches 38 run tellraw @a[tag=game3] ["",{"selector":"@p[tag=p5]"}," used Black Lagoon Brew on Slot 17!"]
execute if score abilitynumber3 abilities matches 38 if score slot18isatk booleans matches 1 run execute if score invincibleSlot17 booleaneffects < igorDuration abilityStats run scoreboard players operation invincibleSlot17 booleaneffects = igorDuration abilityStats
execute if score abilitynumber3 abilities matches 38 if score slot18isatk booleans matches 1 run scoreboard players operation savehp57 saves = slot17 hp

#Zeebo
execute if score abilitynumber3 abilities matches 40 if score ward slot17 matches ..0 unless score curse slot17 matches 5 unless score curse slot17 matches 2 run scoreboard players set curseStacks slot17 0
execute if score abilitynumber3 abilities matches 40 if score ward slot17 matches ..0 unless score curse slot17 matches 5 unless score curse slot17 matches 2 run scoreboard players set curseDuration slot17 0
execute if score abilitynumber3 abilities matches 40 if score ward slot17 matches ..0 unless score curse slot17 matches 5 run scoreboard players set curse slot17 2
execute if score abilitynumber3 abilities matches 40 if score ward slot17 matches ..0 unless score curse slot17 matches 5 if score curse slot17 matches 2 run scoreboard players add curseStacks slot17 1
execute if score abilitynumber3 abilities matches 40 if score ward slot17 matches ..0 run execute if score durationSlot17 burn < zeeboDuration abilityStats run scoreboard players operation durationSlot17 burn = zeeboDuration abilityStats
execute if score abilitynumber3 abilities matches 40 if score ward slot17 matches ..0 run scoreboard players operation slot17Burn burn += zeeboBurn abilityStats
execute if score abilitynumber3 abilities matches 40 run execute at @e[type=armor_stand,name=slot17] run summon firework_rocket ~ ~2 ~ {LifeTime:1,FireworksItem:{id:"minecraft:firework_rocket",count:1,components:{"minecraft:fireworks":{explosions:[{shape:"burst",has_twinkle:true,has_trail:true,colors:[I;13894251,16746496,16770560],fade_colors:[I;10224278]}]}}}}
execute if score abilitynumber3 abilities matches 40 run execute at @e[type=armor_stand,name=slot17] run summon firework_rocket ~ ~2 ~ {LifeTime:1,FireworksItem:{id:"minecraft:firework_rocket",count:1,components:{"minecraft:fireworks":{explosions:[{shape:"burst",has_twinkle:true,has_trail:true,colors:[I;13894251,16746496,16770560],fade_colors:[I;10224278]}]}}}}
execute if score abilitynumber3 abilities matches 40 run tellraw @a[tag=game3] ["",{"selector":"@p[tag=p6]"}," used Last Laugh on Slot 17!"]
execute if score abilitynumber3 abilities matches 40 if score ward slot17 matches 1.. run function chthree:wardslot17

#Fenrir
execute if score abilitynumber3 abilities matches 41 if score ward slot17 matches ..0 unless score curse slot17 matches 5 unless score curse slot17 matches 3 run scoreboard players set curseStacks slot17 0
execute if score abilitynumber3 abilities matches 41 if score ward slot17 matches ..0 unless score curse slot17 matches 5 unless score curse slot17 matches 3 run scoreboard players set curseDuration slot17 -1
execute if score abilitynumber3 abilities matches 41 if score ward slot17 matches ..0 unless score character# slot17 matches 41 unless score curse slot17 matches 5 run scoreboard players set curse slot17 3
...
execute if score abilitynumber3 abilities matches 41 run scoreboard players operation abilityDmg3 saves += marks slot17
execute if score abilitynumber3 abilities matches 41 run scoreboard players operation abilityDmg3 saves /= atkmultiplier slot17
execute if score abilitynumber3 abilities matches 41 run execute if score ward slot17 matches ..0 run scoreboard players operation shield slot17 -= abilityDmg3 saves
execute if score abilitynumber3 abilities matches 41 run execute at @n[type=armor_stand,name=slot17] run particle enchanted_hit ~ ~1 ~ 0.9 0.9 0.9 0.1 400
execute if score abilitynumber3 abilities matches 41 run tellraw @a[tag=game3] ["",{"selector":"@p[tag=p6]"}," used Mark of the Wolf on Slot 17!"]
execute if score abilitynumber3 abilities matches 41 run execute if score ward slot17 matches 0 if score shield slot17 matches ..0 run scoreboard players operation slot17 hp += shield slot17
execute if score abilitynumber3 abilities matches 41 if score ward slot17 matches 1.. run function chthree:wardslot17
...
execute if score abilitynumber3 abilities matches 43 run scoreboard players operation abilityDmg3 saves += marks slot17
execute if score abilitynumber3 abilities matches 43 run scoreboard players operation abilityDmg3 saves /= atkmultiplier slot17
execute if score abilitynumber3 abilities matches 43 run execute if score ward slot17 matches ..0 run scoreboard players operation shield slot17 -= abilityDmg3 saves
execute if score abilitynumber3 abilities matches 43 run execute if score ward slot17 matches ..0 run scoreboard players operation slot17Disease disease += grendelDisease abilityStats
execute if score abilitynumber3 abilities matches 43 run execute at @e[type=armor_stand,name=slot17] run particle minecraft:noxious_gas ~ ~1 ~ 0.7 0.7 0.7 0.05 200
...
execute if score abilitynumber3 abilities matches -43 run execute at @e[type=armor_stand,name=slot17] run particle minecraft:noxious_gas ~ ~1 ~ 0.7 0.7 0.7 0.05 200
execute if score abilitynumber3 abilities matches -43 if score ward slot17 matches 1.. run function chthree:wardslot17
execute if score abilitynumber3 abilities matches -43 run tellraw @a[tag=game3] ["",{"selector":"@p[tag=p6]"}," used Piercing Pestilence on Slot 17!"]
execute if score abilitynumber3 abilities matches 43 run tellraw @a[tag=game3] ["",{"selector":"@p[tag=p6]"}," used Piercing Pestilence on Slot 17!"]
#Frank
...
execute if score abilitynumber3 abilities matches 34 run scoreboard players operation slot17 hp += shield slot17
execute if score abilitynumber3 abilities matches 34 run execute at @e[name=slot17,type=armor_stand] run particle minecraft:angry_villager ~ ~1 ~ 0.9 0.9 0.9 0.5 15
execute if score abilitynumber3 abilities matches 34 run tellraw @a[tag=game3] ["",{"selector":"@p[tag=p5]"}," used IT'S ALIVE! to damage Slot 17!"]
execute if score abilitynumber3 abilities matches 34 run function chthree:abilitygivetargetsp5
execute if score abilitynumber3 abilities matches -34 run execute if score ward slot17 matches 0 run scoreboard players operation slot17 stun = frankDuration abilityStats
execute if score abilitynumber3 abilities matches -34 run execute if score ward slot17 matches 1.. run function chthree:wardslot17
execute if score abilitynumber3 abilities matches -34 run execute at @e[name=slot17,type=armor_stand] run particle minecraft:flash{color:[1.000,1.000,1.000,1.00]} ~ ~1 ~ 0.9 0.9 0.9 0.5 100
execute if score abilitynumber3 abilities matches -34 run tellraw @a[tag=game3] ["",{"selector":"@p[tag=p6]"}," used IT'S ALIVE! to stun Slot 17!"]
...
execute if score abilitynumber3 abilities matches 35 if score slot21isatk booleans matches 1 run scoreboard players operation abilityDmg3 saves += slot17 atkmodifiers
execute if score abilitynumber3 abilities matches 35 if score slot22isatk booleans matches 1 run scoreboard players operation abilityDmg3 saves += slot18 atkmodifiers
execute if score abilitynumber3 abilities matches 35 if score slot23isatk booleans matches 1 run scoreboard players operation abilityDmg3 saves += slot19 atkmodifiers
execute if score abilitynumber3 abilities matches 35 run scoreboard players operation abilityDmg3 saves += marks slot17
execute if score abilitynumber3 abilities matches 35 run scoreboard players operation abilityDmg3 saves /= atkmultiplier slot17
execute if score abilitynumber3 abilities matches 35 run execute if score ward slot17 matches 0 run scoreboard players operation shield slot17 -= abilityDmg3 saves
execute if score abilitynumber3 abilities matches 35 run execute if score ward slot17 matches 0 if score shield slot17 matches ..0 run scoreboard players operation slot17 hp += shield slot17
execute if score abilitynumber3 abilities matches 35 run execute if score ward slot17 matches 1.. run function chthree:wardslot17
execute if score abilitynumber3 abilities matches 35 run execute at @e[name=slot17,type=armor_stand] run particle raid_omen ~ ~1 ~ 0.9 0.9 0.9 2 100
execute if score abilitynumber3 abilities matches 35 run tellraw @a[tag=game3] ["",{"selector":"@p[tag=p6]"}," used Reanimation Beam to damage Slot 17!"]
execute if score abilitynumber3 abilities matches 35 run function chthree:abilitygivetargetsp5reverse

execute if score abilitynumber3 abilities matches -35 if score slot17bleeding booleaneffects matches 0 run scoreboard players operation slot17 hp += abilityDmg3 saves
execute if score abilitynumber3 abilities matches -35 if score character# slot18 matches 35 run function chthree:cleanseslot17
execute if score abilitynumber3 abilities matches -35 if score character# slot18 matches 34 run function chthree:cleanseslot17
execute if score abilitynumber3 abilities matches -35 run execute at @e[name=slot17,type=armor_stand] run particle trial_omen ~ ~1 ~ 0.9 0.9 0.9 2 100
execute if score abilitynumber3 abilities matches -35 run tellraw @a[tag=game3] ["",{"selector":"@p[tag=p5]"}," used Reanimation Beam to heal Slot 17!"]

#Boogaloo
execute if score abilitynumber3 abilities matches 37 unless score curse slot17 matches 5 run scoreboard players set curseDuration slot17 -1
execute if score abilitynumber3 abilities matches 37 if score curseStacks slot17 matches 1.. unless score curse slot17 matches 5 run scoreboard players set curseStacks slot17 0
execute if score abilitynumber3 abilities matches 37 unless score curse slot17 matches 5 run scoreboard players set curse slot17 1
execute if score abilitynumber3 abilities matches 37 run execute at @e[name=slot17,type=armor_stand] run particle minecraft:sculk_soul ~ ~1 ~ 0.9 0.9 0.9 0.15 30
execute if score abilitynumber3 abilities matches 37 run tellraw @a[tag=game3] ["",{"selector":"@p[tag=p6]"}," used Devour Soul on Slot 17!"]
...
execute if score abilitynumber3 abilities matches 42 run tellraw @a[tag=game3] ["",{"selector":"@p[tag=p6]"}," used Wrath of the Desert on Slot 17!"]
...
execute if score abilitynumber3 abilities matches 42 run scoreboard players operation abilityDmg3 saves += marks slot17
execute if score abilitynumber3 abilities matches 42 run scoreboard players operation abilityDmg3 saves /= atkmultiplier slot17
execute if score abilitynumber3 abilities matches 42 run execute if score ward slot17 matches 0 run scoreboard players operation shield slot17 -= abilityDmg3 saves
execute if score abilitynumber3 abilities matches 42 run execute if score ward slot17 matches 0 if score shield slot17 matches ..0 run scoreboard players operation slot17 hp += shield slot17
execute if score abilitynumber3 abilities matches 42 if score ward slot17 matches 1.. run function chthree:wardslot17
