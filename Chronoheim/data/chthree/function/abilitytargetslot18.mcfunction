...
execute if score abilitynumber3 abilities matches 12 run execute if score character# slot22 matches 12 run scoreboard players operation cooldown slot18 = aceSetCooldownLeader abilityStats
