...
execute if score abilitynumber3 abilities matches -2 if score character# slot18 matches 27 run function chthree:cleanseslot20
...
execute if score abilitynumber3 abilities matches 25 if score slot23isatk booleans matches 1 run execute if score ward slot19 matches 1.. run function chthree:wardslot19
