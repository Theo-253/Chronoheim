...
execute if score abilitynumber3 abilities matches 12 run execute if score character# slot22 matches 12 run scoreboard players operation cooldown slot20 = aceSetCooldownLeader abilityStats
...
execute if score abilitynumber3 abilities matches 43 run tellraw @a[tag=game3] ["",{"selector":"@p[tag=p6]"}," used Piercing Pestilence on Slot 4!"]
execute if score abilitynumber3 abilities matches 43 run execute if score ward slot20 matches 0 if score shield slot20 matches ..0 run scoreboard players operation slot20 hp += shield slot20
execute if score abilitynumber3 abilities matches -43 run execute if score ward slot20 matches 0 if score shield slot20 matches ..0 run scoreboard players operation slot20 hp += shield slot20
#Frank
...
execute if score abilitynumber3 abilities matches 42 if score ward slot20 matches 0 run scoreboard players operation abilityDmg3 saves *= anubisUnusedP6 saves
