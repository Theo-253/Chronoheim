...
execute if score abilitynumber3 abilities matches 12 run execute if score character# slot18 matches 12 run scoreboard players operation cooldown slot23 = aceSetCooldownLeader abilityStats
