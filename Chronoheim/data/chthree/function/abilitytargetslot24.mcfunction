...
execute if score abilitynumber3 abilities matches -2 if score character# slot22 matches 27 run function chthree:cleanseslot24
...
execute if score abilitynumber3 abilities matches 7 run execute if score ward slot24 matches 0 if score kongDmgDebuffDuration abilityStats > debuffDurationSlot16 atkmodifiers run scoreboard players operation debuffDurationSlot16 atkmodifiers = kongDmgDebuffDuration abilityStats
execute if score abilitynumber3 abilities matches 7 run execute if score ward slot24 matches 0 run scoreboard players operation speedDebuffSlot16 speedDebuffs += kongSpDebuff abilityStats
execute if score abilitynumber3 abilities matches 7 run execute if score ward slot24 matches 0 run scoreboard players operation attackDebuffSlot16 atkmodifiers += kongDmgDebuff abilityStats
execute if score abilitynumber3 abilities matches 7 run execute if score ward slot24 matches 0 run execute if score slot18isatk booleans matches 1 run scoreboard players operation attackDebuffSlot16 atkmodifiers += kongLeaderDmgDebuff abilityStats
...
#Kirin
execute if score abilitynumber3 abilities matches 8 if score buffDurationSlot16 atkmodifiers < kirinDuration abilityStats run scoreboard players operation buffDurationSlot16 atkmodifiers = kirinDuration abilityStats
