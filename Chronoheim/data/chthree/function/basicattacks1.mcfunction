...
tellraw @a[tag=game3] ["",{"selector":"@p[tag=p6]"}," attacked Slot 1"]
clear @a[tag=p6]
#slot 5
...
execute if score slot21isatk booleans matches 1 run scoreboard players operation atk1 saves += marks slot17
execute if score slot21isatk booleans matches 1 run scoreboard players operation atk1 saves /= atkmultiplier slot17
execute if score slot21isatk booleans matches 1 run scoreboard players operation shield slot17 -= atk1 saves
#slot 6
...
execute if score slot22isatk booleans matches 1 run scoreboard players operation atk1 saves += marks slot17
execute if score slot22isatk booleans matches 1 if score character# slot22 matches 36 run execute unless score durationSlot21-17 fear matches 1.. unless score durationSlot22-17 fear matches 1.. unless score durationSlot23-17 fear matches 1.. unless score durationSlot24-17 fear matches 1.. run scoreboard players operation atk1 saves -= barleyLeader abilityStats
execute if score slot22isatk booleans matches 1 run scoreboard players operation atk1 saves /= atkmultiplier slot17
execute if score slot22isatk booleans matches 1 run scoreboard players operation shield slot17 -= atk1 saves
#slot 7
execute if score slot23isatk booleans matches 1 run scoreboard players operation atk1 saves = atk slot23
execute if score slot23isatk booleans matches 1 run scoreboard players operation atk1 saves += marks slot17
execute if score slot23isatk booleans matches 1 run scoreboard players operation atk1 saves += slot23 atkmodifiers
execute if score slot23isatk booleans matches 1 run scoreboard players operation atk1 saves /= atkmultiplier slot17
execute if score slot23isatk booleans matches 1 run scoreboard players operation shield slot17 -= atk1 saves
#slot 8
execute if score slot24isatk booleans matches 1 run scoreboard players operation atk1 saves = atk slot24
execute if score slot24isatk booleans matches 1 run scoreboard players operation atk1 saves += marks slot17
execute if score slot24isatk booleans matches 1 run scoreboard players operation atk1 saves += slot24 atkmodifiers
execute if score slot24isatk booleans matches 1 run scoreboard players operation atk1 saves /= atkmultiplier slot17
execute if score slot24isatk booleans matches 1 run scoreboard players operation shield slot17 -= atk1 saves
...
execute if score lifesteal slot21 matches 1.. run execute if score slot21isatk booleans matches 1 run scoreboard players operation lifesteal2 saves += marks slot17
execute if score lifesteal slot21 matches 1.. run execute if score slot21isatk booleans matches 1 run scoreboard players operation lifesteal2 saves /= atkmultiplier slot17
...
execute if score ward slot17 matches 0 if score slot21bleeding booleaneffects matches 0 run execute if score lifesteal slot21 matches 1.. run execute if score slot21isatk booleans matches 1 run scoreboard players operation slot21 hp += lifesteal2 saves
...
execute if score lifesteal slot22 matches 1.. run execute if score slot22isatk booleans matches 1 run scoreboard players operation lifesteal2 saves += marks slot17
execute if score lifesteal slot22 matches 1.. run execute if score slot22isatk booleans matches 1 run scoreboard players operation lifesteal2 saves /= atkmultiplier slot17
...
execute if score ward slot17 matches 0 if score slot22bleeding booleaneffects matches 0 run execute if score lifesteal slot22 matches 1.. run execute if score slot22isatk booleans matches 1 run scoreboard players operation slot22 hp += lifesteal2 saves
execute if score ward slot17 matches 0 if score lifesteal slot22 matches 1.. if score slot22isatk booleans matches 1 at @e[name=slot22,type=armor_stand] run particle minecraft:composter ~ ~1 ~ 0.9 0.9 0.9 0.5 50
#slot 7
...
execute if score lifesteal slot23 matches 1.. run execute if score slot23isatk booleans matches 1 run scoreboard players operation lifesteal2 saves += marks slot17
execute if score lifesteal slot23 matches 1.. run execute if score slot23isatk booleans matches 1 run scoreboard players operation lifesteal2 saves /= atkmultiplier slot17
...
execute if score ward slot17 matches 0 if score slot23bleeding booleaneffects matches 0 run execute if score lifesteal slot23 matches 1.. run execute if score slot23isatk booleans matches 1 run scoreboard players operation slot23 hp += lifesteal2 saves
...
execute if score lifesteal slot24 matches 1.. run execute if score slot24isatk booleans matches 1 run scoreboard players operation lifesteal2 saves += marks slot17
execute if score lifesteal slot24 matches 1.. run execute if score slot24isatk booleans matches 1 run scoreboard players operation lifesteal2 saves /= atkmultiplier slot17
...
execute if score ward slot17 matches 0 if score slot24bleeding booleaneffects matches 0 run execute if score lifesteal slot24 matches 1.. run execute if score slot24isatk booleans matches 1 run scoreboard players operation slot24 hp += lifesteal2 saves
...
#Special Cases
execute if score ward slot17 matches ..0 if score slot21isatk booleans matches 1 if score character# slot21 matches 29 if score slot17 hp <= ripperHpBleed abilityStats run scoreboard players operation slot17bleeding booleaneffects = ripperBleed abilityStats
execute if score ward slot17 matches ..0 if score slot22isatk booleans matches 1 if score character# slot22 matches 29 if score slot17 hp <= ripperHpBleed abilityStats run scoreboard players operation slot17bleeding booleaneffects = ripperBleed abilityStats
execute if score ward slot17 matches ..0 if score slot23isatk booleans matches 1 if score character# slot23 matches 29 if score slot17 hp <= ripperHpBleed abilityStats run scoreboard players operation slot17bleeding booleaneffects = ripperBleed abilityStats
execute if score ward slot17 matches ..0 run execute if score slot21isatk booleans matches 1 if score character# slot21 matches -8 run scoreboard players operation slot17Disease disease += zombieDisease abilityStats
execute if score ward slot17 matches ..0 run execute if score slot22isatk booleans matches 1 if score character# slot22 matches -8 run scoreboard players operation slot17Disease disease += zombieDisease abilityStats
execute if score ward slot17 matches ..0 run execute if score slot23isatk booleans matches 1 if score character# slot23 matches -8 run scoreboard players operation slot17Disease disease += zombieDisease abilityStats
execute if score ward slot17 matches ..0 run execute if score slot24isatk booleans matches 1 if score character# slot24 matches -8 run scoreboard players operation slot17Disease disease += zombieDisease abilityStats
#damage + shield reset (all)
