...
tellraw @a[tag=game3] ["",{"selector":"@p[tag=p6]"}," attacked Slot 2"]
clear @a[tag=p6]
#slot 5
...
execute if score slot22isatk booleans matches 1 run scoreboard players operation atk1 saves += marks slot18
execute if score slot22isatk booleans matches 1 if score character# slot22 matches 36 run execute unless score durationSlot21-18 fear matches 1.. unless score durationSlot22-18 fear matches 1.. unless score durationSlot23-18 fear matches 1.. unless score durationSlot24-18 fear matches 1.. run scoreboard players operation atk1 saves -= barleyLeader abilityStats
execute if score slot22isatk booleans matches 1 if score character# slot22 matches 30 run scoreboard players operation atk1 saves += dominoLeaderHit heroattack
execute if score slot22isatk booleans matches 1 run scoreboard players operation atk1 saves /= atkmultiplier slot18
execute if score slot22isatk booleans matches 1 run scoreboard players operation shield slot18 -= atk1 saves
#slot 7
...
execute if score splash slot22 matches 1.. run execute if score slot22isatk booleans matches 1 run scoreboard players operation splashdamage2 saves += marks slot17
execute if score splash slot22 matches 1.. run execute if score slot22isatk booleans matches 1 run scoreboard players operation splashdamage2 saves /= atkmultiplier slot17
execute if score ward slot17 matches 0 run execute if score splash slot22 matches 1.. run execute if score slot22isatk booleans matches 1 run scoreboard players operation shield slot17 -= splashdamage2 saves
execute if score ward slot17 matches 1.. run execute if score splash slot22 matches 1.. run execute if score slot22isatk booleans matches 1 run function chthree:wardslot17
execute if score splash slot22 matches 1.. if score slot22isatk booleans matches 1 at @e[name=slot17,type=armor_stand] run particle minecraft:crit ~ ~1 ~ 0.9 0.9 0.9 0.5 50
execute if score splash slot22 matches 1.. run execute if score slot22isatk booleans matches 1 run scoreboard players operation splashdamage2 saves = atk slot22
execute if score splash slot22 matches 1.. run execute if score slot22isatk booleans matches 1 run scoreboard players operation splashdamage2 saves += slot22 atkmodifiers
execute if score splash slot22 matches 1.. run execute if score slot22isatk booleans matches 1 run scoreboard players operation splashdamage2 saves /= splash slot22
...
execute if score lifesteal slot22 matches 1.. run execute if score slot22isatk booleans matches 1 run scoreboard players operation lifesteal2 saves += marks slot18
execute if score lifesteal slot22 matches 1.. if score slot22isatk booleans matches 1 if score character# slot22 matches 30 run scoreboard players operation lifesteal2 saves += dominoLeaderHit heroattack
execute if score lifesteal slot22 matches 1.. run execute if score slot22isatk booleans matches 1 run scoreboard players operation lifesteal2 saves /= atkmultiplier slot18
...
execute if score ward slot18 matches 0 if score slot22bleeding booleaneffects matches 0 run execute if score lifesteal slot22 matches 1.. run execute if score slot22isatk booleans matches 1 run scoreboard players operation slot22 hp += lifesteal2 saves
execute if score ward slot18 matches 0 if score lifesteal slot22 matches 1.. if score slot22isatk booleans matches 1 at @e[name=slot22,type=armor_stand] run particle minecraft:composter ~ ~1 ~ 0.9 0.9 0.9 0.5 50
#slot 7
...
execute if score lifesteal slot22 matches 1.. run execute if score splash slot22 matches 1.. run execute if score slot22isatk booleans matches 1 run scoreboard players operation lifestealsplash2 saves += marks slot17
execute if score lifesteal slot22 matches 1.. run execute if score splash slot22 matches 1.. run execute if score slot22isatk booleans matches 1 run scoreboard players operation lifestealsplash2 saves /= atkmultiplier slot17
...
#Special Cases
execute if score ward slot18 matches ..0 if score slot21isatk booleans matches 1 if score character# slot21 matches 29 if score slot18 hp <= ripperHpBleed abilityStats run scoreboard players operation slot18bleeding booleaneffects = ripperBleed abilityStats
execute if score ward slot18 matches ..0 if score slot22isatk booleans matches 1 if score character# slot22 matches 29 if score slot18 hp <= ripperHpBleed abilityStats run scoreboard players operation slot18bleeding booleaneffects = ripperBleed abilityStats
execute if score ward slot18 matches ..0 if score slot23isatk booleans matches 1 if score character# slot23 matches 29 if score slot18 hp <= ripperHpBleed abilityStats run scoreboard players operation slot18bleeding booleaneffects = ripperBleed abilityStats
execute if score ward slot18 matches ..0 run execute if score slot21isatk booleans matches 1 if score character# slot21 matches -8 run scoreboard players operation slot18Disease disease += zombieDisease abilityStats
execute if score ward slot18 matches ..0 run execute if score slot22isatk booleans matches 1 if score character# slot22 matches -8 run scoreboard players operation slot18Disease disease += zombieDisease abilityStats
execute if score ward slot18 matches ..0 run execute if score slot23isatk booleans matches 1 if score character# slot23 matches -8 run scoreboard players operation slot18Disease disease += zombieDisease abilityStats
execute if score ward slot18 matches ..0 run execute if score slot24isatk booleans matches 1 if score character# slot24 matches -8 run scoreboard players operation slot18Disease disease += zombieDisease abilityStats
#damage + shield reset (all)
