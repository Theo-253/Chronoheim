...
execute if score slot22isatk booleans matches 1 if score character# slot22 matches 36 run execute unless score durationSlot21-19 fear matches 1.. unless score durationSlot22-19 fear matches 1.. unless score durationSlot23-19 fear matches 1.. unless score durationSlot24-19 fear matches 1.. run scoreboard players operation atk1 saves -= barleyLeader abilityStats
...
#Special Cases
execute if score ward slot19 matches ..0 if score slot21isatk booleans matches 1 if score character# slot21 matches 29 if score slot19 hp <= ripperHpBleed abilityStats run scoreboard players operation slot19bleeding booleaneffects = ripperBleed abilityStats
execute if score ward slot19 matches ..0 if score slot22isatk booleans matches 1 if score character# slot22 matches 29 if score slot19 hp <= ripperHpBleed abilityStats run scoreboard players operation slot19bleeding booleaneffects = ripperBleed abilityStats
execute if score ward slot19 matches ..0 if score slot23isatk booleans matches 1 if score character# slot23 matches 29 if score slot19 hp <= ripperHpBleed abilityStats run scoreboard players operation slot19bleeding booleaneffects = ripperBleed abilityStats
execute if score ward slot19 matches ..0 run execute if score slot21isatk booleans matches 1 if score character# slot21 matches -8 run scoreboard players operation slot19Disease disease += zombieDisease abilityStats
execute if score ward slot19 matches ..0 run execute if score slot22isatk booleans matches 1 if score character# slot22 matches -8 run scoreboard players operation slot19Disease disease += zombieDisease abilityStats
execute if score ward slot19 matches ..0 run execute if score slot23isatk booleans matches 1 if score character# slot23 matches -8 run scoreboard players operation slot19Disease disease += zombieDisease abilityStats
execute if score ward slot19 matches ..0 run execute if score slot24isatk booleans matches 1 if score character# slot24 matches -8 run scoreboard players operation slot19Disease disease += zombieDisease abilityStats
#damage + shield reset (all)
