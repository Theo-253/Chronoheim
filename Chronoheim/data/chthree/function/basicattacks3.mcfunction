...
execute if score slot22isatk booleans matches 1 if score character# slot22 matches 29 run scoreboard players operation slot19bleeding booleaneffects = ripperBleed abilityStats
