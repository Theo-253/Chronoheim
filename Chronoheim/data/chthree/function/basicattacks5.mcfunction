...
execute if score slot18isatk booleans matches 1 if score character# slot18 matches 36 run execute unless score durationSlot17-21 fear matches 1.. unless score durationSlot18-21 fear matches 1.. unless score durationSlot19-21 fear matches 1.. unless score durationSlot20-21 fear matches 1.. run scoreboard players operation atk1 saves -= barleyLeader abilityStats
...
execute if score lifesteal slot17 matches 1.. run execute if score slot17isatk booleans matches 1 run scoreboard players operation lifesteal2 saves += marks slot21
execute if score lifesteal slot17 matches 1.. run execute if score slot17isatk booleans matches 1 run scoreboard players operation lifesteal2 saves /= atkmultiplier slot21
...
execute if score lifesteal slot18 matches 1.. run execute if score slot18isatk booleans matches 1 run scoreboard players operation lifesteal2 saves += marks slot21
execute if score lifesteal slot18 matches 1.. run execute if score slot18isatk booleans matches 1 run scoreboard players operation lifesteal2 saves /= atkmultiplier slot21
...
execute if score lifesteal slot19 matches 1.. run execute if score slot19isatk booleans matches 1 run scoreboard players operation lifesteal2 saves += marks slot21
execute if score lifesteal slot19 matches 1.. run execute if score slot19isatk booleans matches 1 run scoreboard players operation lifesteal2 saves /= atkmultiplier slot21
...
execute if score lifesteal slot20 matches 1.. run execute if score slot20isatk booleans matches 1 run scoreboard players operation lifesteal2 saves += marks slot21
execute if score lifesteal slot20 matches 1.. run execute if score slot20isatk booleans matches 1 run scoreboard players operation lifesteal2 saves /= atkmultiplier slot21
...
#Special Cases
execute if score ward slot21 matches ..0 if score slot17isatk booleans matches 1 if score character# slot17 matches 29 if score slot21 hp <= ripperHpBleed abilityStats run scoreboard players operation slot21bleeding booleaneffects = ripperBleed abilityStats
execute if score ward slot21 matches ..0 if score slot18isatk booleans matches 1 if score character# slot18 matches 29 if score slot21 hp <= ripperHpBleed abilityStats run scoreboard players operation slot21bleeding booleaneffects = ripperBleed abilityStats
execute if score ward slot21 matches ..0 if score slot19isatk booleans matches 1 if score character# slot19 matches 29 if score slot21 hp <= ripperHpBleed abilityStats run scoreboard players operation slot21bleeding booleaneffects = ripperBleed abilityStats
execute if score ward slot21 matches ..0 run execute if score slot17isatk booleans matches 1 if score character# slot17 matches -8 run scoreboard players operation slot21Disease disease += zombieDisease abilityStats
execute if score ward slot21 matches ..0 run execute if score slot18isatk booleans matches 1 if score character# slot18 matches -8 run scoreboard players operation slot21Disease disease += zombieDisease abilityStats
execute if score ward slot21 matches ..0 run execute if score slot19isatk booleans matches 1 if score character# slot19 matches -8 run scoreboard players operation slot21Disease disease += zombieDisease abilityStats
execute if score ward slot21 matches ..0 run execute if score slot20isatk booleans matches 1 if score character# slot20 matches -8 run scoreboard players operation slot21Disease disease += zombieDisease abilityStats
#damage + shield reset (all)
