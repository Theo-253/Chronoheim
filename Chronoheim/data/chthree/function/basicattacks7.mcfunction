...
tellraw @a[tag=game3] ["",{"selector":"@p[tag=p5]"}," attacked Slot 7"]
clear @a[tag=p5]
#slot 5
...
execute if score slot18isatk booleans matches 1 if score character# slot18 matches 36 run execute unless score durationSlot17-23 fear matches 1.. unless score durationSlot18-23 fear matches 1.. unless score durationSlot19-23 fear matches 1.. unless score durationSlot20-23 fear matches 1.. run scoreboard players operation atk1 saves -= barleyLeader abilityStats
...
#Special Cases
execute if score ward slot23 matches ..0 if score slot17isatk booleans matches 1 if score character# slot17 matches 29 if score slot23 hp <= ripperHpBleed abilityStats run scoreboard players operation slot23bleeding booleaneffects = ripperBleed abilityStats
execute if score ward slot23 matches ..0 if score slot18isatk booleans matches 1 if score character# slot18 matches 29 if score slot23 hp <= ripperHpBleed abilityStats run scoreboard players operation slot23bleeding booleaneffects = ripperBleed abilityStats
execute if score ward slot23 matches ..0 if score slot19isatk booleans matches 1 if score character# slot19 matches 29 if score slot23 hp <= ripperHpBleed abilityStats run scoreboard players operation slot23bleeding booleaneffects = ripperBleed abilityStats
execute if score ward slot23 matches ..0 run execute if score slot17isatk booleans matches 1 if score character# slot17 matches -8 run scoreboard players operation slot23Disease disease += zombieDisease abilityStats
execute if score ward slot23 matches ..0 run execute if score slot18isatk booleans matches 1 if score character# slot18 matches -8 run scoreboard players operation slot23Disease disease += zombieDisease abilityStats
execute if score ward slot23 matches ..0 run execute if score slot19isatk booleans matches 1 if score character# slot19 matches -8 run scoreboard players operation slot23Disease disease += zombieDisease abilityStats
execute if score ward slot23 matches ..0 run execute if score slot20isatk booleans matches 1 if score character# slot20 matches -8 run scoreboard players operation slot23Disease disease += zombieDisease abilityStats
#damage + shield reset (all)
