...
tellraw @a[tag=game3] ["",{"selector":"@p[tag=p5]"}," attacked Slot 8"]
clear @a[tag=p5]
#slot 5
...
execute if score slot17isatk booleans matches 1 run scoreboard players operation atk1 saves += marks slot24
execute if score slot17isatk booleans matches 1 run scoreboard players operation atk1 saves /= atkmultiplier slot24
execute if score slot17isatk booleans matches 1 run scoreboard players operation shield slot24 -= atk1 saves
#slot 6
...
execute if score slot18isatk booleans matches 1 run scoreboard players operation atk1 saves += marks slot24
execute if score slot18isatk booleans matches 1 if score character# slot18 matches 36 run execute unless score durationSlot17-24 fear matches 1.. unless score durationSlot18-24 fear matches 1.. unless score durationSlot19-24 fear matches 1.. unless score durationSlot20-24 fear matches 1.. run scoreboard players operation atk1 saves -= barleyLeader abilityStats
execute if score slot18isatk booleans matches 1 run scoreboard players operation atk1 saves /= atkmultiplier slot24
execute if score slot18isatk booleans matches 1 run scoreboard players operation shield slot24 -= atk1 saves
#slot 7
execute if score slot19isatk booleans matches 1 run scoreboard players operation atk1 saves = atk slot19
execute if score slot19isatk booleans matches 1 run scoreboard players operation atk1 saves += marks slot24
execute if score slot19isatk booleans matches 1 run scoreboard players operation atk1 saves += slot19 atkmodifiers
execute if score slot19isatk booleans matches 1 run scoreboard players operation atk1 saves /= atkmultiplier slot24
execute if score slot19isatk booleans matches 1 run scoreboard players operation shield slot24 -= atk1 saves
#slot 8
execute if score slot20isatk booleans matches 1 run scoreboard players operation atk1 saves = atk slot20
execute if score slot20isatk booleans matches 1 run scoreboard players operation atk1 saves += marks slot24
execute if score slot20isatk booleans matches 1 run scoreboard players operation atk1 saves += slot20 atkmodifiers
execute if score slot20isatk booleans matches 1 run scoreboard players operation atk1 saves /= atkmultiplier slot24
execute if score slot20isatk booleans matches 1 run scoreboard players operation shield slot24 -= atk1 saves
...
execute if score lifesteal slot17 matches 1.. run execute if score slot17isatk booleans matches 1 run scoreboard players operation lifesteal2 saves += marks slot24
execute if score lifesteal slot17 matches 1.. run execute if score slot17isatk booleans matches 1 run scoreboard players operation lifesteal2 saves /= atkmultiplier slot24
...
execute if score ward slot24 matches 0 if score slot17bleeding booleaneffects matches 0 run execute if score lifesteal slot17 matches 1.. run execute if score slot17isatk booleans matches 1 run scoreboard players operation slot17 hp += lifesteal2 saves
...
execute if score lifesteal slot18 matches 1.. run execute if score slot18isatk booleans matches 1 run scoreboard players operation lifesteal2 saves += marks slot24
execute if score lifesteal slot18 matches 1.. run execute if score slot18isatk booleans matches 1 run scoreboard players operation lifesteal2 saves /= atkmultiplier slot24
...
execute if score ward slot24 matches 0 if score slot18bleeding booleaneffects matches 0 run execute if score lifesteal slot18 matches 1.. run execute if score slot18isatk booleans matches 1 run scoreboard players operation slot18 hp += lifesteal2 saves
...
execute if score lifesteal slot19 matches 1.. run execute if score slot19isatk booleans matches 1 run scoreboard players operation lifesteal2 saves += marks slot24
execute if score lifesteal slot19 matches 1.. run execute if score slot19isatk booleans matches 1 run scoreboard players operation lifesteal2 saves /= atkmultiplier slot24
...
execute if score ward slot24 matches 0 if score slot19bleeding booleaneffects matches 0 run execute if score lifesteal slot19 matches 1.. run execute if score slot19isatk booleans matches 1 run scoreboard players operation slot19 hp += lifesteal2 saves
...
execute if score lifesteal slot20 matches 1.. run execute if score slot20isatk booleans matches 1 run scoreboard players operation lifesteal2 saves += marks slot24
execute if score lifesteal slot20 matches 1.. run execute if score slot20isatk booleans matches 1 run scoreboard players operation lifesteal2 saves /= atkmultiplier slot24
...
execute if score ward slot24 matches 0 if score slot20bleeding booleaneffects matches 0 run execute if score lifesteal slot20 matches 1.. run execute if score slot20isatk booleans matches 1 run scoreboard players operation slot20 hp += lifesteal2 saves
...
#Special Cases
execute if score ward slot24 matches ..0 if score slot17isatk booleans matches 1 if score character# slot17 matches 29 if score slot24 hp <= ripperHpBleed abilityStats run scoreboard players operation slot24bleeding booleaneffects = ripperBleed abilityStats
execute if score ward slot24 matches ..0 if score slot18isatk booleans matches 1 if score character# slot18 matches 29 if score slot24 hp <= ripperHpBleed abilityStats run scoreboard players operation slot24bleeding booleaneffects = ripperBleed abilityStats
execute if score ward slot24 matches ..0 if score slot19isatk booleans matches 1 if score character# slot19 matches 29 if score slot24 hp <= ripperHpBleed abilityStats run scoreboard players operation slot24bleeding booleaneffects = ripperBleed abilityStats
execute if score ward slot24 matches ..0 run execute if score slot17isatk booleans matches 1 if score character# slot17 matches -8 run scoreboard players operation slot24Disease disease += zombieDisease abilityStats
execute if score ward slot24 matches ..0 run execute if score slot18isatk booleans matches 1 if score character# slot18 matches -8 run scoreboard players operation slot24Disease disease += zombieDisease abilityStats
execute if score ward slot24 matches ..0 run execute if score slot19isatk booleans matches 1 if score character# slot19 matches -8 run scoreboard players operation slot24Disease disease += zombieDisease abilityStats
execute if score ward slot24 matches ..0 run execute if score slot20isatk booleans matches 1 if score character# slot20 matches -8 run scoreboard players operation slot24Disease disease += zombieDisease abilityStats
#damage + shield reset (all)
