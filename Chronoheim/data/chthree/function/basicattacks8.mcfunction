...
#Special Cases
execute if score slot17isatk booleans matches 1 if score character# slot17 matches 29 if score hp slot24 <= ripperHpBleed abilityStats run scoreboard players operation slot24bleeding booleaneffects = ripperBleed abilityStats
execute if score slot18isatk booleans matches 1 if score character# slot18 matches 29 if score hp slot24 <= ripperHpBleed abilityStats run scoreboard players operation slot24bleeding booleaneffects = ripperBleed abilityStats
execute if score slot19isatk booleans matches 1 if score character# slot19 matches 29 if score hp slot24 <= ripperHpBleed abilityStats run scoreboard players operation slot24bleeding booleaneffects = ripperBleed abilityStats
