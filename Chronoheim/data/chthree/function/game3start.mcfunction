...
execute at @p[tag=p5,tag=lab] run place template map.lab 200 0 262
execute at @p[tag=p6,tag=lab] run place template map.lab 199 0 292 180
execute at @p[tag=p5,tag=!lab,tag=!colosseum] run place template map.scenic 200 1 262
execute at @p[tag=p6,tag=!lab,tag=!colosseum] run place template map.scenic 199 1 292 180
#Slot 1 Speed Reset
...
execute if score slot22 hp matches 1.. run execute if score character# slot22 matches -3 run scoreboard players operation speed slot22 = healingtotem herospeed
