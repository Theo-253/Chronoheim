...
execute if score character# slot18 matches 9 run execute if score ward slot23 matches 1 run function chthree:wardslot23
...
execute if score character# slot23 matches 9 run execute if score ward slot23 matches 1 run function chthree:wardslot18
