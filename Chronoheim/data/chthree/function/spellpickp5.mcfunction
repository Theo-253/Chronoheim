#Spell Point Giver
execute if score character# slot23 matches 1.. run execute if score character# slot19 matches 1.. if score Spell_Points_P5 Spell_Points matches ..-1 run give @p[tag=p5] barrier[minecraft:custom_name="Skip Spell Picking",food={can_always_eat:1b,nutrition:1,saturation:1},consumable={consume_seconds:0.1,animation:none,sound:"block.amethyst_block.break",has_consume_particles:0b,on_consume_effects:[{type:apply_effects,effects:[{id:water_breathing,duration:1,amplifier:0,show_particles:0b}]}]}]
execute if score character# slot23 matches 1.. run execute if score character# slot19 matches 1.. if score Spell_Points_P6 Spell_Points matches ..-1 run give @p[tag=p6] barrier[minecraft:custom_name="Skip Spell Picking",food={can_always_eat:1b,nutrition:1,saturation:1},consumable={consume_seconds:0.1,animation:none,sound:"block.amethyst_block.break",has_consume_particles:0b,on_consume_effects:[{type:apply_effects,effects:[{id:water_breathing,duration:1,amplifier:0,show_particles:0b}]}]}]
...
execute if score character# slot23 matches 1.. run execute if score character# slot19 matches 1.. run execute if score Spell_Points_P5 Spell_Points matches -2 run scoreboard players set Spell_Points_P5 Spell_Points 9
execute if score character# slot23 matches 1.. run execute if score character# slot19 matches 1.. run execute if score Spell_Points_P5 Spell_Points matches -3 run scoreboard players set Spell_Points_P5 Spell_Points 11
execute if score character# slot23 matches 1.. run execute if score character# slot19 matches 1.. run execute if score Spell_Points_P6 Spell_Points matches -2 run scoreboard players set Spell_Points_P6 Spell_Points 9
execute if score character# slot23 matches 1.. run execute if score character# slot19 matches 1.. run execute if score Spell_Points_P6 Spell_Points matches -3 run scoreboard players set Spell_Points_P6 Spell_Points 11

scoreboard players operation spellpick5 drafts = Spell_Points_P5 Spell_Points
...
execute if score Spell_Points_P5 Spell_Points >= miracleSp spellStats run execute if items entity @p[tag=p5,tag=protectorsruneO] container.* chiseled_tuff[minecraft:custom_name={"text":"Protector's Rune","bold":true,"color":"blue","italic":false}] run tellraw @a[tag=p5] ["",{"selector":"@p[tag=p5]"}," picked Miracle."]
...
execute if score Spell_Points_P5 Spell_Points < miracleSp spellStats run execute if items entity @p[tag=p5,tag=protectorsruneO] container.* chiseled_tuff[minecraft:custom_name={"text":"Protector's Rune","bold":true,"color":"blue","italic":false}] run clear @a[tag=p5]
execute if score Spell_Points_P5 Spell_Points >= miracleSp spellStats run execute if items entity @p[tag=p5,tag=protectorsruneO] container.* chiseled_tuff[minecraft:custom_name={"text":"Protector's Rune","bold":true,"color":"blue","italic":false}] run scoreboard players operation Spell_Points_P5 Spell_Points -= miracleSp spellStats
execute if score Spell_Points_P5 Spell_Points >= miracleSp spellStats run execute if items entity @p[tag=p5,tag=protectorsruneO] container.* chiseled_tuff[minecraft:custom_name={"text":"Protector's Rune","bold":true,"color":"blue","italic":false}] run effect clear @a[tag=p5] water_breathing
...
execute if score spellpick5 drafts > Spell_Points_P5 Spell_Points run clear @a[tag=p5]

execute if score Spell_Points_P5 Spell_Points matches 0 run execute if score Spell_Points_P6 Spell_Points matches 0 run function ch:game3start