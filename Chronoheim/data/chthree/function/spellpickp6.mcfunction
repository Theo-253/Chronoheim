scoreboard players operation spellpick6 drafts = Spell_Points_P6 Spell_Points

give @p[tag=p6] barrier[minecraft:custom_name="Skip Spell Picking",food={can_always_eat:1b,nutrition:1,saturation:1},consumable={consume_seconds:0.1,animation:none,sound:"block.amethyst_block.break",has_consume_particles:0b,on_consume_effects:[{type:apply_effects,effects:[{id:water_breathing,duration:1,amplifier:0,show_particles:0b}]}]}]
...
execute if score Spell_Points_P6 Spell_Points >= miracleSp spellStats run execute if items entity @p[tag=p6,tag=protectorsruneO] container.* chiseled_tuff[minecraft:custom_name={"text":"Protector's Rune","bold":true,"color":"blue","italic":false}] run tellraw @a[tag=p6] ["",{"selector":"@p[tag=p6]"}," picked Miracle."]
execute if score Spell_Points_P6 Spell_Points < miracleSp spellStats run execute if items entity @p[tag=p6,tag=protectorsruneO] container.* chiseled_tuff[minecraft:custom_name={"text":"Protector's Rune","bold":true,"color":"blue","italic":false}] run tellraw @a[tag=p6] ["",{"selector":"@p[tag=p6]"}," You dont have enough spell points to equip this spell."]
execute if score Spell_Points_P6 Spell_Points < miracleSp spellStats run execute if items entity @p[tag=p6,tag=protectorsruneO] container.* chiseled_tuff[minecraft:custom_name={"text":"Protector's Rune","bold":true,"color":"blue","italic":false}] run clear @a[tag=p6]
execute if score Spell_Points_P6 Spell_Points >= miracleSp spellStats run execute if items entity @p[tag=p6,tag=protectorsruneO] container.* chiseled_tuff[minecraft:custom_name={"text":"Protector's Rune","bold":true,"color":"blue","italic":false}] run scoreboard players operation Spell_Points_P6 Spell_Points -= miracleSp spellStats
execute if score Spell_Points_P6 Spell_Points >= miracleSp spellStats run execute if items entity @p[tag=p6,tag=protectorsruneO] container.* chiseled_tuff[minecraft:custom_name={"text":"Protector's Rune","bold":true,"color":"blue","italic":false}] run effect clear @a[tag=p6] water_breathing
...
execute if score spellpick6 drafts > Spell_Points_P6 Spell_Points run clear @a[tag=p6]
