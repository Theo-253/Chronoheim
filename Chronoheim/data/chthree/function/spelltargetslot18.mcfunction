...
execute if score spellnumber3 spells matches -3 if score slot18bleeding booleaneffects matches 0 run scoreboard players operation slot18 hp += cannibalize spellStats
execute if score spellnumber3 spells matches -3 if score slot18bleeding booleaneffects matches 0 run scoreboard players operation slot18 hp += spellbuffsp5 spells
execute if score spellnumber3 spells matches -3 run scoreboard players set attackIsOngoingGame3 booleans 0
execute if score spellnumber3 spells matches -3 run execute at @n[type=armor_stand,name=slot18] run particle dust{color:[0.639,0.008,0.008],scale:1} ~ ~1 ~ 0.9 0.9 0.9 0.1 400
execute if score spellnumber3 spells matches -3 run tellraw @a[tag=game3] ["",{"selector":"@p[tag=p5]"}," used Cannibalize to heal Slot 2!"]
execute if score spellnumber3 spells matches -3 run scoreboard players set spellbuffsp5 spells 0

#cannibalize
execute if score spellnumber3 spells matches 34 run scoreboard players operation slot18 hp -= cannibalize spellStats
execute if score spellnumber3 spells matches 34 run scoreboard players operation slot18bleeding booleaneffects += cannibalizeDuration spellStats
execute if score spellnumber3 spells matches 34 run function chthree:spellgivetargetsp6reverse
execute if score spellnumber3 spells matches 34 run execute at @n[type=armor_stand,name=slot18] run particle dust{color:[0.639,0.008,0.008],scale:1} ~ ~1 ~ 0.9 0.9 0.9 0.1 400
execute if score spellnumber3 spells matches 34 run tellraw @a[tag=game3] ["",{"selector":"@p[tag=p5]"}," used Cannibalize on Slot 2!"]
execute if score spellnumber3 spells matches 34 run scoreboard players set spellnumber3 spells -3

#Dark Ritual
execute if score spellnumber3 spells matches 40 run execute if score buffDurationSlot18 atkmodifiers < darkpowerDuration spellStats run scoreboard players operation buffDurationSlot18 atkmodifiers = darkpowerDuration spellStats
execute if score spellnumber3 spells matches 40 run scoreboard players operation attackBuffSlot18 atkmodifiers += darkpower spellStats
execute if score spellnumber3 spells matches 40 run scoreboard players operation attackBuffSlot18 atkmodifiers += darkritual player5spells
execute if score spellnumber3 spells matches 40 at @e[name=slot18] run particle minecraft:trial_omen ~ ~1 ~ 0.9 0.9 0.9 0.5 40
execute if score spellnumber3 spells matches 40 run scoreboard players set attackIsOngoingGame3 booleans 0
execute if score spellnumber3 spells matches 40 run tellraw @a[tag=game3] ["",{"selector":"@p[tag=p5]"}," used Dark Ritual on Slot 2!"]

#Monkey's Paw
execute if score spellnumber3 spells matches 43 run scoreboard players operation invincibleSlot18 booleaneffects = monkeyspaw spellStats
execute if score spellnumber3 spells matches 43 run scoreboard players operation savehp18 saves = slot18 hp
execute if score spellnumber3 spells matches 43 run scoreboard players set curse slot18 5
execute if score spellnumber3 spells matches 43 run scoreboard players set curseStacks slot18 0
execute if score spellnumber3 spells matches 43 run scoreboard players operation curseDuration slot18 = monkeyspaw spellStats
execute if score spellnumber3 spells matches 43 at @e[name=slot18] run particle minecraft:raid_omen ~ ~1 ~ 0.9 0.9 0.9 0.00000001 200
...
execute if score spellnumber3 spells matches 43 run tellraw @a[tag=game3] ["",{"selector":"@p[tag=p5]"}," used Monkey's Paw on Slot 2!"]

#Slimed!
execute if score spellnumber3 spells matches 35 if score ward slot18 matches 0 run scoreboard players operation disarmedslot18 booleaneffects += slimed spellStats
execute if score spellnumber3 spells matches 35 if score ward slot18 matches 1.. run function chthree:wardslot18
execute if score spellnumber3 spells matches 35 run function chthree:spellphasep5
execute if score spellnumber3 spells matches 35 run execute at @n[type=armor_stand,name=slot18] run particle minecraft:item_slime ~ ~1 ~ 0.7 0.7 0.7 0.3 150
execute if score spellnumber3 spells matches 35 run tellraw @a[tag=game3] ["",{"selector":"@p[tag=p6]"}," used Slimed! on Slot 2!"]

#Vampire Mark
execute if score spellnumber3 spells matches 36 run scoreboard players operation lifesteal slot18 = vampiremark spellStats
execute if score spellnumber3 spells matches 36 run execute at @n[type=armor_stand,name=slot18] run particle minecraft:crimson_spore ~ ~1 ~ 0.6 0.4 0.6 0 200
execute if score spellnumber3 spells matches 36 run tellraw @a[tag=game3] ["",{"selector":"@p[tag=p5]"}," used Vampire Mark on Slot 2!"]
...
execute if score spellnumber3 spells matches 37 run scoreboard players operation spellDmg saves += marks slot18
execute if score spellnumber3 spells matches 37 run scoreboard players operation spellDmg saves /= atkmultiplier slot18
execute if score spellnumber3 spells matches 37 run execute if score ward slot18 matches 0 run scoreboard players operation shield slot18 -= spellDmg saves
execute if score spellnumber3 spells matches 37 run execute if score ward slot18 matches 0 if score shield slot18 matches ..0 run scoreboard players operation slot18 hp += shield slot18
execute if score spellnumber3 spells matches 37 at @e[name=slot18] run particle minecraft:damage_indicator ~ ~1 ~ 0.6 0.6 0.6 0 100
execute if score spellnumber3 spells matches 37 run execute if score ward slot18 matches 1.. run function chthree:wardslot18
...
execute if score spellnumber3 spells matches 37 run tellraw @a[tag=game3] ["",{"selector":"@p[tag=p6]"}," used Butchering on Slot 2!"]

#Will O' Wisp
execute if score spellnumber3 spells matches 38 run execute if score ward slot18 matches 0 if score durationSlot18 burn < willowispDuration spellStats run scoreboard players operation durationSlot18 burn = willowispDuration spellStats
execute if score spellnumber3 spells matches 38 run execute if score ward slot18 matches 0 run scoreboard players operation slot18Burn burn += willowisp spellStats
execute if score spellnumber3 spells matches 38 run scoreboard players operation spellDmg saves = slot18Burn burn
execute if score spellnumber3 spells matches 38 run scoreboard players operation spellDmg saves += spellbuffsp5 spells
execute if score spellnumber3 spells matches 38 run scoreboard players operation spellDmg saves += marks slot18
execute if score spellnumber3 spells matches 38 run scoreboard players operation spellDmg saves /= atkmultiplier slot18
execute if score spellnumber3 spells matches 38 run execute if score ward slot18 matches 0 run scoreboard players operation shield slot18 -= spellDmg saves
execute if score spellnumber3 spells matches 38 run execute if score ward slot18 matches 0 if score shield slot18 matches ..0 run scoreboard players operation slot18 hp += shield slot18
execute if score spellnumber3 spells matches 38 at @e[name=slot18] run particle minecraft:glow ~ ~1 ~ 0.7 0.7 0.7 0.1 100
execute if score spellnumber3 spells matches 38 at @e[name=slot18] run particle minecraft:soul_fire_flame ~ ~1 ~ 0.6 0.6 0.6 0.1 100
execute if score spellnumber3 spells matches 38 run execute if score ward slot18 matches 1.. run function chthree:wardslot18
...
execute if score spellnumber3 spells matches 38 run tellraw @a[tag=game3] ["",{"selector":"@p[tag=p5]"}," used Will O' Wisp on Slot 2!"]

#Curse of Bats
execute if score spellnumber3 spells matches 42 if score ward slot18 matches ..0 unless score curse slot18 matches 5 unless score curse slot18 matches 6 run scoreboard players set curseStacks slot18 0
execute if score spellnumber3 spells matches 42 if score ward slot18 matches ..0 unless score curse slot18 matches 5 unless score curse slot18 matches 6 run scoreboard players set curseDuration slot18 -1
execute if score spellnumber3 spells matches 42 if score ward slot18 matches ..0 unless score curse slot18 matches 5 run scoreboard players set curse slot18 6
execute if score spellnumber3 spells matches 42 if score ward slot18 matches ..0 unless score curse slot18 matches 5 if score curse slot18 matches 6 run scoreboard players add curseStacks slot18 1
execute if score spellnumber3 spells matches 42 run execute at @n[name=slot18] run particle shriek{delay:0} ~ ~1 ~ 0.3 0.5 0.3 0.1 200 normal
execute if score spellnumber3 spells matches 42 run tellraw @a[tag=game3] ["",{"selector":"@p[tag=p5]"}," used Curse of Bats on Slot 2!"]
execute if score spellnumber3 spells matches 42 if score ward slot18 matches 1.. run function chthree:wardslot18
