...
execute if score spellnumber3 spells matches 26 run execute if score slot18 hp matches ..0 if score slot17 hp matches ..0 if score slot20 hp matches ..0 run scoreboard players operation shield slot19 += dragonforge spellStats
execute if score spellnumber3 spells matches 26 run scoreboard players set attackIsOngoingGame3 booleans 0
execute if score spellnumber3 spells matches 26 run execute if score slot18 hp matches ..0 if score slot17 hp matches ..0 if score slot20 hp matches ..0 run execute at @n[type=armor_stand,name=slot19] run particle dragon_breath ~ ~1 ~ 0.9 0.9 0.9 0.1 400
execute if score spellnumber3 spells matches 26 run execute at @n[type=armor_stand,name=slot19] run particle dragon_breath ~ ~1 ~ 0.9 0.9 0.9 0.1 100
execute if score spellnumber3 spells matches 26 run tellraw @a[tag=game3] ["",{"selector":"@p[tag=p5]"}," used Dragonforge on Slot 3!"]
...
execute if score spellnumber3 spells matches 13 run scoreboard players operation maxhp slot19 += embiggen spellStats
execute if score spellnumber3 spells matches 13 run scoreboard players operation slot19 hp += embiggen spellStats
...
execute if score spellnumber3 spells matches 13 run tellraw @a[tag=game3] ["",{"selector":"@p[tag=p5]"}," used Embiggen on Slot 3!"]
...
execute if score spellnumber3 spells matches 12 if score ward slot19 matches 1.. run function chthree:wardslot19
...
execute if score spellnumber3 spells matches 12 run tellraw @a[tag=game3] ["",{"selector":"@p[tag=p6]"}," used Embrittle on Slot 3!"]
#Evil Eye
execute if score spellnumber3 spells matches 15 if score ward slot19 matches 0 run execute if score durationSlot19 mark < evilEyeDuration spellStats run scoreboard players operation durationSlot19 mark = evilEyeDuration spellStats
...
execute if score spellnumber3 spells matches 15 if score ward slot19 matches 1.. run function chthree:wardslot19
...
execute if score spellnumber3 spells matches 15 run tellraw @a[tag=game3] ["",{"selector":"@p[tag=p6]"}," used Evil Eye on Slot 3!"]
...
execute if score spellnumber3 spells matches 6 run scoreboard players operation spellDmg3 saves += marks slot19
execute if score spellnumber3 spells matches 6 run scoreboard players operation spellDmg3 saves /= atkmultiplier slot19
execute if score spellnumber3 spells matches 6 run execute if score ward slot19 matches 0 run scoreboard players operation shield slot19 -= spellDmg3 saves
...
execute if score spellnumber3 spells matches 6 run execute if score ward slot19 matches 1.. run function chthree:wardslot19
...
execute if score spellnumber3 spells matches 6 run tellraw @a[tag=game3] ["",{"selector":"@p[tag=p6]"}," used Frostbolt on Slot 3!"]
...
execute if score spellnumber3 spells matches 2 unless score slot19bleeding booleaneffects matches 1.. run scoreboard players operation slot19 hp += spellHeal saves
execute if score spellnumber3 spells matches 2 run function chthree:cleanseslot19
...
execute if score spellnumber3 spells matches 4 at @e[name=slot19] run particle minecraft:enchanted_hit ~ ~1 ~ 0.9 0.9 0.9 0.5 300
execute if score spellnumber3 spells matches 4 at @e[name=slot18] run particle minecraft:enchanted_hit ~ ~1 ~ 0.9 0.9 0.9 0.5 150
execute if score spellnumber3 spells matches 4 at @e[name=slot20] run particle minecraft:enchanted_hit ~ ~1 ~ 0.9 0.9 0.9 0.5 150
...
execute if score spellnumber3 spells matches 4 run tellraw @a[tag=game1] ["",{"selector":"@p[tag=p6]"}," used Magic Missile on Slot 3!"]
...
execute if score spellnumber3 spells matches 16 if score protectorsrune spellStats > durationSlot19 taunt if score ward slot19 matches 1.. run function chthree:wardslot19
...
execute if score spellnumber3 spells matches 16 run tellraw @a[tag=game3] ["",{"selector":"@p[tag=p5]"}," used Protector's Rune on Slot 3!"]
...
execute if score spellnumber3 spells matches 8 run tellraw @a[tag=game3] ["",{"selector":"@p[tag=p5]"}," used Shield on Slot 3!"]
...
execute if score spellnumber3 spells matches 9 if score ward slot19 matches 1.. run function chthree:wardslot19
execute if score spellnumber3 spells matches 9 run function chthree:spellphasep5
execute if score spellnumber3 spells matches 9 run execute at @n[type=armor_stand,name=slot19] run particle flash{color:[1.000,1.000,1.000,1.00]} ~ ~1 ~ 0.9 0.9 0.9 0.1 10
execute if score spellnumber3 spells matches 9 run tellraw @a[tag=game3] ["",{"selector":"@p[tag=p6]"}," used Ball Lightning on Slot 3!"]
...
execute if score spellnumber3 spells matches 23 run execute if score ward slot19 matches 1.. run function chthree:wardslot19
execute if score spellnumber3 spells matches 23 run function chthree:spellphasep5
execute if score spellnumber3 spells matches 23 run tellraw @a[tag=game3] ["",{"selector":"@p[tag=p6]"}," used Witches Brew on Slot 3!"]
...
execute if score spellnumber3 spells matches -1 if score ward slot19 matches 1.. run function chthree:wardslot19
...
execute if score spellnumber3 spells matches -1 run tellraw @a[tag=game3] ["",{"selector":"@p[tag=p6]"}," used Shifting Shadows to fear Slot 3!"]
...
execute if score spellnumber3 spells matches 28 run tellraw @a[tag=game3] ["",{"selector":"@p[tag=p5]"}," used Shifting Shadows to make Slot 3 scary!"]
...
execute if score spellnumber3 spells matches 1 run scoreboard players operation spellDmg3 saves += marks slot19
execute if score spellnumber3 spells matches 1 run scoreboard players operation spellDmg3 saves /= atkmultiplier slot19
execute if score spellnumber3 spells matches 1 run execute if score ward slot19 matches 0 run scoreboard players operation shield slot19 -= spellDmg3 saves
...
execute if score spellnumber3 spells matches 1 run execute if score ward slot19 matches 1.. run function chthree:wardslot19
execute if score spellnumber3 spells matches 1 run scoreboard players set spellbuffsp6 spells 0
execute if score spellnumber3 spells matches 1 run function chthree:spellphasep5
execute if score spellnumber3 spells matches 1 run tellraw @a[tag=game3] ["",{"selector":"@p[tag=p6]"}," used Fireball on Slot 3!"]
#meteor
...
execute if score spellnumber3 spells matches 7 run tellraw @a[tag=game3] ["",{"selector":"@p[tag=p6]"}," used Meteor on Slot 3!"]
...
execute if score spellnumber3 spells matches 10 run scoreboard players operation spellDmg3 saves += marks slot19
execute if score spellnumber3 spells matches 10 run scoreboard players operation spellDmg3 saves /= atkmultiplier slot19
execute if score spellnumber3 spells matches 10 run execute if score ward slot19 matches 0 run scoreboard players operation shield slot19 -= spellDmg3 saves
...
execute if score spellnumber3 spells matches 10 run execute if score ward slot19 matches 1.. run function chthree:wardslot19
...
execute if score spellnumber3 spells matches 10 run tellraw @a[tag=game3] ["",{"selector":"@p[tag=p6]"}," used Witch Bolt on Slot 3!"]
#ward
...
execute if score spellnumber3 spells matches 19 run tellraw @a[tag=game3] ["",{"selector":"@p[tag=p5]"}," used Ward on Slot 3!"]
#plague
...
execute if score spellnumber3 spells matches 21 if score ward slot19 matches 1.. run function chthree:wardslot19
execute if score spellnumber3 spells matches 21 run function chthree:spellphasep5
execute if score spellnumber3 spells matches 21 run tellraw @a[tag=game3] ["",{"selector":"@p[tag=p6]"}," used Plague on Slot 3!"]
...
execute if score spellnumber3 spells matches 22 run tellraw @a[tag=game3] ["",{"selector":"@p[tag=p5]"}," used Second Wind on Slot 3!"]
#fountain of youth
...
execute if score spellnumber3 spells matches 25 run tellraw @a[tag=game3] ["",{"selector":"@p[tag=p5]"}," used Fountain of Youth on Slot 3!"]
#overclock
...
execute if score spellnumber3 spells matches 27 run tellraw @a[tag=game3] ["",{"selector":"@p[tag=p5]"}," used Overclock on Slot 3!"]

#Life Leech Token

execute if score spellnumber3 spells matches -2 if score slot19bleeding booleaneffects matches 0 run scoreboard players operation slot19 hp += lifeLeechHeal spellStats
execute if score spellnumber3 spells matches -2 if score slot19bleeding booleaneffects matches 0 run scoreboard players operation slot19 hp += spellbuffsp5 spells
execute if score spellnumber3 spells matches -2 run scoreboard players set attackIsOngoingGame3 booleans 0
execute if score spellnumber3 spells matches -2 run execute at @n[type=armor_stand,name=slot19] run particle dust{color:[0.639,0.008,0.008],scale:1} ~ ~1 ~ 0.9 0.9 0.9 0.1 400
execute if score spellnumber3 spells matches -2 run tellraw @a[tag=game3] ["",{"selector":"@p[tag=p5]"}," used Life Leech to heal Slot 3!"]
execute if score spellnumber3 spells matches -2 run scoreboard players set spellbuffsp5 spells 0
...
execute if score spellnumber3 spells matches 31 run scoreboard players operation spellDmg saves += marks slot19
execute if score spellnumber3 spells matches 31 run scoreboard players operation spellDmg saves /= atkmultiplier slot19
execute if score spellnumber3 spells matches 31 run execute if score ward slot19 matches 0 run scoreboard players operation shield slot19 -= spellDmg saves
execute if score spellnumber3 spells matches 31 run execute if score ward slot19 matches 0 if score shield slot19 matches ..0 run scoreboard players operation slot19 hp += shield slot19
execute if score spellnumber3 spells matches 31 run execute if score ward slot19 matches 1.. run function chthree:wardslot19
execute if score spellnumber3 spells matches 31 run function chthree:spellgivetargetsp5reverse
execute if score spellnumber3 spells matches 31 run execute at @n[type=armor_stand,name=slot19] run particle dust{color:[0.639,0.008,0.008],scale:1} ~ ~1 ~ 0.9 0.9 0.9 0.1 400
execute if score spellnumber3 spells matches 31 run tellraw @a[tag=game3] ["",{"selector":"@p[tag=p6]"}," used Life Leech on Slot 3!"]
...
execute if score spellnumber3 spells matches 32 run scoreboard players operation spellDmg saves += marks slot19
execute if score spellnumber3 spells matches 32 run scoreboard players operation spellDmg saves /= atkmultiplier slot19
execute if score spellnumber3 spells matches 32 run execute if score ward slot19 matches 0 if score character# slot19 matches ..-1 run scoreboard players operation shield slot19 -= spellDmg saves
execute if score spellnumber3 spells matches 32 run execute if score ward slot19 matches 0 if score character# slot19 matches ..-1 if score shield slot19 matches ..0 run scoreboard players operation slot19 hp += shield slot19
execute if score spellnumber3 spells matches 32 run execute if score ward slot19 matches 1.. if score character# slot19 matches ..-1 run function chthree:wardslot19
execute if score spellnumber3 spells matches 32 run execute at @n[type=armor_stand,name=slot19] run particle block{block_state:"minecraft:dripstone_block"} ~ ~ ~ 0.9 2 0.9 1 250 normal
execute if score spellnumber3 spells matches 32 run tellraw @a[tag=game3] ["",{"selector":"@p[tag=p6]"}," used Decimate on Slot 3!"]
...
execute if score spellnumber3 spells matches 40 run scoreboard players operation attackBuffSlot19 atkmodifiers += darkritual player5spells
