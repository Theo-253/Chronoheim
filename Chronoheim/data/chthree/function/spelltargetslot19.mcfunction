...
execute if score spellnumber3 spells matches 4 run scoreboard players operation spellDmg3 saves += marks slot19
execute if score spellnumber3 spells matches 4 run scoreboard players operation spellDmg3 saves /= atkmultiplier slot19
execute if score spellnumber3 spells matches 4 run execute if score ward slot19 matches 0 run scoreboard players operation shield slot19 -= spellDmg3 saves
...
execute if score spellnumber3 spells matches 4 run tellraw @a[tag=game3] ["",{"selector":"@p[tag=p6]"}," smited Slot 3 with Magic Missle!"]
