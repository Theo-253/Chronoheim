...
#Miracle
execute if score spellnumber spells matches 17 run function chthree:cleanseslot20
execute if score spellnumber spells matches 17 run scoreboard players set attackIsOngoingGame3 booleans 0
execute if score spellnumber spells matches 17 run tellraw @a[tag=game3] ["",{"selector":"@p[tag=p5]"}," used Miracle on Slot 4!"]
