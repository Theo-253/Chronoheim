...
execute if score spellnumber3 spells matches 26 run execute if score alivep6 deaths matches 1 run scoreboard players operation shield slot22 += dragonforge spellStats
...
execute if score spellnumber3 spells matches 2 run scoreboard players operation slot22 hp += spellHeal saves
