...
execute if score spellnumber3 spells matches 4 at @e[name=slot22] run particle minecraft:enchanted_hit ~ ~1 ~ 0.9 0.9 0.9 0.5 300
execute if score spellnumber3 spells matches 4 at @e[name=slot21] run particle minecraft:enchanted_hit ~ ~1 ~ 0.9 0.9 0.9 0.5 150
...
execute if score spellnumber3 spells matches 4 run tellraw @a[tag=game1] ["",{"selector":"@p[tag=p5]"}," used Magic Missile on Slot 6!"]
