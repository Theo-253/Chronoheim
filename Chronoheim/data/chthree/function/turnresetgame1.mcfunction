execute if score attackIsOngoingGame2 booleans matches 0 run execute if score speed slot24 matches ..-10000 if score speed slot23 matches ..-10000 if score speed slot23 matches ..-10000 run execute if score speed slot21 matches ..-10000 run execute if score speed slot20 matches ..-10000 run execute if score speed slot19 matches ..-10000 run execute if score speed slot18 matches ..-10000 run execute if score speed slot17 matches ..-10000 run scoreboard players set attackIsOngoingGame2 booleans 1
#Slot 17 Speed Reset
...
execute if score slot20 hp matches 1.. run execute if score character# slot20 matches -3 run scoreboard players operation speed slot20 = healingTotemSpeed spellStats
...
execute if score slot24 hp matches 1.. run execute if score character# slot24 matches -3 run scoreboard players operation speed slot24 = healingTotemSpeed spellStats
...
execute if score slot24 hp matches 1.. run execute if score character# slot24 matches -5 run scoreboard players operation speed slot24 = skeletonplus herospeed
...
execute if score suddenDeath2 deaths matches 20 run title @a[tag=game3] actionbar "Sudden Death is now active! Healing and Shields are disabled."
