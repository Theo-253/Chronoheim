...
scoreboard players set slot20 hp 1
scoreboard players set slot21 hp 1
scoreboard players set slot22 hp 1
scoreboard players set slot23 hp 1
scoreboard players set slot24 hp 1
...
tag @a[tag=game3] remove cannibalize
tag @a[tag=game3] remove slimed
tag @a[tag=game3] remove vampiremark
tag @a[tag=game3] remove willowisp
tag @a[tag=game3] remove butchering
tag @a[tag=game3] remove spiderward
tag @a[tag=game3] remove darkritual
tag @a[tag=game3] remove raisedead
tag @a[tag=game3] remove monkeyspaw
tag @a[tag=game3] remove curseofbats
tag @a remove p5
tag @a remove p6
tag @a remove game3
...
scoreboard players set decimateCooldown player5spells 0
scoreboard players set lifeLeechCooldown player5spells 0
scoreboard players set healingRainCooldown player5spells 0
scoreboard players set decimateCooldown player6spells 0
scoreboard players set lifeLeechCooldown player6spells 0
scoreboard players set healingRainCooldown player6spells 0
scoreboard players set butcheringCooldown player5spells 0
scoreboard players set butcheringCooldown player6spells 0
scoreboard players set cannibalizeCooldown player5spells 0
scoreboard players set cannibalizeCooldown player6spells 0
scoreboard players set curseOfBatsCooldown player5spells 0
scoreboard players set curseOfBatsCooldown player6spells 0
scoreboard players set darkRitualCooldown player5spells 0
scoreboard players set darkRitualCooldown player6spells 0
scoreboard players set monkeysPawCooldown player5spells 0
scoreboard players set monkeysPawCooldown player6spells 0
scoreboard players set raiseDeadCooldown player5spells 0
scoreboard players set raiseDeadCooldown player6spells 0
scoreboard players set vampireMarkCooldown player5spells 0
scoreboard players set vampireMarkCooldown player6spells 0
scoreboard players set slimedCooldown player5spells 0
scoreboard players set slimedCooldown player6spells 0
scoreboard players set willOWispCooldown player5spells 0
scoreboard players set willOWispCooldown player6spells 0
scoreboard players set spiderWardCooldown player5spells 0
scoreboard players set spiderWardCooldown player6spells 0
...
scoreboard players set maxhp slot17 9999
scoreboard players set maxhp slot18 9999
scoreboard players set maxhp slot19 9999
scoreboard players set maxhp slot20 9999
scoreboard players set maxhp slot21 9999
scoreboard players set maxhp slot22 9999
scoreboard players set maxhp slot23 9999
scoreboard players set maxhp slot24 9999

scoreboard players set darkritual player5spells 0
