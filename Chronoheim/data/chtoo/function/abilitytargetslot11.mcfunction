...
#Doc Basic Attack
execute if score abilitynumber abilities matches -1 if score ward slot11 matches 0 run scoreboard players operation slot11Disease disease += doc heroattack
execute if score abilitynumber abilities matches -1 if score ward slot11 matches 0 if score slot14isatk booleans matches 1 run scoreboard players operation slot11Disease disease += docLeader heroattack
execute if score abilitynumber abilities matches -1 run execute if score ward slot11 matches 1.. run function chtoo:wardslot11
execute if score abilitynumber abilities matches -1 at @e[name=slot11] run particle minecraft:trial_omen ~ ~1 ~ 0.9 0.9 0.9 0.1 50

#Subject ability
execute if score abilitynumber abilities matches 4 if score ward slot11 matches 0 run scoreboard players operation slot11Poison poison += subject abilityStats
execute if score abilitynumber abilities matches 4 if score ward slot11 matches 0 if score slot14isatk booleans matches 1 run scoreboard players operation slot11Poison poison += subjectLeader abilityStats
execute if score abilitynumber abilities matches 4 at @e[name=slot11] run particle minecraft:trial_omen ~ ~1 ~ 0.9 0.9 0.9 0.1 50
execute if score abilitynumber abilities matches 4 run execute if score ward slot11 matches 1.. run function chtoo:wardslot11
execute if score abilitynumber abilities matches 4 run tellraw @a[tag=game2] ["",{"selector":"@p[tag=p4]"}," used Contagion on Slot 3!"]
...
execute if score abilitynumber2 abilities matches 3 run scoreboard players operation abilityDmg2 saves /= atkmultiplier slot11
execute if score abilitynumber2 abilities matches 3 run execute if score ward slot11 matches 0 run scoreboard players operation shield slot11 -= abilityDmg2 saves
execute if score abilitynumber2 abilities matches 3 run execute if score ward slot11 matches 0 if score slot14isatk booleans matches 1 if score durationSlot14-11 fear <= eidolonLeaderFearDuration abilityStats run scoreboard players operation durationSlot14-11 fear = eidolonLeaderFearDuration abilityStats
execute if score abilitynumber2 abilities matches 3 run execute if score ward slot11 matches 0 if score shield slot11 matches ..0 run scoreboard players operation slot11 hp += shield slot11
execute if score abilitynumber2 abilities matches 3 run execute if score ward slot11 matches 1.. run function chtoo:wardslot11
execute if score abilitynumber2 abilities matches 3 run execute at @e[name=slot11,type=armor_stand] run particle raid_omen ~ ~1 ~ 0.3 0.3 0.3 2 100
