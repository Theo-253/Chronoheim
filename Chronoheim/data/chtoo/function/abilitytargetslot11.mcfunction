...
clear @p[tag=game2]
#Arthur Ability
execute if score abilitynumber abilities matches 2 run function chtoo:cleanseslot11
#Deuce ability
...
execute if score abilitynumber2 abilities matches -2 if score character# slot10 matches 27 run function chtoo:cleanseslot11
