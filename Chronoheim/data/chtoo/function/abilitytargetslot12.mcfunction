...
execute if score abilitynumber2 abilities matches 12 run execute if score character# slot14 matches 12 run scoreboard players operation cooldown slot12 = aceSetCooldownLeader abilityStats
...
execute if score abilitynumber2 abilities matches 43 run tellraw @a[tag=game2] ["",{"selector":"@p[tag=p4]"}," used Piercing Pestilence on Slot 4!"]
execute if score abilitynumber2 abilities matches 43 run execute if score ward slot12 matches 0 if score shield slot12 matches ..0 run scoreboard players operation slot12 hp += shield slot12
execute if score abilitynumber2 abilities matches -43 run execute if score ward slot12 matches 0 if score shield slot12 matches ..0 run scoreboard players operation slot12 hp += shield slot12
#Frank
...
execute if score abilitynumber2 abilities matches 42 if score ward slot12 matches 0 run scoreboard players operation abilityDmg2 saves *= anubisUnusedP4 saves
