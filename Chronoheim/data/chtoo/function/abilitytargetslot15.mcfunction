...
execute if score abilitynumber2 abilities matches 12 run execute if score character# slot10 matches 12 run scoreboard players operation cooldown slot15 = aceSetCooldownLeader abilityStats
...
execute if score abilitynumber2 abilities matches 43 run tellraw @a[tag=game2] ["",{"selector":"@p[tag=p3]"}," used Piercing Pestilence on Slot 7!"]
execute if score abilitynumber2 abilities matches 43 run execute if score ward slot15 matches 0 if score shield slot15 matches ..0 run scoreboard players operation slot15 hp += shield slot15
execute if score abilitynumber2 abilities matches -43 run execute if score ward slot15 matches 0 if score shield slot15 matches ..0 run scoreboard players operation slot15 hp += shield slot15
#Frank
...
execute if score abilitynumber2 abilities matches 42 if score ward slot15 matches 0 run scoreboard players operation abilityDmg2 saves *= anubisUnusedP3 saves
