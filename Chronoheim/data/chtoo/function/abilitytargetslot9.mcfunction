...
#Subject ability
execute if score abilitynumber2 abilities matches 4 if score ward slot19 matches 0 run scoreboard players operation slot9Poison poison += subject abilityStats
execute if score abilitynumber2 abilities matches 4 if score ward slot19 matches 0 if score slot14isatk booleans matches 1 run scoreboard players operation slot9Poison poison += subjectLeader abilityStats
