...
execute if score abilitynumber2 abilities matches 28 run tellraw @a[tag=game2] ["",{"selector":"@p[tag=p4]"}," used Double Punch on Slot 1!"]
...
#Robyn Ability
execute if score abilitynumber2 abilities matches 9 if score ward slot9 matches 0 if score durationSlot9 mark < robynDuration abilityStats run scoreboard players operation durationSlot9 mark = robynDuration abilityStats
...
execute if score abilitynumber2 abilities matches 22 at @e[name=slot9] run particle minecraft:flash{color:[1.000,1.000,1.000,1.00]} ~ ~1 ~ 0.9 0.9 0.9 0.5 100
...
#Scythe
execute if score abilitynumber2 abilities matches 32 if score ward slot9 matches 0 run scoreboard players operation slot9 hp /= scytheDivide abilityStats
execute if score abilitynumber2 abilities matches 32 if score ward slot9 matches 0 run scoreboard players operation slot9 hp *= scytheMult abilityStats
execute if score abilitynumber2 abilities matches 32 if score ward slot9 matches 0 if score slot14isatk booleans matches 1 if score durationSlot9 mark < scytheDuration abilityStats run scoreboard players operation durationSlot9 mark = scytheDuration abilityStats
execute if score abilitynumber2 abilities matches 32 if score ward slot9 matches 0 if score slot14isatk booleans matches 1 run scoreboard players operation marks slot9 += scytheLeader abilityStats
execute if score abilitynumber2 abilities matches 32 if score ward slot9 matches 1.. run function chtoo:wardslot9
execute if score abilitynumber2 abilities matches 32 at @e[name=slot9] run particle minecraft:sculk_soul ~ ~1 ~ 0.9 0.9 0.9 0.1 100
execute if score abilitynumber2 abilities matches 32 run tellraw @a[tag=game2] ["",{"selector":"@p[tag=p4]"}," used Cull the Weak on Slot 1!"]

#Doc Basic Attack
execute if score abilitynumber2 abilities matches -1 if score ward slot9 matches 0 run scoreboard players operation slot9Disease disease += doc heroattack
execute if score abilitynumber2 abilities matches -1 if score ward slot9 matches 0 if score slot14isatk booleans matches 1 run scoreboard players operation slot9Disease disease += docLeader heroattack
execute if score abilitynumber2 abilities matches -1 run execute if score ward slot9 matches 1.. run function chtoo:wardslot9
...
#Subject ability
execute if score abilitynumber2 abilities matches 4 if score ward slot9 matches 0 if score durationSlot9 poison < subjectDuration abilityStats run scoreboard players operation durationSlot9 poison = subjectDuration abilityStats
execute if score abilitynumber2 abilities matches 4 if score ward slot9 matches 0 run scoreboard players operation slot9Poison poison += subject abilityStats
execute if score abilitynumber2 abilities matches 4 if score ward slot9 matches 0 if score slot14isatk booleans matches 1 run scoreboard players operation slot9Poison poison += subjectLeader abilityStats
execute if score abilitynumber2 abilities matches 4 at @e[name=slot9] run particle minecraft:trial_omen ~ ~1 ~ 0.9 0.9 0.9 0.1 50
...
execute if score abilitynumber2 abilities matches 4 run tellraw @a[tag=game2] ["",{"selector":"@p[tag=p4]"}," used Contagion on Slot 1!"]
...
execute if score abilitynumber2 abilities matches 31 run scoreboard players operation abilityDmg2 saves += marks slot9
execute if score abilitynumber2 abilities matches 31 run scoreboard players operation abilityDmg2 saves /= atkmultiplier slot9
execute if score abilitynumber2 abilities matches 31 run execute if score ward slot9 matches 0 run scoreboard players operation shield slot9 -= abilityDmg2 saves
execute if score abilitynumber2 abilities matches 31 run execute if score ward slot9 matches 0 if score shield slot9 matches ..0 run scoreboard players operation slot9 hp += shield slot9
execute if score abilitynumber2 abilities matches 31 run execute if score ward slot9 matches 0 run scoreboard players operation disarmedslot9 booleaneffects = jones abilityStats
execute if score abilitynumber2 abilities matches 31 run execute if score ward slot9 matches 1 run function chtoo:wardslot9
execute if score abilitynumber2 abilities matches 31 run tellraw @a[tag=game2] ["",{"selector":"@p[tag=p4]"}," used Lasso on Slot 1!"]
execute if score abilitynumber2 abilities matches 31 at @e[name=slot9] run particle minecraft:crit ~ ~1 ~ 0.9 0.9 0.9 0.1 100

#Sherman Basic
execute if score abilitynumber2 abilities matches -5 run execute unless score slot9bleeding booleaneffects matches 1.. run scoreboard players operation slot9 hp += sherman heroattack
execute if score abilitynumber2 abilities matches -5 run tellraw @a[tag=game2] ["",{"selector":"@p[tag=p3]"}," healed Slot 1!"]
execute if score abilitynumber2 abilities matches -5 run execute at @n[type=armor_stand,name=slot9] run particle minecraft:composter ~ ~1 ~ 0.9 0.9 0.9 0.5 80

#Sherman Ability
execute if score abilitynumber2 abilities matches 33 run execute if score ward slot9 matches 0 if score debuffDurationSlot9 atkmodifiers < shermanDuration abilityStats run scoreboard players operation debuffDurationSlot9 atkmodifiers = shermanDuration abilityStats
execute if score abilitynumber2 abilities matches 33 run execute if score ward slot9 matches 0 run scoreboard players operation attackDebuffSlot9 atkmodifiers += shermanDebuff abilityStats
...
execute if score abilitynumber2 abilities matches 33 at @e[name=slot9] run particle minecraft:pale_oak_leaves ~ ~1 ~ 0.9 0.9 0.9 0.1 100
execute if score abilitynumber2 abilities matches 33 at @e[name=slot9] run particle minecraft:explosion ~ ~1 ~ 0.9 0.9 0.9 0.1 10
...
execute if score abilitynumber2 abilities matches 33 run tellraw @a[tag=game2] ["",{"selector":"@p[tag=p4]"}," used Grasping Roots on Slot 1!"]
execute if score abilitynumber2 abilities matches 33 run scoreboard players operation abilityDmg saves = sherman abilityStats
execute if score abilitynumber2 abilities matches 33 if score slot13isatk booleans matches 1 run scoreboard players operation abilityDmg saves += slot13 atkmodifiers
execute if score abilitynumber2 abilities matches 33 if score slot14isatk booleans matches 1 run scoreboard players operation abilityDmg saves += slot14 atkmodifiers
execute if score abilitynumber2 abilities matches 33 if score slot15isatk booleans matches 1 run scoreboard players operation abilityDmg saves += slot15 atkmodifiers
...
execute if score abilitynumber2 abilities matches 28 run scoreboard players operation abilityDmg2 saves += marks slot9
execute if score abilitynumber2 abilities matches 28 run scoreboard players operation abilityDmg2 saves /= atkmultiplier slot9
execute if score abilitynumber2 abilities matches 28 run execute if score ward slot9 matches 0 run scoreboard players operation shield slot9 -= abilityDmg2 saves
execute if score abilitynumber2 abilities matches 28 run execute if score ward slot9 matches 0 if score slot14isatk booleans matches 1 if score durationSlot14-9 fear <= eidolonLeaderFearDuration abilityStats run scoreboard players operation durationSlot14-9 fear = eidolonLeaderFearDuration abilityStats
execute if score abilitynumber2 abilities matches 28 run execute if score ward slot9 matches 0 if score shield slot9 matches ..0 run scoreboard players operation slot9 hp += shield slot9
execute if score abilitynumber2 abilities matches 28 run execute if score ward slot9 matches 1.. run function chtoo:wardslot9
execute if score abilitynumber2 abilities matches 28 run execute at @e[name=slot9,type=armor_stand] run particle raid_omen ~ ~1 ~ 0.3 0.3 0.3 2 100

#Barley
execute if score abilitynumber2 abilities matches -36 if score barleyPart1 abilities matches 5 if score ward slot9 matches ..0 run scoreboard players operation durationSlot13-9 fear = barleyDuration abilityStats 
execute if score abilitynumber2 abilities matches -36 if score barleyPart1 abilities matches 6 if score ward slot9 matches ..0 run scoreboard players operation durationSlot14-9 fear = barleyDuration abilityStats 
execute if score abilitynumber2 abilities matches -36 if score barleyPart1 abilities matches 7 if score ward slot9 matches ..0 run scoreboard players operation durationSlot15-9 fear = barleyDuration abilityStats 
execute if score abilitynumber2 abilities matches -36 if score barleyPart1 abilities matches 8 if score ward slot9 matches ..0 run scoreboard players operation durationSlot16-9 fear = barleyDuration abilityStats 
execute if score abilitynumber2 abilities matches -36 if score ward slot9 matches ..0 if score debuffDurationSlot9 atkmodifiers < barleyDuration abilityStats run scoreboard players operation debuffDurationSlot9 atkmodifiers = barleyDuration abilityStats
execute if score abilitynumber2 abilities matches -36 if score ward slot9 matches ..0 run scoreboard players operation attackDebuffSlot9 atkmodifiers += barley abilityStats
execute if score abilitynumber2 abilities matches -36 if score ward slot9 matches 1.. run function chtoo:wardslot9
execute if score abilitynumber2 abilities matches -36 run execute at @n[type=armor_stand,name=slot9] run particle trial_omen ~ ~1 ~ 0.9 0.9 0.9 0.1 400
execute if score abilitynumber2 abilities matches -36 run tellraw @a[tag=game2] ["",{"selector":"@p[tag=p4]"}," used Spookcrow to fear Slot 1!"]

execute if score abilitynumber2 abilities matches 36 run scoreboard players set barleyPart1 abilities 1
execute if score abilitynumber2 abilities matches 36 if score buffDurationSlot9 atkmodifiers < barleyDuration abilityStats run scoreboard players operation buffDurationSlot9 atkmodifiers = barleyDuration abilityStats
execute if score abilitynumber2 abilities matches 36 run scoreboard players operation attackBuffSlot9 atkmodifiers += barley abilityStats
execute if score abilitynumber2 abilities matches 36 run function chtoo:abilitygivetargetsp3
execute if score abilitynumber2 abilities matches 36 run execute at @n[type=armor_stand,name=slot9] run particle raid_omen ~ ~1 ~ 0.9 0.9 0.9 0.1 400
execute if score abilitynumber2 abilities matches 36 run tellraw @a[tag=game2] ["",{"selector":"@p[tag=p3]"}," used Spookcrow to make Slot 1 scary!"]

#Igor
execute if score abilitynumber2 abilities matches 38 if score cooldown slot9 matches 1.. run scoreboard players operation cooldown slot9 -= igor abilityStats
execute if score abilitynumber2 abilities matches 38 run execute at @e[type=armor_stand,name=slot9] run particle witch ~ ~1 ~ 0.5 0.8 0.5 0.1 100
execute if score abilitynumber2 abilities matches 38 run execute if score durationSlot9 speedBuffs < igorDuration abilityStats run scoreboard players operation durationSlot9 speedBuffs = igorDuration abilityStats
execute if score abilitynumber2 abilities matches 38 run scoreboard players operation speed slot9 += igorSpBuff abilityStats
execute if score abilitynumber2 abilities matches 38 run scoreboard players operation speedBuffSlot9 speedBuffs += igorSpBuff abilityStats
execute if score abilitynumber2 abilities matches 38 run tellraw @a[tag=game2] ["",{"selector":"@p[tag=p3]"}," used Black Lagoon Brew on Slot 1!"]
execute if score abilitynumber2 abilities matches 38 if score slot10isatk booleans matches 1 run execute if score invincibleSlot9 booleaneffects < igorDuration abilityStats run scoreboard players operation invincibleSlot9 booleaneffects = igorDuration abilityStats
execute if score abilitynumber2 abilities matches 38 if score slot10isatk booleans matches 1 run scoreboard players operation savehp9 saves = slot9 hp

#Zeebo
execute if score abilitynumber2 abilities matches 40 if score ward slot9 matches ..0 unless score curse slot9 matches 5 unless score curse slot9 matches 2 run scoreboard players set curseStacks slot9 0
execute if score abilitynumber2 abilities matches 40 if score ward slot9 matches ..0 unless score curse slot9 matches 5 unless score curse slot9 matches 2 run scoreboard players set curseDuration slot9 0
execute if score abilitynumber2 abilities matches 40 if score ward slot9 matches ..0 unless score curse slot9 matches 5 run scoreboard players set curse slot9 2
execute if score abilitynumber2 abilities matches 40 if score ward slot9 matches ..0 unless score curse slot9 matches 5 if score curse slot9 matches 2 run scoreboard players add curseStacks slot9 1
execute if score abilitynumber2 abilities matches 40 if score ward slot9 matches ..0 run execute if score durationSlot9 burn < zeeboDuration abilityStats run scoreboard players operation durationSlot9 burn = zeeboDuration abilityStats
execute if score abilitynumber2 abilities matches 40 if score ward slot9 matches ..0 run scoreboard players operation slot9Burn burn += zeeboBurn abilityStats
execute if score abilitynumber2 abilities matches 40 run execute at @e[type=armor_stand,name=slot9] run summon firework_rocket ~ ~2 ~ {LifeTime:1,FireworksItem:{id:"minecraft:firework_rocket",count:1,components:{"minecraft:fireworks":{explosions:[{shape:"burst",has_twinkle:true,has_trail:true,colors:[I;13894251,16746496,16770560],fade_colors:[I;10224278]}]}}}}
execute if score abilitynumber2 abilities matches 40 run execute at @e[type=armor_stand,name=slot9] run summon firework_rocket ~ ~2 ~ {LifeTime:1,FireworksItem:{id:"minecraft:firework_rocket",count:1,components:{"minecraft:fireworks":{explosions:[{shape:"burst",has_twinkle:true,has_trail:true,colors:[I;13894251,16746496,16770560],fade_colors:[I;10224278]}]}}}}
execute if score abilitynumber2 abilities matches 40 run tellraw @a[tag=game2] ["",{"selector":"@p[tag=p4]"}," used Last Laugh on Slot 1!"]
execute if score abilitynumber2 abilities matches 40 if score ward slot9 matches 1.. run function chtoo:wardslot9

#Fenrir
execute if score abilitynumber2 abilities matches 41 if score ward slot9 matches ..0 unless score curse slot9 matches 5 unless score curse slot9 matches 3 run scoreboard players set curseStacks slot9 0
execute if score abilitynumber2 abilities matches 41 if score ward slot9 matches ..0 unless score curse slot9 matches 5 unless score curse slot9 matches 3 run scoreboard players set curseDuration slot9 -1
execute if score abilitynumber2 abilities matches 41 if score ward slot9 matches ..0 unless score character# slot9 matches 41 unless score curse slot9 matches 5 run scoreboard players set curse slot9 3
...
execute if score abilitynumber2 abilities matches 41 run scoreboard players operation abilityDmg2 saves += marks slot9
execute if score abilitynumber2 abilities matches 41 run scoreboard players operation abilityDmg2 saves /= atkmultiplier slot9
execute if score abilitynumber2 abilities matches 41 run execute if score ward slot9 matches ..0 run scoreboard players operation shield slot9 -= abilityDmg2 saves
execute if score abilitynumber2 abilities matches 41 run execute at @n[type=armor_stand,name=slot9] run particle enchanted_hit ~ ~1 ~ 0.9 0.9 0.9 0.1 400
execute if score abilitynumber2 abilities matches 41 run tellraw @a[tag=game2] ["",{"selector":"@p[tag=p4]"}," used Mark of the Wolf on Slot 1!"]
execute if score abilitynumber2 abilities matches 41 run execute if score ward slot9 matches 0 if score shield slot9 matches ..0 run scoreboard players operation slot9 hp += shield slot9
execute if score abilitynumber2 abilities matches 41 if score ward slot9 matches 1.. run function chtoo:wardslot9
...
execute if score abilitynumber2 abilities matches 43 run scoreboard players operation abilityDmg2 saves += marks slot9
execute if score abilitynumber2 abilities matches 43 run scoreboard players operation abilityDmg2 saves /= atkmultiplier slot9
execute if score abilitynumber2 abilities matches 43 run execute if score ward slot9 matches ..0 run scoreboard players operation shield slot9 -= abilityDmg2 saves
execute if score abilitynumber2 abilities matches 43 run execute if score ward slot9 matches ..0 run scoreboard players operation slot9Disease disease += grendelDisease abilityStats
execute if score abilitynumber2 abilities matches 43 run execute at @e[type=armor_stand,name=slot9] run particle minecraft:noxious_gas ~ ~1 ~ 0.7 0.7 0.7 0.05 200
execute if score abilitynumber2 abilities matches 43 if score ward slot9 matches 1.. run function chtoo:wardslot9
...
execute if score abilitynumber2 abilities matches -43 run execute at @e[type=armor_stand,name=slot9] run particle minecraft:noxious_gas ~ ~1 ~ 0.7 0.7 0.7 0.05 200
execute if score abilitynumber2 abilities matches -43 if score ward slot9 matches 1.. run function chtoo:wardslot9
execute if score abilitynumber2 abilities matches -43 run tellraw @a[tag=game2] ["",{"selector":"@p[tag=p4]"}," used Piercing Pestilence on Slot 1!"]
execute if score abilitynumber2 abilities matches 43 run tellraw @a[tag=game2] ["",{"selector":"@p[tag=p4]"}," used Piercing Pestilence on Slot 1!"]
execute if score abilitynumber2 abilities matches 43 run execute if score ward slot9 matches 0 if score shield slot9 matches ..0 run scoreboard players operation slot9 hp += shield slot9
execute if score abilitynumber2 abilities matches -43 run execute if score ward slot9 matches 0 if score shield slot9 matches ..0 run scoreboard players operation slot9 hp += shield slot9
...
execute if score abilitynumber2 abilities matches 34 run scoreboard players operation shield slot9 -= abilityDmg2 saves
execute if score abilitynumber2 abilities matches 34 run scoreboard players operation slot9 hp += shield slot9
execute if score abilitynumber2 abilities matches 34 run execute at @e[name=slot9,type=armor_stand] run particle minecraft:angry_villager ~ ~1 ~ 0.9 0.9 0.9 0.5 15
execute if score abilitynumber2 abilities matches 34 run tellraw @a[tag=game2] ["",{"selector":"@p[tag=p3]"}," used IT'S ALIVE! to damage Slot 1!"]
execute if score abilitynumber2 abilities matches 34 run function chtoo:abilitygivetargetsp3
execute if score abilitynumber2 abilities matches -34 run execute if score ward slot9 matches 0 run scoreboard players operation slot9 stun = frankDuration abilityStats
execute if score abilitynumber2 abilities matches -34 run execute if score ward slot9 matches 1.. run function chtoo:wardslot9
execute if score abilitynumber2 abilities matches -34 run execute at @e[name=slot9,type=armor_stand] run particle minecraft:flash{color:[1.000,1.000,1.000,1.00]} ~ ~1 ~ 0.9 0.9 0.9 0.5 100
execute if score abilitynumber2 abilities matches -34 run tellraw @a[tag=game2] ["",{"selector":"@p[tag=p4]"}," used IT'S ALIVE! to stun Slot 1!"]
...
execute if score abilitynumber2 abilities matches 35 if score slot13isatk booleans matches 1 run scoreboard players operation abilityDmg2 saves += slot9 atkmodifiers
execute if score abilitynumber2 abilities matches 35 if score slot14isatk booleans matches 1 run scoreboard players operation abilityDmg2 saves += slot10 atkmodifiers
execute if score abilitynumber2 abilities matches 35 if score slot15isatk booleans matches 1 run scoreboard players operation abilityDmg2 saves += slot11 atkmodifiers
execute if score abilitynumber2 abilities matches 35 run scoreboard players operation abilityDmg2 saves += marks slot9
execute if score abilitynumber2 abilities matches 35 run scoreboard players operation abilityDmg2 saves /= atkmultiplier slot9
execute if score abilitynumber2 abilities matches 35 run execute if score ward slot9 matches 0 run scoreboard players operation shield slot9 -= abilityDmg2 saves
execute if score abilitynumber2 abilities matches 35 run execute if score ward slot9 matches 0 if score shield slot9 matches ..0 run scoreboard players operation slot9 hp += shield slot9
execute if score abilitynumber2 abilities matches 35 run execute if score ward slot9 matches 1.. run function chtoo:wardslot9
execute if score abilitynumber2 abilities matches 35 run execute at @e[name=slot9,type=armor_stand] run particle raid_omen ~ ~1 ~ 0.9 0.9 0.9 2 100
execute if score abilitynumber2 abilities matches 35 run tellraw @a[tag=game2] ["",{"selector":"@p[tag=p4]"}," used Reanimation Beam to damage Slot 1!"]
execute if score abilitynumber2 abilities matches 35 run function chtoo:abilitygivetargetsp3reverse

execute if score abilitynumber2 abilities matches -35 if score slot9bleeding booleaneffects matches 0 run scoreboard players operation slot9 hp += abilityDmg2 saves
execute if score abilitynumber2 abilities matches -35 if score character# slot10 matches 35 run function chtoo:cleanseslot9
execute if score abilitynumber2 abilities matches -35 if score character# slot10 matches 34 run function chtoo:cleanseslot9
execute if score abilitynumber2 abilities matches -35 run execute at @e[name=slot9,type=armor_stand] run particle trial_omen ~ ~1 ~ 0.9 0.9 0.9 2 100
execute if score abilitynumber2 abilities matches -35 run tellraw @a[tag=game2] ["",{"selector":"@p[tag=p3]"}," used Reanimation Beam to heal Slot 1!"]

#Boogaloo
execute if score abilitynumber2 abilities matches 37 unless score curse slot9 matches 5 run scoreboard players set curseDuration slot9 -1
execute if score abilitynumber2 abilities matches 37 if score curseStacks slot9 matches 1.. unless score curse slot9 matches 5 run scoreboard players set curseStacks slot9 0
execute if score abilitynumber2 abilities matches 37 unless score curse slot9 matches 5 run scoreboard players set curse slot9 1
execute if score abilitynumber2 abilities matches 37 run execute at @e[name=slot9,type=armor_stand] run particle minecraft:sculk_soul ~ ~1 ~ 0.9 0.9 0.9 0.15 30
execute if score abilitynumber2 abilities matches 37 run tellraw @a[tag=game2] ["",{"selector":"@p[tag=p4]"}," used Devour Soul on Slot 1!"]

#Anubis
execute if score abilitynumber2 abilities matches 42 if score ward slot9 matches 0 run scoreboard players operation abilityDmg2 saves = anubis abilityStats
execute if score abilitynumber2 abilities matches 42 if score ward slot9 matches 0 run scoreboard players operation abilityDmg2 saves *= anubisUnusedP2 saves
execute if score abilitynumber2 abilities matches 42 run execute at @e[name=slot9,type=armor_stand] run particle minecraft:sonic_boom ~ ~2 ~ 0.03 0.03 0.03 0.01 100
execute if score abilitynumber2 abilities matches 42 run tellraw @a[tag=game2] ["",{"selector":"@p[tag=p4]"}," used Wrath of the Desert on Slot 1!"]
...
execute if score abilitynumber2 abilities matches 42 run scoreboard players operation abilityDmg2 saves += marks slot9
execute if score abilitynumber2 abilities matches 42 run scoreboard players operation abilityDmg2 saves /= atkmultiplier slot9
execute if score abilitynumber2 abilities matches 42 run execute if score ward slot9 matches 0 run scoreboard players operation shield slot9 -= abilityDmg2 saves
execute if score abilitynumber2 abilities matches 42 run execute if score ward slot9 matches 0 if score shield slot9 matches ..0 run scoreboard players operation slot9 hp += shield slot9
execute if score abilitynumber2 abilities matches 42 if score ward slot9 matches 1.. run function chtoo:wardslot9
