...
#Special Cases
execute if score slot13isatk booleans matches 1 if score character# slot13 matches 29 if score hp slot12 <= ripperHpBleed abilityStats run scoreboard players operation slot12bleeding booleaneffects = ripperBleed abilityStats
execute if score slot14isatk booleans matches 1 if score character# slot14 matches 29 if score hp slot12 <= ripperHpBleed abilityStats run scoreboard players operation slot12bleeding booleaneffects = ripperBleed abilityStats
execute if score slot15isatk booleans matches 1 if score character# slot15 matches 29 if score hp slot12 <= ripperHpBleed abilityStats run scoreboard players operation slot12bleeding booleaneffects = ripperBleed abilityStats
