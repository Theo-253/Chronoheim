...
execute if score slot14isatk booleans matches 1 if score character# slot14 matches 36 run execute unless score durationSlot13-12 fear matches 1.. unless score durationSlot14-12 fear matches 1.. unless score durationSlot15-12 fear matches 1.. unless score durationSlot16-12 fear matches 1.. run scoreboard players operation atk1 saves -= barleyLeader abilityStats
...
#Special Cases
execute if score ward slot12 matches ..0 if score slot13isatk booleans matches 1 if score character# slot13 matches 29 if score slot12 hp <= ripperHpBleed abilityStats run scoreboard players operation slot12bleeding booleaneffects = ripperBleed abilityStats
execute if score ward slot12 matches ..0 if score slot14isatk booleans matches 1 if score character# slot14 matches 29 if score slot12 hp <= ripperHpBleed abilityStats run scoreboard players operation slot12bleeding booleaneffects = ripperBleed abilityStats
execute if score ward slot12 matches ..0 if score slot15isatk booleans matches 1 if score character# slot15 matches 29 if score slot12 hp <= ripperHpBleed abilityStats run scoreboard players operation slot12bleeding booleaneffects = ripperBleed abilityStats
execute if score ward slot12 matches ..0 run execute if score slot13isatk booleans matches 1 if score character# slot13 matches -8 run scoreboard players operation slot12Disease disease += zombieDisease abilityStats
execute if score ward slot12 matches ..0 run execute if score slot14isatk booleans matches 1 if score character# slot14 matches -8 run scoreboard players operation slot12Disease disease += zombieDisease abilityStats
execute if score ward slot12 matches ..0 run execute if score slot15isatk booleans matches 1 if score character# slot15 matches -8 run scoreboard players operation slot12Disease disease += zombieDisease abilityStats
execute if score ward slot12 matches ..0 run execute if score slot16isatk booleans matches 1 if score character# slot16 matches -8 run scoreboard players operation slot12Disease disease += zombieDisease abilityStats
