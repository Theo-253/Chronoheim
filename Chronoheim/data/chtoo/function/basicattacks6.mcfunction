...
#Special Cases
execute if score slot9isatk booleans matches 1 if score character# slot9 matches 29 if score slot14 hp <= ripperHpBleed abilityStats run scoreboard players operation slot14bleeding booleaneffects = ripperBleed abilityStats
execute if score slot10isatk booleans matches 1 if score character# slot10 matches 29 if score slot14 hp <= ripperHpBleed abilityStats run scoreboard players operation slot14bleeding booleaneffects = ripperBleed abilityStats
execute if score slot11isatk booleans matches 1 if score character# slot11 matches 29 if score slot14 hp <= ripperHpBleed abilityStats run scoreboard players operation slot14bleeding booleaneffects = ripperBleed abilityStats
