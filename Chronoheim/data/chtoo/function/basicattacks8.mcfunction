...
tellraw @a[tag=game2] ["",{"selector":"@p[tag=p3]"}," attacked Slot 8"]
clear @a[tag=p3]
#slot 5
...
#Special Cases
execute if score slot9isatk booleans matches 1 if score character# slot9 matches 29 if score hp slot16 <= ripperHpBleed abilityStats run scoreboard players operation slot16bleeding booleaneffects = ripperBleed abilityStats
execute if score slot10isatk booleans matches 1 if score character# slot10 matches 29 if score hp slot16 <= ripperHpBleed abilityStats run scoreboard players operation slot16bleeding booleaneffects = ripperBleed abilityStats
execute if score slot11isatk booleans matches 1 if score character# slot11 matches 29 if score hp slot16 <= ripperHpBleed abilityStats run scoreboard players operation slot16bleeding booleaneffects = ripperBleed abilityStats
