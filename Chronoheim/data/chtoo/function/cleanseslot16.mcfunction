...
execute if score curse slot16 matches 2 run execute if score ward slot13 matches 1.. run function chthree:wardslot13
execute if score curse slot16 matches 2 run execute if score ward slot14 matches 1.. run function chthree:wardslot14
execute if score curse slot16 matches 2 run execute if score ward slot15 matches 1.. run function chthree:wardslot15
execute if score curse slot16 matches 2 run execute if score ward slot16 matches 1.. run function chthree:wardslot16
