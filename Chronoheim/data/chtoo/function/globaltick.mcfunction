...
execute as @p[tag=p3] if predicate {condition:"minecraft:entity_properties",entity:"this",predicate:{effects:{"minecraft:water_breathing":{amplifier:{min:0,max:0}}}}} if score anubisSpCheckedP3 booleans matches 0 run scoreboard players operation anubisUnusedP3 saves = Spell_Points_P3 Spell_Points
execute as @p[tag=p4] if predicate {condition:"minecraft:entity_properties",entity:"this",predicate:{effects:{"minecraft:water_breathing":{amplifier:{min:0,max:0}}}}} if score anubisSpCheckedP4 booleans matches 0 run scoreboard players operation anubisUnusedP4 saves = Spell_Points_P4 Spell_Points
execute as @p[tag=p3] if predicate {condition:"minecraft:entity_properties",entity:"this",predicate:{effects:{"minecraft:water_breathing":{amplifier:{min:0,max:0}}}}} run scoreboard players set anubisSpCheckedP3 booleans 1
execute as @p[tag=p4] if predicate {condition:"minecraft:entity_properties",entity:"this",predicate:{effects:{"minecraft:water_breathing":{amplifier:{min:0,max:0}}}}} run scoreboard players set anubisSpCheckedP4 booleans 1
...
execute as @p[tag=p3] if predicate {condition:"minecraft:entity_properties",entity:"this",predicate:{effects:{"minecraft:water_breathing":{amplifier:{min:0,max:0}}}}} run effect clear @p[tag=p3] water_breathing
execute as @p[tag=p4] if predicate {condition:"minecraft:entity_properties",entity:"this",predicate:{effects:{"minecraft:water_breathing":{amplifier:{min:0,max:0}}}}} run effect clear @p[tag=p4] water_breathing
...
execute as @a[tag=p3] run execute as @a[tag=p4] if score game2start ongoinggames matches 0 run function chtoo:characterown
