...
execute as @a[tag=p3] run execute as @a[tag=p4] if score game2start ongoinggames matches 0 run place template minecraft:game2heroes2 -180 126 -100
execute as @a[tag=p3] run execute as @a[tag=p4] if score game2start ongoinggames matches 0 run place template minecraft:game2heroes1 -173 127 -109
