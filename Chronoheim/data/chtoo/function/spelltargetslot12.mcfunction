...
#Miracle
execute if score spellnumber spells matches 17 run function chtoo:cleanseslot12
execute if score spellnumber spells matches 17 run scoreboard players set attackIsOngoingGame2 booleans 0
execute if score spellnumber spells matches 17 run tellraw @a[tag=game2] ["",{"selector":"@p[tag=p3]"}," used Miracle on Slot 4!"]
