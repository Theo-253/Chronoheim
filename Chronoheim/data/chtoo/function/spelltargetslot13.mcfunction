...
execute if score spellnumber2 spells matches 13 run scoreboard players operation maxhp slot13 += embiggen spellStats
execute if score spellnumber2 spells matches 13 run scoreboard players operation slot13 hp += embiggen spellStats
...
execute if score spellnumber2 spells matches 2 unless score slot13bleeding booleaneffects matches 1.. run scoreboard players operation slot13 hp += spellHeal saves
...
#Miracle
execute if score spellnumber2 spells matches 17 run function chtoo:cleanseslot13
execute if score spellnumber2 spells matches 17 run function chtoo:spellphasep3
execute if score spellnumber2 spells matches 17 run tellraw @a[tag=game2] ["",{"selector":"@p[tag=p4]"}," used Miracle on Slot 5!"]
...
execute if score spellnumber2 spells matches 4 at @e[name=slot13] run particle minecraft:enchanted_hit ~ ~1 ~ 0.9 0.9 0.9 0.5 300
...
execute if score spellnumber2 spells matches 4 run tellraw @a[tag=game1] ["",{"selector":"@p[tag=p3]"}," used Magic Missile on Slot 5!"]
...
execute if score spellnumber2 spells matches 9 run execute at @n[type=armor_stand,name=slot13] run particle flash{color:[1.000,1.000,1.000,1.00]} ~ ~1 ~ 0.9 0.9 0.9 0.1 10
...
execute if score spellnumber2 spells matches -2 if score slot13bleeding booleaneffects matches 0 run scoreboard players operation slot13 hp += lifeLeechHeal spellStats
execute if score spellnumber2 spells matches -2 if score slot13bleeding booleaneffects matches 0 run scoreboard players operation slot13 hp += spellbuffsp4 spells
execute if score spellnumber2 spells matches -2 run function chtoo:spellphasep3
execute if score spellnumber2 spells matches -2 run execute at @n[type=armor_stand,name=slot13] run particle dust{color:[0.639,0.008,0.008],scale:1} ~ ~1 ~ 0.9 0.9 0.9 0.1 400
execute if score spellnumber2 spells matches -2 run tellraw @a[tag=game2] ["",{"selector":"@p[tag=p4]"}," used Life Leech to heal Slot 5!"]
execute if score spellnumber2 spells matches -2 run scoreboard players set spellbuffsp4 spells 0
...
execute if score spellnumber2 spells matches 31 run scoreboard players operation spellDmg saves += marks slot13
execute if score spellnumber2 spells matches 31 run scoreboard players operation spellDmg saves /= atkmultiplier slot13
execute if score spellnumber2 spells matches 31 run execute if score ward slot13 matches 0 run scoreboard players operation shield slot13 -= spellDmg saves
execute if score spellnumber2 spells matches 31 run execute if score ward slot13 matches 0 if score shield slot13 matches ..0 run scoreboard players operation slot13 hp += shield slot13
execute if score spellnumber2 spells matches 31 run execute if score ward slot13 matches 1.. run function chtoo:wardslot13
execute if score spellnumber2 spells matches 31 run function chtoo:spellgivetargetsp4reverse
execute if score spellnumber2 spells matches 31 run execute at @n[type=armor_stand,name=slot13] run particle dust{color:[0.639,0.008,0.008],scale:1} ~ ~1 ~ 0.9 0.9 0.9 0.1 400
execute if score spellnumber2 spells matches 31 run tellraw @a[tag=game2] ["",{"selector":"@p[tag=p3]"}," used Life Leech on Slot 5!"]
...
execute if score spellnumber2 spells matches 32 run scoreboard players operation spellDmg saves += marks slot13
execute if score spellnumber2 spells matches 32 run scoreboard players operation spellDmg saves /= atkmultiplier slot13
execute if score spellnumber2 spells matches 32 run execute if score ward slot13 matches 0 if score character# slot13 matches ..-1 run scoreboard players operation shield slot13 -= spellDmg saves
execute if score spellnumber2 spells matches 32 run execute if score ward slot13 matches 0 if score character# slot13 matches ..-1 if score shield slot13 matches ..0 run scoreboard players operation slot13 hp += shield slot13
execute if score spellnumber2 spells matches 32 run execute if score ward slot13 matches 1.. if score character# slot13 matches ..-1 run function chtoo:wardslot13
execute if score spellnumber2 spells matches 32 run execute at @n[type=armor_stand,name=slot13] run particle block{block_state:"minecraft:dripstone_block"} ~ ~ ~ 0.9 2 0.9 1 250 normal
execute if score spellnumber2 spells matches 32 run tellraw @a[tag=game2] ["",{"selector":"@p[tag=p3]"}," used Decimate on Slot 5!"]
...
execute if score spellnumber2 spells matches -3 if score slot13bleeding booleaneffects matches 0 run scoreboard players operation slot13 hp += cannibalize spellStats
execute if score spellnumber2 spells matches -3 if score slot13bleeding booleaneffects matches 0 run scoreboard players operation slot13 hp += spellbuffsp3 spells
execute if score spellnumber2 spells matches -3 run function chtoo:spellphasep3
execute if score spellnumber2 spells matches -3 run execute at @n[type=armor_stand,name=slot13] run particle dust{color:[0.639,0.008,0.008],scale:1} ~ ~1 ~ 0.9 0.9 0.9 0.1 400
execute if score spellnumber2 spells matches -3 run tellraw @a[tag=game2] ["",{"selector":"@p[tag=p4]"}," used Cannibalize to heal Slot 5!"]
execute if score spellnumber2 spells matches -3 run scoreboard players set spellbuffsp3 spells 0

#cannibalize
execute if score spellnumber2 spells matches 34 run scoreboard players operation slot13 hp -= cannibalize spellStats
execute if score spellnumber2 spells matches 34 run scoreboard players operation slot13bleeding booleaneffects += cannibalizeDuration spellStats
execute if score spellnumber2 spells matches 34 run function chtoo:spellgivetargetsp3reverse
execute if score spellnumber2 spells matches 34 run execute at @n[type=armor_stand,name=slot13] run particle dust{color:[0.639,0.008,0.008],scale:1} ~ ~1 ~ 0.9 0.9 0.9 0.1 400
execute if score spellnumber2 spells matches 34 run tellraw @a[tag=game2] ["",{"selector":"@p[tag=p4]"}," used Cannibalize on Slot 5!"]
execute if score spellnumber2 spells matches 34 run scoreboard players set spellnumber2 spells -3

#Dark Ritual
execute if score spellnumber2 spells matches 40 run execute if score buffDurationSlot13 atkmodifiers < darkpowerDuration spellStats run scoreboard players operation buffDurationSlot13 atkmodifiers = darkpowerDuration spellStats
execute if score spellnumber2 spells matches 40 run scoreboard players operation attackBuffSlot13 atkmodifiers += darkpower spellStats
execute if score spellnumber2 spells matches 40 run scoreboard players operation attackBuffSlot13 atkmodifiers += darkritual player4spells
execute if score spellnumber2 spells matches 40 at @e[name=slot13] run particle minecraft:trial_omen ~ ~1 ~ 0.9 0.9 0.9 0.5 40
execute if score spellnumber2 spells matches 40 run function chtoo:spellphasep3
execute if score spellnumber2 spells matches 40 run tellraw @a[tag=game2] ["",{"selector":"@p[tag=p4]"}," used Dark Ritual on Slot 5!"]

#Monkey's Paw
execute if score spellnumber2 spells matches 43 run scoreboard players operation invincibleSlot13 booleaneffects = monkeyspaw spellStats
execute if score spellnumber2 spells matches 43 run scoreboard players operation savehp13 saves = slot13 hp
execute if score spellnumber2 spells matches 43 run scoreboard players set curse slot13 5
execute if score spellnumber2 spells matches 43 run scoreboard players set curseStacks slot13 0
execute if score spellnumber2 spells matches 43 run scoreboard players operation curseDuration slot13 = monkeyspaw spellStats
execute if score spellnumber2 spells matches 43 at @e[name=slot13] run particle minecraft:raid_omen ~ ~1 ~ 0.9 0.9 0.9 0.00000001 200
...
execute if score spellnumber2 spells matches 43 run tellraw @a[tag=game2] ["",{"selector":"@p[tag=p4]"}," used Monkey's Paw on Slot 5!"]

#Slimed!
execute if score spellnumber2 spells matches 35 if score ward slot13 matches 0 run scoreboard players operation disarmedslot13 booleaneffects += slimed spellStats
execute if score spellnumber2 spells matches 35 if score ward slot13 matches 1.. run function chtoo:wardslot13
execute if score spellnumber2 spells matches 35 run scoreboard players set attackIsOngoingGame2 booleans 0
execute if score spellnumber2 spells matches 35 run execute at @n[type=armor_stand,name=slot13] run particle minecraft:item_slime ~ ~1 ~ 0.7 0.7 0.7 0.3 150
execute if score spellnumber2 spells matches 35 run tellraw @a[tag=game2] ["",{"selector":"@p[tag=p3]"}," used Slimed! on Slot 5!"]

#Vampire Mark
execute if score spellnumber2 spells matches 36 run scoreboard players operation lifesteal slot13 = vampiremark spellStats
execute if score spellnumber2 spells matches 36 run execute at @n[type=armor_stand,name=slot13] run particle minecraft:crimson_spore ~ ~1 ~ 0.6 0.4 0.6 0 200
execute if score spellnumber2 spells matches 36 run tellraw @a[tag=game2] ["",{"selector":"@p[tag=p4]"}," used Vampire Mark on Slot 5!"]
...
execute if score spellnumber2 spells matches 37 run scoreboard players operation spellDmg saves += marks slot13
execute if score spellnumber2 spells matches 37 run scoreboard players operation spellDmg saves /= atkmultiplier slot13
execute if score spellnumber2 spells matches 37 run execute if score ward slot13 matches 0 run scoreboard players operation shield slot13 -= spellDmg saves
execute if score spellnumber2 spells matches 37 run execute if score ward slot13 matches 0 if score shield slot13 matches ..0 run scoreboard players operation slot13 hp += shield slot13
execute if score spellnumber2 spells matches 37 at @e[name=slot13] run particle minecraft:damage_indicator ~ ~1 ~ 0.6 0.6 0.6 0 100
execute if score spellnumber2 spells matches 37 run execute if score ward slot13 matches 1.. run function chtoo:wardslot13
...
execute if score spellnumber2 spells matches 37 run tellraw @a[tag=game2] ["",{"selector":"@p[tag=p3]"}," used Butchering on Slot 5!"]

#Will O' Wisp
execute if score spellnumber2 spells matches 38 run execute if score ward slot13 matches 0 if score durationSlot13 burn < willowispDuration spellStats run scoreboard players operation durationSlot13 burn = willowispDuration spellStats
execute if score spellnumber2 spells matches 38 run execute if score ward slot13 matches 0 run scoreboard players operation slot13Burn burn += willowisp spellStats
execute if score spellnumber2 spells matches 38 run scoreboard players operation spellDmg saves = slot13Burn burn
execute if score spellnumber2 spells matches 38 run scoreboard players operation spellDmg saves += spellbuffsp3 spells
execute if score spellnumber2 spells matches 38 run scoreboard players operation spellDmg saves += marks slot13
execute if score spellnumber2 spells matches 38 run scoreboard players operation spellDmg saves /= atkmultiplier slot13
execute if score spellnumber2 spells matches 38 run execute if score ward slot13 matches 0 run scoreboard players operation shield slot13 -= spellDmg saves
execute if score spellnumber2 spells matches 38 run execute if score ward slot13 matches 0 if score shield slot13 matches ..0 run scoreboard players operation slot13 hp += shield slot13
execute if score spellnumber2 spells matches 38 at @e[name=slot13] run particle minecraft:glow ~ ~1 ~ 0.7 0.7 0.7 0.1 100
execute if score spellnumber2 spells matches 38 at @e[name=slot13] run particle minecraft:soul_fire_flame ~ ~1 ~ 0.6 0.6 0.6 0.1 100
execute if score spellnumber2 spells matches 38 run execute if score ward slot13 matches 1.. run function chtoo:wardslot13
...
execute if score spellnumber2 spells matches 38 run tellraw @a[tag=game2] ["",{"selector":"@p[tag=p3]"}," used Will O' Wisp on Slot 5!"]

#Curse of Bats
execute if score spellnumber2 spells matches 42 if score ward slot13 matches ..0 unless score curse slot13 matches 5 unless score curse slot13 matches 6 run scoreboard players set curseStacks slot13 0
execute if score spellnumber2 spells matches 42 if score ward slot13 matches ..0 unless score curse slot13 matches 5 unless score curse slot13 matches 6 run scoreboard players set curseDuration slot13 -1
execute if score spellnumber2 spells matches 42 if score ward slot13 matches ..0 unless score curse slot13 matches 5 run scoreboard players set curse slot13 6
execute if score spellnumber2 spells matches 42 if score ward slot13 matches ..0 unless score curse slot13 matches 5 if score curse slot13 matches 6 run scoreboard players add curseStacks slot13 1
execute if score spellnumber2 spells matches 42 run execute at @n[name=slot13] run particle shriek{delay:0} ~ ~1 ~ 0.3 0.5 0.3 0.1 200 normal
execute if score spellnumber2 spells matches 42 run tellraw @a[tag=game2] ["",{"selector":"@p[tag=p3]"}," used Curse of Bats on Slot 5!"]
execute if score spellnumber2 spells matches 42 if score ward slot13 matches 1.. run function chtoo:wardslot13
