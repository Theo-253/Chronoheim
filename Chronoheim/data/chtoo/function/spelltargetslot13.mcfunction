...
#Miracle
execute if score spellnumber spells matches 17 run function chtoo:cleanseslot13
execute if score spellnumber spells matches 17 run function chtoo:spellphasep3
execute if score spellnumber spells matches 17 run tellraw @a[tag=game2] ["",{"selector":"@p[tag=p4]"}," used Miracle on Slot 5!"]
