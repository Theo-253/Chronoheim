...
execute if score spellnumber spells matches 4 run scoreboard players operation spellDmg saves += spellbuffsp3 spells
execute if score spellnumber spells matches 4 run scoreboard players operation spellDmg saves += marks slot16 
execute if score spellnumber spells matches 4 run scoreboard players operation spellDmg saves /= atkmultiplier slot16
execute if score spellnumber spells matches 4 run execute if score ward slot16 matches 0 run scoreboard players operation shield slot16 -= spellDmg saves
execute if score spellnumber spells matches 4 run execute if score ward slot16 matches 0 if score shield slot16 matches ..0 run scoreboard players operation slot16 hp += shield slot16
execute if score spellnumber spells matches 4 run execute if score ward slot16 matches 1.. run function chtoo:wardslot15
execute if score spellnumber spells matches 4 run execute at @n[type=armor_stand,name=slot16] run particle minecraft:enchanted_hit ~ ~1 ~ 0.7 0.7 0.7 0.5 300
execute if score spellnumber spells matches 4 run tellraw @a[tag=game2] ["",{"selector":"@p[tag=p3]"}," smited Slot 16 with Magic Missle!"]
execute if score spellnumber spells matches 4 run execute if score magicMissilex3 spells matches 1 run function chtoo:spellgivetargetsp3
execute if score spellnumber spells matches 4 run execute if score magicMissilex3 spells matches 2 run scoreboard players set spellbuffsp3 spells 0
execute if score spellnumber spells matches 4 run execute if score magicMissilex3 spells matches 2 run clear @a[tag=p3] target
execute if score spellnumber spells matches 4 run execute if score magicMissilex3 spells matches 2 run scoreboard players set attackIsOngoingGame2 booleans 0
