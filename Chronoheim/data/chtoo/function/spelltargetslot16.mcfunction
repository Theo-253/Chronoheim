...
execute if score spellnumber2 spells matches 26 run execute if score slot14 hp matches ..0 if score slot15 hp matches ..0 if score slot13 hp matches ..0 run scoreboard players operation shield slot16 += dragonforge spellStats
execute if score spellnumber2 spells matches 26 run function chtoo:spellphasep3
execute if score spellnumber2 spells matches 26 run execute if score slot14 hp matches ..0 if score slot15 hp matches ..0 if score slot13 hp matches ..0 run execute at @n[type=armor_stand,name=slot16] run particle dragon_breath ~ ~1 ~ 0.9 0.9 0.9 0.1 400
execute if score spellnumber2 spells matches 26 run execute at @n[type=armor_stand,name=slot16] run particle dragon_breath ~ ~1 ~ 0.9 0.9 0.9 0.1 100
...
execute if score spellnumber2 spells matches 13 run scoreboard players operation maxhp slot16 += embiggen spellStats
execute if score spellnumber2 spells matches 13 run scoreboard players operation slot16 hp += embiggen spellStats
...
#Evil Eye
execute if score spellnumber2 spells matches 15 if score ward slot16 matches 0 run execute if score durationSlot16 mark < evilEyeDuration spellStats run scoreboard players operation durationSlot16 mark = evilEyeDuration spellStats
...
execute if score spellnumber2 spells matches 2 unless score slot16bleeding booleaneffects matches 1.. run scoreboard players operation slot16 hp += spellHeal saves
...
#Miracle
execute if score spellnumber2 spells matches 17 run function chtoo:cleanseslot16
execute if score spellnumber2 spells matches 17 run function chtoo:spellphasep3
execute if score spellnumber2 spells matches 17 run tellraw @a[tag=game2] ["",{"selector":"@p[tag=p4]"}," used Miracle on Slot 8!"]
...
execute if score spellnumber2 spells matches 4 at @e[name=slot16] run particle minecraft:enchanted_hit ~ ~1 ~ 0.9 0.9 0.9 0.5 300
...
execute if score spellnumber2 spells matches 4 run tellraw @a[tag=game1] ["",{"selector":"@p[tag=p3]"}," used Magic Missile on Slot 8!"]
...
execute if score spellnumber2 spells matches 9 run execute at @n[type=armor_stand,name=slot16] run particle flash{color:[1.000,1.000,1.000,1.00]} ~ ~1 ~ 0.9 0.9 0.9 0.1 10
...
#life leech token
execute if score spellnumber2 spells matches -2 if score slot16bleeding booleaneffects matches 0 run scoreboard players operation slot16 hp += lifeLeechHeal spellStats
execute if score spellnumber2 spells matches -2 if score slot16bleeding booleaneffects matches 0 run scoreboard players operation slot16 hp += spellbuffsp4 spells
execute if score spellnumber2 spells matches -2 run function chtoo:spellphasep3
execute if score spellnumber2 spells matches -2 run execute at @n[type=armor_stand,name=slot16] run particle dust{color:[0.639,0.008,0.008],scale:1} ~ ~1 ~ 0.9 0.9 0.9 0.1 400
execute if score spellnumber2 spells matches -2 run tellraw @a[tag=game2] ["",{"selector":"@p[tag=p4]"}," used Life Leech to heal Slot 8!"]
execute if score spellnumber2 spells matches -2 run scoreboard players set spellbuffsp4 spells 0
...
execute if score spellnumber2 spells matches 31 run scoreboard players operation spellDmg saves += marks slot16
execute if score spellnumber2 spells matches 31 run scoreboard players operation spellDmg saves /= atkmultiplier slot16
execute if score spellnumber2 spells matches 31 run execute if score ward slot16 matches 0 run scoreboard players operation shield slot16 -= spellDmg saves
execute if score spellnumber2 spells matches 31 run execute if score ward slot16 matches 0 if score shield slot16 matches ..0 run scoreboard players operation slot16 hp += shield slot16
execute if score spellnumber2 spells matches 31 run execute if score ward slot16 matches 1.. run function chtoo:wardslot16
execute if score spellnumber2 spells matches 31 run function chtoo:spellgivetargetsp4reverse
execute if score spellnumber2 spells matches 31 run execute at @n[type=armor_stand,name=slot16] run particle dust{color:[0.639,0.008,0.008],scale:1} ~ ~1 ~ 0.9 0.9 0.9 0.1 400
execute if score spellnumber2 spells matches 31 run tellraw @a[tag=game2] ["",{"selector":"@p[tag=p3]"}," used Life Leech on Slot 8!"]
...
execute if score spellnumber2 spells matches 32 run scoreboard players operation spellDmg saves += marks slot16
execute if score spellnumber2 spells matches 32 run scoreboard players operation spellDmg saves /= atkmultiplier slot16
execute if score spellnumber2 spells matches 32 run execute if score ward slot16 matches 0 if score character# slot16 matches ..-1 run scoreboard players operation shield slot16 -= spellDmg saves
execute if score spellnumber2 spells matches 32 run execute if score ward slot16 matches 0 if score character# slot16 matches ..-1 if score shield slot16 matches ..0 run scoreboard players operation slot16 hp += shield slot16
execute if score spellnumber2 spells matches 32 run execute if score ward slot16 matches 1.. if score character# slot16 matches ..-1 run function chtoo:wardslot16
execute if score spellnumber2 spells matches 32 run execute at @n[type=armor_stand,name=slot16] run particle block{block_state:"minecraft:dripstone_block"} ~ ~ ~ 0.9 2 0.9 1 250 normal
execute if score spellnumber2 spells matches 32 run tellraw @a[tag=game2] ["",{"selector":"@p[tag=p3]"}," used Decimate on Slot 8!"]
...
execute if score spellnumber2 spells matches 40 run scoreboard players operation attackBuffSlot16 atkmodifiers += darkritual player4spells
