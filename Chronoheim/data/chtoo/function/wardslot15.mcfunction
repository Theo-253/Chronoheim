...
execute if score ward slot15 matches 4 at @e[name=slot15,type=armor_stand] run particle minecraft:block{block_state:"minecraft:cobweb"} ~ ~1 ~ 0.9 0.9 0.9 0.1 200
execute if score ward slot15 matches 4 if score spiderwardDuration spellStats > durationSlot11 speedDebuffs run scoreboard players operation durationSlot11 speedDebuffs = spiderwardDuration spellStats
execute if score ward slot15 matches 4 if score spiderwardDuration spellStats > durationSlot11 poison run scoreboard players operation durationSlot11 poison = spiderwardDuration spellStats
execute if score ward slot15 matches 4 run scoreboard players operation slot11Poison poison += spiderward spellStats
execute if score ward slot15 matches 4 run scoreboard players operation speedDebuffSlot11 speedDebuffs += spiderwardSpDebuff spellStats
execute if score ward slot15 matches 4 run scoreboard players operation speed slot11 -= spiderwardSpDebuff spellStats
execute if score ward slot15 matches 4 run scoreboard players set ward slot15 0
