...
execute if score slot12 hp matches 1.. run execute if score character# slot12 matches -5 run scoreboard players operation speed slot12 = skeletonplus herospeed
...
execute if score slot16 hp matches 1.. run execute if score character# slot16 matches -5 run scoreboard players operation speed slot16 = skeletonplus herospeed
