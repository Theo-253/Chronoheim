execute as @a[tag=p1] if predicate {condition:"minecraft:entity_properties",entity:"this",predicate:{effects:{"minecraft:infested":{amplifier:{min:25,max:25}}}}} run tellraw @a[tag=game1] ["",{"selector":"@p[tag=p1]"}," used Fountain of Youth!"]
execute as @a[tag=p2] if predicate {condition:"minecraft:entity_properties",entity:"this",predicate:{effects:{"minecraft:infested":{amplifier:{min:25,max:25}}}}} run tellraw @a[tag=game1] ["",{"selector":"@p[tag=p2]"}," used Fountain of Youth!"]
