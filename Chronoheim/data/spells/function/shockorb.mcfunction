execute as @a[tag=p1] if predicate {condition:"minecraft:entity_properties",entity:"this",predicate:{effects:{"minecraft:infested":{amplifier:{min:9,max:9}}}}} run tellraw @a[tag=game1] ["",{"selector":"@p[tag=p1]"}," used Ball Lightning!"]
execute as @a[tag=p2] if predicate {condition:"minecraft:entity_properties",entity:"this",predicate:{effects:{"minecraft:infested":{amplifier:{min:9,max:9}}}}} run tellraw @a[tag=game1] ["",{"selector":"@p[tag=p1]"}," used Ball Lightning!"]
