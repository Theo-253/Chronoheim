...
execute if score abilitynumber abilities matches -2 if score character# slot2 matches 27 run function ch:cleanseslot3
...
execute if score abilitynumber abilities matches 23 if score ward slot3 matches 0 run scoreboard players operation savehp5 saves = slot3 hp 
