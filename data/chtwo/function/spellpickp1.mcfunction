...
scoreboard players operation spellpick1 drafts = Spell_Points_P3 Spell_Points
...
execute if score spellpick1 drafts > Spell_Points_P3 Spell_Points run clear @a[tag=p3]

execute if score Spell_Points_P3 Spell_Points matches 0 run execute if score Spell_Points_P4 Spell_Points matches 0 run function ch:game2start