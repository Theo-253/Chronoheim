scoreboard players operation spellpick2 drafts = Spell_Points_P4 Spell_Points
...
execute if score Spell_Points_P4 Spell_Points >= miracleSp spellStats run execute if items entity @p[tag=p4,tag=protectorsruneO] container.* chiseled_tuff[minecraft:custom_name={"text":"Protector's Rune","bold":true,"color":"blue","italic":false}] run tellraw @a[tag=p4] ["",{"selector":"@p[tag=p4]"}," picked Miracle."]
execute if score Spell_Points_P4 Spell_Points < miracleSp spellStats run execute if items entity @p[tag=p4,tag=protectorsruneO] container.* chiseled_tuff[minecraft:custom_name={"text":"Protector's Rune","bold":true,"color":"blue","italic":false}] run tellraw @a[tag=p4] ["",{"selector":"@p[tag=p4]"}," You dont have enough spell points to equip this spell."]
execute if score Spell_Points_P4 Spell_Points < miracleSp spellStats run execute if items entity @p[tag=p4,tag=protectorsruneO] container.* chiseled_tuff[minecraft:custom_name={"text":"Protector's Rune","bold":true,"color":"blue","italic":false}] run clear @a[tag=p4]
execute if score Spell_Points_P4 Spell_Points >= miracleSp spellStats run execute if items entity @p[tag=p4,tag=protectorsruneO] container.* chiseled_tuff[minecraft:custom_name={"text":"Protector's Rune","bold":true,"color":"blue","italic":false}] run scoreboard players operation Spell_Points_P4 Spell_Points -= miracleSp spellStats
execute if score Spell_Points_P4 Spell_Points >= miracleSp spellStats run execute if items entity @p[tag=p4,tag=protectorsruneO] container.* chiseled_tuff[minecraft:custom_name={"text":"Protector's Rune","bold":true,"color":"blue","italic":false}] run effect clear @a[tag=p4] water_breathing
...
execute if score spellpick2 drafts > Spell_Points_P4 Spell_Points run clear @a[tag=p4]
